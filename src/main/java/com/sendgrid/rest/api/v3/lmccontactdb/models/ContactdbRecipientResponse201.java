...
public class ContactdbRecipientResponse201 {
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("persistedRecipients")
    @Getter
    @Setter
    ...
    public static class Builder {
        ...
        public Builder(BigDecimal errorCount, BigDecimal newCount, List<String> persistedRecipients, BigDecimal updatedCount) {
        ...
        public Builder errors(List<ContactdbRecipientResponse201ErrorsInner> errors) {
            this.errors = errors;
            return this;
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", ContactdbRecipientResponse201.class.getSimpleName() + "(", ")");
        ...
        if (persistedRecipients != null) joiner.add("persistedRecipients=" + persistedRecipients);
