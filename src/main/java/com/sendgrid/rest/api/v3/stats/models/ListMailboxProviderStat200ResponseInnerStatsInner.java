...
import com.sendgrid.rest.api.v3.stats.models.AdvancedStatsMailboxProvider;
...
@ToString
public class ListMailboxProviderStat200ResponseInnerStatsInner {
    ...
    @Getter
    @Setter
    private AdvancedStatsMailboxProvider metrics;

    public ListMailboxProviderStat200ResponseInnerStatsInner() {}

    private ListMailboxProviderStat200ResponseInnerStatsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder metrics(AdvancedStatsMailboxProvider metrics) {
            this.metrics = metrics;
            return this;
        }

        public ListMailboxProviderStat200ResponseInnerStatsInner build() {
            return new ListMailboxProviderStat200ResponseInnerStatsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListMailboxProviderStat200ResponseInnerStatsInner.class.getSimpleName() +
            "(",
            ")"
        );
