...
public class UpdateBouncePurge extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private MailSettingsBouncePurge mailSettingsBouncePurge;

    public ApiResponse<MailSettingsBouncePurge> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateBouncePurge creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (mailSettingsBouncePurge != null) {
            request.addBody(JsonUtil.toJson(mailSettingsBouncePurge));
        }
    }
}
