...
@ToString
public class DeleteIpsPoolsPoolNameIpsIp404Response {
    ...
    public DeleteIpsPoolsPoolNameIpsIp404Response() {
    }

    private DeleteIpsPoolsPoolNameIpsIp404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteIpsPoolsPoolNameIpsIp404Response build() {
            return new DeleteIpsPoolsPoolNameIpsIp404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteIpsPoolsPoolNameIpsIp404Response.class.getSimpleName() + "(", ")");
