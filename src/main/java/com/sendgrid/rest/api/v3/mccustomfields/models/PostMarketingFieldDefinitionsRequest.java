...
@ToString
public class PostMarketingFieldDefinitionsRequest {
    ...
    public PostMarketingFieldDefinitionsRequest() {
    }

    private PostMarketingFieldDefinitionsRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingFieldDefinitionsRequest build() {
            return new PostMarketingFieldDefinitionsRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingFieldDefinitionsRequest.class.getSimpleName() + "(", ")");
