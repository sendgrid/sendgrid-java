...
@ToString
public class PostMailSendRequestMailSettingsBypassSpamManagement {
    ...
    public PostMailSendRequestMailSettingsBypassSpamManagement() {
    }

    private PostMailSendRequestMailSettingsBypassSpamManagement(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMailSendRequestMailSettingsBypassSpamManagement build() {
            return new PostMailSendRequestMailSettingsBypassSpamManagement(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMailSendRequestMailSettingsBypassSpamManagement.class.getSimpleName() + "(", ")");
