...
@ToString
public class PatchMarketingListsIdRequest {
    ...
    public PatchMarketingListsIdRequest() {
    }

    private PatchMarketingListsIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchMarketingListsIdRequest build() {
            return new PatchMarketingListsIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchMarketingListsIdRequest.class.getSimpleName() + "(", ")");
