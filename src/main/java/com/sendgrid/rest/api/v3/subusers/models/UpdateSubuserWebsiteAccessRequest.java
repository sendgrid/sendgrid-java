...
@ToString
public class UpdateSubuserWebsiteAccessRequest {
    ...
    public UpdateSubuserWebsiteAccessRequest() {}

    private UpdateSubuserWebsiteAccessRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateSubuserWebsiteAccessRequest build() {
            return new UpdateSubuserWebsiteAccessRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateSubuserWebsiteAccessRequest.class.getSimpleName() + "(",
            ")"
        );
