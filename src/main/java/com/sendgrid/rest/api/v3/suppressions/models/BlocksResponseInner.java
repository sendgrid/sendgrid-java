...
@ToString
public class BlocksResponseInner {
    ...
    public BlocksResponseInner() {
    }

    private BlocksResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(Integer created, String email, String reason, String status) {
        ...
        public BlocksResponseInner build() {
            return new BlocksResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", BlocksResponseInner.class.getSimpleName() + "(", ")");
