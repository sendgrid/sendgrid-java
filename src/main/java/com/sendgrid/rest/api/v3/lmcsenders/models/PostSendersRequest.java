...
@ToString
public class PostSendersRequest {
    ...
    public PostSendersRequest() {
    }

    private PostSendersRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(Object nickname, Object address, Object city, Object country) {
        ...
        public PostSendersRequest build() {
            return new PostSendersRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostSendersRequest.class.getSimpleName() + "(", ")");
