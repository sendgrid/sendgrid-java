...
import com.sendgrid.rest.api.v3.sso.models.CreateSsoCertificateRequest;
...
public class CreateSsoCertificate extends ApiKeyBase {

    @Setter
    private CreateSsoCertificateRequest createSsoCertificateRequest;
    ...
    public ApiResponse<SsoCertificateBody> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "CreateSsoCertificate creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (createSsoCertificateRequest != null) {
            request.addBody(JsonUtil.toJson(createSsoCertificateRequest));
        }
    }
}
