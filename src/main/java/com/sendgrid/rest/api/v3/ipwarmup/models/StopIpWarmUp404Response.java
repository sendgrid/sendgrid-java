...
import com.sendgrid.rest.api.v3.ipwarmup.models.StopIpWarmUp404ResponseErrorsInner;
...
@ToString
public class StopIpWarmUp404Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<StopIpWarmUp404ResponseErrorsInner> errors;

    public StopIpWarmUp404Response() {}

    private StopIpWarmUp404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<StopIpWarmUp404ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public StopIpWarmUp404Response build() {
            return new StopIpWarmUp404Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            StopIpWarmUp404Response.class.getSimpleName() + "(",
            ")"
        );
