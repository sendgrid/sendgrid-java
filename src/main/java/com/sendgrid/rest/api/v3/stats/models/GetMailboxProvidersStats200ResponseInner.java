...
@ToString
public class GetMailboxProvidersStats200ResponseInner {
    ...
    @Getter
    @Setter
    private List<GetMailboxProvidersStats200ResponseInnerStatsInner> stats;

    public GetMailboxProvidersStats200ResponseInner() {
    }

    private GetMailboxProvidersStats200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder stats(List<GetMailboxProvidersStats200ResponseInnerStatsInner> stats) {
            this.stats = stats;
            return this;
        }

        public GetMailboxProvidersStats200ResponseInner build() {
            return new GetMailboxProvidersStats200ResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMailboxProvidersStats200ResponseInner.class.getSimpleName() + "(", ")");
