...
import com.sendgrid.rest.api.v3.emailactivity.models.GetMessagesDownloadDownloadUuid200Response;
...
public class GetMessageDownloadById {
    private final UUID downloadUuid;


    public GetMessagesDownloadDownloadUuid200Response send(final TokenRestClient client) {
        String path = "/v3/messages/download/{download_uuid}";
        Request.Builder builder = new Request.Builder(HttpMethod.GET, path)
                .addPathParam("download_uuid", downloadUuid.toString());
        Request request = builder.build();
        Response response = client.request(request);

        if (response == null) {
            throw new ApiConnectionException(
                    "GetMessageDownloadById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetMessagesDownloadDownloadUuid200Response.class);
    }
