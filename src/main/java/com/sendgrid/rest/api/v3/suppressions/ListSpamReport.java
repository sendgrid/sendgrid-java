...
public class ListSpamReport extends ApiKeyBase {
    ...
    public ApiResponse<List<SpamReportsResponseInner>> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListSpamReport creation failed: Unable to connect to server"
            );
        } else if (
