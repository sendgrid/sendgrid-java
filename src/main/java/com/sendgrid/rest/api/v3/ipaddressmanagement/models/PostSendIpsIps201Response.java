...
@ToString
public class PostSendIpsIps201Response {
    ...
    public PostSendIpsIps201Response() {
    }

    private PostSendIpsIps201Response(Builder builder) {
        this.ip = builder.ip;
    ...
    public static class Builder {
        ...
        public PostSendIpsIps201Response build() {
            return new PostSendIpsIps201Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostSendIpsIps201Response.class.getSimpleName() + "(", ")");
