...
import com.sendgrid.rest.api.v3.mccontacts.models.ContactImport;
import com.sendgrid.rest.api.v3.mccontacts.models.ErrorResponse;
import com.sendgrid.rest.api.v3.mccontacts.models.GetMarketingContactsImportsId400Response;
...
public class GetMarketingContactImportById {
    private final String id;


    public ContactImport send(final TokenRestClient client) {
        String path = "/v3/marketing/contacts/imports/{id}";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetMarketingContactImportById creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
            if (Matcher.matches(Integer.toString(statusCode), "400")) {
                GetMarketingContactsImportsId400Response error = JsonUtil.fromJson(
                        response.getStream(),
                        GetMarketingContactsImportsId400Response.class
                );
        ...
        return JsonUtil.fromJson(response.getStream(), ContactImport.class);
    }
