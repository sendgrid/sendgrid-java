...
public class MailTest {
	...
	public void testKitchenSink() throws IOException {
		...
		final Attachments attachments2 = new Attachments();
		...
		final BccSettings bccSettings = new BccSettings();
		...
		final SpamCheckSetting spamCheckSetting = new SpamCheckSetting();
		...
		final GoogleAnalyticsSetting googleAnalyticsSetting = new GoogleAnalyticsSetting();
