...
@ToString
public class PostMarketingSinglesendsIdRequest {
    ...
    public PostMarketingSinglesendsIdRequest() {
    }

    private PostMarketingSinglesendsIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingSinglesendsIdRequest build() {
            return new PostMarketingSinglesendsIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingSinglesendsIdRequest.class.getSimpleName() + "(", ")");
