...
public class UpdateIp extends ApiKeyBase {
    ...
    public ApiResponse<UpdateIp200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateIp creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), UpdateIp200Response.class),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (updateIpRequest != null) {
            request.addBody(JsonUtil.toJson(updateIpRequest));
        }
    }
}
