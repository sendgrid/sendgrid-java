...
public class ListCustomField extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    public ApiResponse<ListAllCustomFieldsResponse> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListCustomField creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListAllCustomFieldsResponse.class
            ),
            response.getHeaders()
        );
    }
