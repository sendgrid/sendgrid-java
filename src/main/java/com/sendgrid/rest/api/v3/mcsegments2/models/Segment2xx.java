...
public class Segment2xx {
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("refreshesUsed")
    @Getter
    @Setter
    private Integer refreshesUsed;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("maxRefreshes")
    @Getter
    @Setter
    ...
    public static class Builder {
        ...
        public Builder(UUID id, String name, String queryDsl, Integer contactsCount, List<ContactResponse> contactsSample, String createdAt, String updatedAt, String sampleUpdatedAt, String nextSampleUpdate, List<String> parentListIds, String queryVersion, SegmentStatusResponse status) {
            this.id = id;
            this.name = name;
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", Segment2xx.class.getSimpleName() + "(", ")");
