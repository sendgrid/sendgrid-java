...
@ToString
public class GetMarketingContactsCount200ResponseBillableBreakdown {
    ...
    public GetMarketingContactsCount200ResponseBillableBreakdown() {
    }

    private GetMarketingContactsCount200ResponseBillableBreakdown(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMarketingContactsCount200ResponseBillableBreakdown build() {
            return new GetMarketingContactsCount200ResponseBillableBreakdown(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingContactsCount200ResponseBillableBreakdown.class.getSimpleName() + "(", ")");
