...
@ToString
public class DeleteMarketingList200Response {
    ...
    public DeleteMarketingList200Response() {}

    private DeleteMarketingList200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteMarketingList200Response build() {
            return new DeleteMarketingList200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            DeleteMarketingList200Response.class.getSimpleName() + "(",
            ")"
        );
