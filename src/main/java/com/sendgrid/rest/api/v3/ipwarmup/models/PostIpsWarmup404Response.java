...
@ToString
public class PostIpsWarmup404Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<PostIpsWarmup404ResponseErrorsInner> errors;

    public PostIpsWarmup404Response() {
    }

    private PostIpsWarmup404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<PostIpsWarmup404ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public PostIpsWarmup404Response build() {
            return new PostIpsWarmup404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostIpsWarmup404Response.class.getSimpleName() + "(", ")");
