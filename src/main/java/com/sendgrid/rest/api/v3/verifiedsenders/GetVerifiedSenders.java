...
import com.sendgrid.rest.api.v3.verifiedsenders.models.GetVerifiedSenders200Response;
...
public class GetVerifiedSenders {
    private BigDecimal limit;
    private String query;


    public GetVerifiedSenders200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetVerifiedSenders creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetVerifiedSenders200Response.class);
    }
