...
@ToString
public class PutSendIpsPoolsPoolId200Response {
    ...
    public PutSendIpsPoolsPoolId200Response() {
    }

    private PutSendIpsPoolsPoolId200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PutSendIpsPoolsPoolId200Response build() {
            return new PutSendIpsPoolsPoolId200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutSendIpsPoolsPoolId200Response.class.getSimpleName() + "(", ")");
