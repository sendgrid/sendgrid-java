...
public class SendTestCampaignRequest {
    ...
    private SendTestCampaignRequest(Builder builder) {
        this.to = builder.to;
    }
    ...
    public static class Builder {
        ...
        public SendTestCampaignRequest build() {
            return new SendTestCampaignRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SendTestCampaignRequest.class.getSimpleName() + "(",
            ")"
        );
