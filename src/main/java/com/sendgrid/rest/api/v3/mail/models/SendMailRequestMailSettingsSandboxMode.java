...
@ToString
public class SendMailRequestMailSettingsSandboxMode {
    ...
    public SendMailRequestMailSettingsSandboxMode() {}

    private SendMailRequestMailSettingsSandboxMode(Builder builder) {
    ...
    public static class Builder {
        ...
        public SendMailRequestMailSettingsSandboxMode build() {
            return new SendMailRequestMailSettingsSandboxMode(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SendMailRequestMailSettingsSandboxMode.class.getSimpleName() + "(",
            ")"
        );
