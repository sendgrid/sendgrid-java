...
@ToString
public class GetTeammates200Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private List<GetTeammates200ResponseResultInner> result;

    public GetTeammates200Response() {
    }

    private GetTeammates200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder result(List<GetTeammates200ResponseResultInner> result) {
            this.result = result;
            return this;
        }

        public GetTeammates200Response build() {
            return new GetTeammates200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetTeammates200Response.class.getSimpleName() + "(", ")");
