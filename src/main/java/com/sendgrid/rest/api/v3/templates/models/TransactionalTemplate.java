...
public class TransactionalTemplate {
    ...
    @Getter
    @Setter
    private TransactionalTemplateWarning warning;

    public TransactionalTemplate() {}

    private TransactionalTemplate(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public Builder warning(TransactionalTemplateWarning warning) {
            this.warning = warning;
            return this;
        }

        public TransactionalTemplate build() {
            return new TransactionalTemplate(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            TransactionalTemplate.class.getSimpleName() + "(",
            ")"
        );
        ...
        if (warning != null) joiner.add("warning=" + warning);
