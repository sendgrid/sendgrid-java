...
import com.sendgrid.rest.api.v3.ips.models.UpdateIpPool404ResponseErrorsInner;
...
@ToString
public class UpdateIpPool404Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<UpdateIpPool404ResponseErrorsInner> errors;

    public UpdateIpPool404Response() {}

    private UpdateIpPool404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<UpdateIpPool404ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public UpdateIpPool404Response build() {
            return new UpdateIpPool404Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateIpPool404Response.class.getSimpleName() + "(",
            ")"
        );
