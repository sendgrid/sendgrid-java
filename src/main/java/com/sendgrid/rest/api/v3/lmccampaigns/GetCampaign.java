...
import com.sendgrid.rest.api.v3.lmccampaigns.models.GetCampaign200Response;
...
public class GetCampaign extends ApiKeyBase {
    ...
    public ApiResponse<GetCampaign200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetCampaign creation failed: Unable to connect to server"
            );
        } else if (
