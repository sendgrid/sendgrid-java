...
import com.sendgrid.rest.api.v3.mccontacts.models.PutMarketingContactsImports200Response;
import com.sendgrid.rest.api.v3.mccontacts.models.PutMarketingContactsImports400Response;
import com.sendgrid.rest.api.v3.mccontacts.models.PutMarketingContactsImports404Response;
import com.sendgrid.rest.api.v3.mccontacts.models.PutMarketingContactsImportsRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PutMarketingContactImport {
    private final PutMarketingContactsImportsRequest putMarketingContactsImportsRequest;


    public PutMarketingContactsImports200Response send(final TokenRestClient client) {
        String path = "/v3/marketing/contacts/imports";
        Request.Builder builder = new Request.Builder(HttpMethod.PUT, path);
        body(builder);
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PutMarketingContactImport creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
            if (Matcher.matches(Integer.toString(statusCode), "400")) {
                PutMarketingContactsImports400Response error = JsonUtil.fromJson(
                        response.getStream(),
                        PutMarketingContactsImports400Response.class
                );
            ...
            if (Matcher.matches(Integer.toString(statusCode), "404")) {
                PutMarketingContactsImports404Response error = JsonUtil.fromJson(
                        response.getStream(),
                        PutMarketingContactsImports404Response.class
                );
                throw new ApiErrorResponse(statusCode, null, error, response.getHeaders());
            }
        ...
        return JsonUtil.fromJson(response.getStream(), PutMarketingContactsImports200Response.class);
    }


    private void body(final Request.Builder builder) {
        if (putMarketingContactsImportsRequest != null) {
            builder.body(JsonUtil.toJson(putMarketingContactsImportsRequest));
        }
    }
