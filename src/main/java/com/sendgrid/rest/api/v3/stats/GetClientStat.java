...
import com.sendgrid.rest.api.v3.stats.models.ClientType;
...
public class GetClientStat extends ApiKeyBase {
    ...
    private void addPathParams(Request request) {
        if (clientType != null) {
            request.addPathParam("client_type", clientType.toString());
        }
    }
