...
@ToString
public class GetSuppressionUnsubscribes200ResponseInner {
    ...
    public GetSuppressionUnsubscribes200ResponseInner() {
    }

    private GetSuppressionUnsubscribes200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(Integer created, String email) {
            this.created = created;
            this.email = email;
        }

        public GetSuppressionUnsubscribes200ResponseInner build() {
            return new GetSuppressionUnsubscribes200ResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetSuppressionUnsubscribes200ResponseInner.class.getSimpleName() + "(", ")");
