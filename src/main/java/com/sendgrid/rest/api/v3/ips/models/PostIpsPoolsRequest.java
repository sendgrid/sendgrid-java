...
@ToString
public class PostIpsPoolsRequest {
    ...
    public PostIpsPoolsRequest() {
    }

    private PostIpsPoolsRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostIpsPoolsRequest build() {
            return new PostIpsPoolsRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostIpsPoolsRequest.class.getSimpleName() + "(", ")");
