...
@ToString
public class GetIpsRemaining200ResponseResultsInner {
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("pricePerIp")
    @Getter
    @Setter
    private BigDecimal pricePerIp;

    public GetIpsRemaining200ResponseResultsInner() {
    }

    private GetIpsRemaining200ResponseResultsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(Integer remaining, String period, BigDecimal pricePerIp) {
            this.remaining = remaining;
            this.period = period;
            this.pricePerIp = pricePerIp;
        }

        public GetIpsRemaining200ResponseResultsInner build() {
            return new GetIpsRemaining200ResponseResultsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetIpsRemaining200ResponseResultsInner.class.getSimpleName() + "(", ")");
