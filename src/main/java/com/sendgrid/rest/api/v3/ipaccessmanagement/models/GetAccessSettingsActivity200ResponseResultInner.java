...
@ToString
public class GetAccessSettingsActivity200ResponseResultInner {
    ...
    public GetAccessSettingsActivity200ResponseResultInner() {
    }

    private GetAccessSettingsActivity200ResponseResultInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(Boolean allowed, String authMethod, Integer firstAt, String ip, Integer lastAt, String location) {
        ...
        public GetAccessSettingsActivity200ResponseResultInner build() {
            return new GetAccessSettingsActivity200ResponseResultInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetAccessSettingsActivity200ResponseResultInner.class.getSimpleName() + "(", ")");
