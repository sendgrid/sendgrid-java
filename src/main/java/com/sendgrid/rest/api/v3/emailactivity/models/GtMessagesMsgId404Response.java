...
@ToString
public class GtMessagesMsgId404Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GtMessagesMsgId404ResponseErrorsInner> errors;

    public GtMessagesMsgId404Response() {
    }

    private GtMessagesMsgId404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<GtMessagesMsgId404ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public GtMessagesMsgId404Response build() {
            return new GtMessagesMsgId404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GtMessagesMsgId404Response.class.getSimpleName() + "(", ")");
