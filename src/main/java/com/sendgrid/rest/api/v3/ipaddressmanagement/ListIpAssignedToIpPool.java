...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.ListIpAssignedToIpPool200Response;
...
public class ListIpAssignedToIpPool extends ApiKeyBase {
    ...
    public ApiResponse<ListIpAssignedToIpPool200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListIpAssignedToIpPool creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListIpAssignedToIpPool200Response.class
            ),
            response.getHeaders()
        );
    }
