...
import com.sendgrid.rest.api.v3.apikeys.models.PatchApiKeysApiKeyIdRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PatchApiKeysById {
    private final String apiKeyId;
    private String onBehalfOf;
    private final PatchApiKeysApiKeyIdRequest patchApiKeysApiKeyIdRequest;
    ...
    public ApiKeyResponse send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchApiKeysById creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (patchApiKeysApiKeyIdRequest != null) {
            builder.body(JsonUtil.toJson(patchApiKeysApiKeyIdRequest));
        }
    }
