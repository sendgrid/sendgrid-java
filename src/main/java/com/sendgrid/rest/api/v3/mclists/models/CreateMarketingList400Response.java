...
@ToString
public class CreateMarketingList400Response {
    ...
    public CreateMarketingList400Response() {}

    private CreateMarketingList400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public CreateMarketingList400Response build() {
            return new CreateMarketingList400Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            CreateMarketingList400Response.class.getSimpleName() + "(",
            ")"
        );
