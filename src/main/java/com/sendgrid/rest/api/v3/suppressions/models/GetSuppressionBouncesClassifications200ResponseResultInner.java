...
public class GetSuppressionBouncesClassifications200ResponseResultInner {
    ...
    @Getter
    @Setter
    private List<GetSuppressionBouncesClassifications200ResponseResultInnerStatsInner> stats;

    public GetSuppressionBouncesClassifications200ResponseResultInner() {
    }

    private GetSuppressionBouncesClassifications200ResponseResultInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder stats(List<GetSuppressionBouncesClassifications200ResponseResultInnerStatsInner> stats) {
            this.stats = stats;
            return this;
        }

        public GetSuppressionBouncesClassifications200ResponseResultInner build() {
            return new GetSuppressionBouncesClassifications200ResponseResultInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetSuppressionBouncesClassifications200ResponseResultInner.class.getSimpleName() + "(", ")");
