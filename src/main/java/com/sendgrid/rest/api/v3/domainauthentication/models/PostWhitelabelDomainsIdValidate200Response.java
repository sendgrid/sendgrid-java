...
@ToString
public class PostWhitelabelDomainsIdValidate200Response {
    ...
    @Getter
    @Setter
    private PostWhitelabelDomainsIdValidate200ResponseValidationResults validationResults;

    public PostWhitelabelDomainsIdValidate200Response() {
    }

    private PostWhitelabelDomainsIdValidate200Response(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public Builder validationResults(PostWhitelabelDomainsIdValidate200ResponseValidationResults validationResults) {
            this.validationResults = validationResults;
            return this;
        }

        public PostWhitelabelDomainsIdValidate200Response build() {
            return new PostWhitelabelDomainsIdValidate200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelDomainsIdValidate200Response.class.getSimpleName() + "(", ")");
