...
import com.sendgrid.rest.api.v3.templates.models.PostTemplatesTemplateIdRequest;
import com.sendgrid.rest.api.v3.templates.models.TransactionalTemplate;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PostTemplatesById {
    private final String templateId;
    private String onBehalfOf;
    private final PostTemplatesTemplateIdRequest postTemplatesTemplateIdRequest;
    ...
    public TransactionalTemplate send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostTemplatesById creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (postTemplatesTemplateIdRequest != null) {
            builder.body(JsonUtil.toJson(postTemplatesTemplateIdRequest));
        }
    }
