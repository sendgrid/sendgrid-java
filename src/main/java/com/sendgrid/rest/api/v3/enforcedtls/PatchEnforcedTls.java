...
public class PatchEnforcedTls {
    private String onBehalfOf;
    private final EnforcedTlsRequestResponse enforcedTlsRequestResponse;
    ...
    public EnforcedTlsRequestResponse send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchEnforcedTls creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (enforcedTlsRequestResponse != null) {
            builder.body(JsonUtil.toJson(enforcedTlsRequestResponse));
        }
    }
