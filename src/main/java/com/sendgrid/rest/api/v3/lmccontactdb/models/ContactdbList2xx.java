...
public class ContactdbList2xx {
    ...
    public ContactdbList2xx() {
    }

    private ContactdbList2xx(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public Builder(Integer id, String name, Integer recipientCount) {
            this.id = id;
            this.name = name;
            this.recipientCount = recipientCount;
        }

        public ContactdbList2xx build() {
            return new ContactdbList2xx(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", ContactdbList2xx.class.getSimpleName() + "(", ")");
