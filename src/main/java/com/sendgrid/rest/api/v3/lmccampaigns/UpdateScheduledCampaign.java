...
public class UpdateScheduledCampaign extends ApiKeyBase {
    ...
    @Setter
    private UpdateAScheduledCampaignRequest updateAScheduledCampaignRequest;

    public ApiResponse<UpdateAScheduledCampaignResponse> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateScheduledCampaign creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                UpdateAScheduledCampaignResponse.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (updateAScheduledCampaignRequest != null) {
            request.addBody(JsonUtil.toJson(updateAScheduledCampaignRequest));
        }
    }
}
