...
@ToString
public class PostSendIpsPoolsPoolIdIps200Response {
    ...
    public PostSendIpsPoolsPoolIdIps200Response() {
    }

    private PostSendIpsPoolsPoolIdIps200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostSendIpsPoolsPoolIdIps200Response build() {
            return new PostSendIpsPoolsPoolIdIps200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostSendIpsPoolsPoolIdIps200Response.class.getSimpleName() + "(", ")");
