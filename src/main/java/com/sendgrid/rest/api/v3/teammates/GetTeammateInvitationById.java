...
import com.sendgrid.rest.api.v3.teammates.models.GetTeammatesUsername200Response;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetTeammateInvitationById {
    private final String username;
    private String onBehalfOf;


    public GetTeammatesUsername200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetTeammateInvitationById creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), GetTeammatesUsername200Response.class);
    }
