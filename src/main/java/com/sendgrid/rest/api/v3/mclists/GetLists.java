...
import com.sendgrid.rest.api.v3.mclists.models.GetMarketingLists200Response;
...
public class GetLists {
    ...
    public GetMarketingLists200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetLists creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), GetMarketingLists200Response.class);
    }
