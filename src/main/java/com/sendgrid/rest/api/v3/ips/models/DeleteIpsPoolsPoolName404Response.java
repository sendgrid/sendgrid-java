...
@ToString
public class DeleteIpsPoolsPoolName404Response {
    ...
    public DeleteIpsPoolsPoolName404Response() {
    }

    private DeleteIpsPoolsPoolName404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteIpsPoolsPoolName404Response build() {
            return new DeleteIpsPoolsPoolName404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteIpsPoolsPoolName404Response.class.getSimpleName() + "(", ")");
