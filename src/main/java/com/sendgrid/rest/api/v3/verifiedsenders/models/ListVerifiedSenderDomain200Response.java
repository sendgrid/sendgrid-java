...
import com.sendgrid.rest.api.v3.verifiedsenders.models.ListVerifiedSenderDomain200ResponseResults;
...
@ToString
public class ListVerifiedSenderDomain200Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("results")
    @Getter
    @Setter
    private ListVerifiedSenderDomain200ResponseResults results;

    public ListVerifiedSenderDomain200Response() {}

    private ListVerifiedSenderDomain200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(ListVerifiedSenderDomain200ResponseResults results) {
            this.results = results;
        }

        public ListVerifiedSenderDomain200Response build() {
            return new ListVerifiedSenderDomain200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListVerifiedSenderDomain200Response.class.getSimpleName() + "(",
            ")"
        );
