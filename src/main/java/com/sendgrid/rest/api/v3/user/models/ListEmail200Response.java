...
@ToString
public class ListEmail200Response {
    ...
    public ListEmail200Response() {}

    private ListEmail200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListEmail200Response build() {
            return new ListEmail200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListEmail200Response.class.getSimpleName() + "(",
            ")"
        );
