...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.PostSendIpsPoolsPoolIdIps200Response;
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.PostSendIpsPoolsPoolIdIpsRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PostIpPoolIpBatchAdd {
    private final String poolid;
    private final PostSendIpsPoolsPoolIdIpsRequest postSendIpsPoolsPoolIdIpsRequest;


    public PostSendIpsPoolsPoolIdIps200Response send(final TokenRestClient client) {
        String path = "/v3/send_ips/pools/{poolid}/ips:batchAdd";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostIpPoolIpBatchAdd creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PostSendIpsPoolsPoolIdIps200Response.class);
    }


    private void body(final Request.Builder builder) {
        if (postSendIpsPoolsPoolIdIpsRequest != null) {
            builder.body(JsonUtil.toJson(postSendIpsPoolsPoolIdIpsRequest));
        }
    }
