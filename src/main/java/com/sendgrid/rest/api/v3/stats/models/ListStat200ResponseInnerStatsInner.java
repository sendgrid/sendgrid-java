...
import com.sendgrid.rest.api.v3.stats.models.StatsAdvancedGlobalStats;
...
@ToString
public class ListStat200ResponseInnerStatsInner {
    ...
    public ListStat200ResponseInnerStatsInner() {}

    private ListStat200ResponseInnerStatsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListStat200ResponseInnerStatsInner build() {
            return new ListStat200ResponseInnerStatsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListStat200ResponseInnerStatsInner.class.getSimpleName() + "(",
            ")"
        );
