...
public class ListSuppressionBouncesClassifications extends ApiKeyBase {
    ...
    public ApiResponse<ListSuppressionBouncesClassifications200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListSuppressionBouncesClassifications creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListSuppressionBouncesClassifications200Response.class
            ),
            response.getHeaders()
        );
    }
