...
import com.sendgrid.rest.api.v3.mccontacts.models.GetImportContact400Response;
...
public class GetImportContact extends ApiKeyBase {

    private final String id;

    public ApiResponse<ContactImport> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetImportContact creation failed: Unable to connect to server"
            );
        } else if (
            ...
            if (Matcher.matches(Integer.toString(statusCode), "400")) {
                GetImportContact400Response error = JsonUtil.fromJson(
                    response.getStream(),
                    GetImportContact400Response.class
                );
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), ContactImport.class),
            response.getHeaders()
        );
    }
