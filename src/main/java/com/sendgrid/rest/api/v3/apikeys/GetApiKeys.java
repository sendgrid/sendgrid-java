...
import com.sendgrid.rest.api.v3.apikeys.models.GetApiKeys200Response;
...
public class GetApiKeys {
    ...
    public GetApiKeys200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetApiKeys creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetApiKeys200Response.class);
    }
