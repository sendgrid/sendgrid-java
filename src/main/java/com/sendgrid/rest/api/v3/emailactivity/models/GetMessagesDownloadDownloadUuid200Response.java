...
@ToString
public class GetMessagesDownloadDownloadUuid200Response {
    ...
    public GetMessagesDownloadDownloadUuid200Response() {
    }

    private GetMessagesDownloadDownloadUuid200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMessagesDownloadDownloadUuid200Response build() {
            return new GetMessagesDownloadDownloadUuid200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMessagesDownloadDownloadUuid200Response.class.getSimpleName() + "(", ")");
