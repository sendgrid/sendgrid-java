...
import com.sendgrid.rest.api.v3.emailvalidation.models.GetValidationsEmailJobs200Response;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetValidationsEmailJobs extends ApiKeyBase {

    public ApiResponse<GetValidationsEmailJobs200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetValidationsEmailJobs creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                GetValidationsEmailJobs200Response.class
            ),
            response.getHeaders()
        );
    }
