...
@ToString
public class GetAsmSuppressionsEmail200Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("suppressions")
    @Getter
    @Setter
    private List<GetAsmSuppressionsEmail200ResponseSuppressionsInner> suppressions;

    public GetAsmSuppressionsEmail200Response() {
    }

    private GetAsmSuppressionsEmail200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<GetAsmSuppressionsEmail200ResponseSuppressionsInner> suppressions) {
            this.suppressions = suppressions;
        }

        public GetAsmSuppressionsEmail200Response build() {
            return new GetAsmSuppressionsEmail200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetAsmSuppressionsEmail200Response.class.getSimpleName() + "(", ")");
        if (suppressions != null) joiner.add("suppressions=" + suppressions);
