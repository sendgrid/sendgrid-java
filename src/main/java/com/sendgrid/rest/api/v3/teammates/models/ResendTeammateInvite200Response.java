...
@ToString
public class ResendTeammateInvite200Response {
    ...
    public ResendTeammateInvite200Response() {}

    private ResendTeammateInvite200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ResendTeammateInvite200Response build() {
            return new ResendTeammateInvite200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ResendTeammateInvite200Response.class.getSimpleName() + "(",
            ")"
        );
