...
public class PostActivateTemplateVersion {
    ...
    public TransactionalTemplateVersionOutput send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostActivateTemplateVersion creation failed: Unable to connect to server"
            );
