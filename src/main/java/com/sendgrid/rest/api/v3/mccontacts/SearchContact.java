...
import com.sendgrid.rest.api.v3.mccontacts.models.SearchContact200Response;
import com.sendgrid.rest.api.v3.mccontacts.models.SearchContact400Response;
import com.sendgrid.rest.api.v3.mccontacts.models.SearchContact500Response;
import com.sendgrid.rest.api.v3.mccontacts.models.SearchContactRequest;
...
public class SearchContact extends ApiKeyBase {

    @Setter
    private SearchContactRequest searchContactRequest;

    public ApiResponse<SearchContact200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "SearchContact creation failed: Unable to connect to server"
            );
        } else if (
            ...
            if (Matcher.matches(Integer.toString(statusCode), "400")) {
                SearchContact400Response error = JsonUtil.fromJson(
                    response.getStream(),
                    SearchContact400Response.class
                );
    ...
    private void addBody(final Request request) {
        if (searchContactRequest != null) {
            request.addBody(JsonUtil.toJson(searchContactRequest));
        }
    }
}
