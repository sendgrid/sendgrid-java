...
@ToString
public class DeleteContactIdentifierRequest {
    ...
    public DeleteContactIdentifierRequest() {}

    private DeleteContactIdentifierRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteContactIdentifierRequest build() {
            return new DeleteContactIdentifierRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            DeleteContactIdentifierRequest.class.getSimpleName() + "(",
            ")"
        );
        if (identifierType != null) joiner.add(
            "identifierType=" + identifierType
        );
        if (identifierValue != null) joiner.add(
