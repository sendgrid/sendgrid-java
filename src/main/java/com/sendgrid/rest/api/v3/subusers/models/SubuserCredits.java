...
public class SubuserCredits {
    ...
    public static class Builder {
        ...
        public Builder(Type type, ResetFrequency resetFrequency, Integer remain, Integer total, Integer used) {
            this.type = type;
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SubuserCredits.class.getSimpleName() + "(", ")");
