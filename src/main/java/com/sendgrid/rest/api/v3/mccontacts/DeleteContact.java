...
import com.sendgrid.rest.api.v3.mccontacts.models.DeleteContact202Response;
...
public class DeleteContact extends ApiKeyBase {

    @Setter
    private String deleteAllContacts;

    @Setter
    private String ids;

    public ApiResponse<DeleteContact202Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DeleteContact creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                DeleteContact202Response.class
            ),
            response.getHeaders()
        );
    }
