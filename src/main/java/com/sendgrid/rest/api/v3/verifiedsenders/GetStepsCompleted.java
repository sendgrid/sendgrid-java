...
import com.sendgrid.rest.api.v3.verifiedsenders.models.GetVerifiedSendersStepsCompleted200Response;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetStepsCompleted {


    public GetVerifiedSendersStepsCompleted200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetStepsCompleted creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetVerifiedSendersStepsCompleted200Response.class);
    }
