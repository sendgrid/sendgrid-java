...
@ToString
public class ListMessage400ResponseErrorsInner {
    ...
    public ListMessage400ResponseErrorsInner() {}

    private ListMessage400ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListMessage400ResponseErrorsInner build() {
            return new ListMessage400ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListMessage400ResponseErrorsInner.class.getSimpleName() + "(",
            ")"
        );
