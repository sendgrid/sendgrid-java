...
import com.sendgrid.rest.api.v3.linkbranding.models.Valid;
import com.sendgrid.rest.api.v3.linkbranding.models.ValidateBrandedLink200ResponseValidationResults;
...
@ToString
public class ValidateBrandedLink200Response {
    ...
    @Getter
    @Setter
    private ValidateBrandedLink200ResponseValidationResults validationResults;

    public ValidateBrandedLink200Response() {}

    private ValidateBrandedLink200Response(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public Builder(
            Integer id,
            Valid valid,
            ValidateBrandedLink200ResponseValidationResults validationResults
        ) {
            this.id = id;
            this.valid = valid;
        ...
        public ValidateBrandedLink200Response build() {
            return new ValidateBrandedLink200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ValidateBrandedLink200Response.class.getSimpleName() + "(",
            ")"
        );
