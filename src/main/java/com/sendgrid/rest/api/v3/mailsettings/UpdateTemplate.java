...
import com.sendgrid.rest.api.v3.mailsettings.models.UpdateTemplate200Response;
import com.sendgrid.rest.api.v3.mailsettings.models.UpdateTemplateRequest;
...
public class UpdateTemplate extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private UpdateTemplateRequest updateTemplateRequest;

    public ApiResponse<UpdateTemplate200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateTemplate creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                UpdateTemplate200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (updateTemplateRequest != null) {
            request.addBody(JsonUtil.toJson(updateTemplateRequest));
        }
    }
}
