...
public class GetRecipient extends ApiKeyBase {
    ...
    public ApiResponse<ContactdbRecipient200> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetRecipient creation failed: Unable to connect to server"
            );
        } else if (
