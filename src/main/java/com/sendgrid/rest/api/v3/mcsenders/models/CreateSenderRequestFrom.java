...
@ToString
public class CreateSenderRequestFrom {
    ...
    public CreateSenderRequestFrom() {}

    private CreateSenderRequestFrom(Builder builder) {
    ...
    public static class Builder {
        ...
        public CreateSenderRequestFrom build() {
            return new CreateSenderRequestFrom(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            CreateSenderRequestFrom.class.getSimpleName() + "(",
            ")"
        );
