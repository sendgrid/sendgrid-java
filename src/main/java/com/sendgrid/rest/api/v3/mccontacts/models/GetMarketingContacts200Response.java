...
@ToString
public class GetMarketingContacts200Response {
    ...
    public GetMarketingContacts200Response() {
    }

    private GetMarketingContacts200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMarketingContacts200Response build() {
            return new GetMarketingContacts200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingContacts200Response.class.getSimpleName() + "(", ")");
