...
import com.sendgrid.rest.api.v3.mcsegments.models.ListSegment500ResponseErrorsInner;
...
@ToString
public class ListSegment500Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<ListSegment500ResponseErrorsInner> errors;

    public ListSegment500Response() {}

    private ListSegment500Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<ListSegment500ResponseErrorsInner> errors) {
            this.errors = errors;
        }

        public ListSegment500Response build() {
            return new ListSegment500Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListSegment500Response.class.getSimpleName() + "(",
            ")"
        );
