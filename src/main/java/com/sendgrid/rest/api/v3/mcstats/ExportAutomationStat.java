...
public class ExportAutomationStat extends ApiKeyBase {
    ...
    public ApiResponse<String> send(final ApiKeyRestClient client) {
        String path = "/v3/marketing/stats/automations/export";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ExportAutomationStat creation failed: Unable to connect to server"
            );
        } else if (
