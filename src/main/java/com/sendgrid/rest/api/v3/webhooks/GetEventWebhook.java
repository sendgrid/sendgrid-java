...
public class GetEventWebhook extends ApiKeyBase {
    ...
    public ApiResponse<EventWebhookNoDatesResponse> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetEventWebhook creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                EventWebhookNoDatesResponse.class
            ),
            response.getHeaders()
        );
    }
