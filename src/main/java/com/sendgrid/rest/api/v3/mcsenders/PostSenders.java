...
import com.sendgrid.rest.api.v3.mcsenders.models.PostMarketingSendersRequest;
...
public class PostSenders {
    ...
    private final PostMarketingSendersRequest postMarketingSendersRequest;
    ...
    private void body(final Request.Builder builder) {
        if (postMarketingSendersRequest != null) {
            builder.body(JsonUtil.toJson(postMarketingSendersRequest));
        }
    }
