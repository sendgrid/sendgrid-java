...
import com.sendgrid.rest.api.v3.ips.models.DeleteIpFromIpPool404Response;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class DeleteIpFromIpPool extends ApiKeyBase {
    ...
    public ApiResponse<Object> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DeleteIpFromIpPool creation failed: Unable to connect to server"
            );
        } else if (
            ...
            if (Matcher.matches(Integer.toString(statusCode), "404")) {
                DeleteIpFromIpPool404Response error = JsonUtil.fromJson(
                    response.getStream(),
                    DeleteIpFromIpPool404Response.class
                );
