...
import com.sendgrid.rest.api.v3.mccontacts.models.ListExportContact200ResponseMetadata;
import com.sendgrid.rest.api.v3.mccontacts.models.ListExportContact200ResponseResultInner;
...
@ToString
public class ListExportContact200Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private List<ListExportContact200ResponseResultInner> result;

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("_metadata")
    @Getter
    @Setter
    private ListExportContact200ResponseMetadata metadata;

    public ListExportContact200Response() {}

    private ListExportContact200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder result(
            List<ListExportContact200ResponseResultInner> result
        ) {
            this.result = result;
            return this;
        }

        public Builder metadata(ListExportContact200ResponseMetadata metadata) {
            this.metadata = metadata;
            return this;
        }

        public ListExportContact200Response build() {
            return new ListExportContact200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListExportContact200Response.class.getSimpleName() + "(",
            ")"
        );
