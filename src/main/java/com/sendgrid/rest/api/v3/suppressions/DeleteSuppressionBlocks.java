...
public class DeleteSuppressionBlocks extends ApiKeyBase {
    ...
    public ApiResponse<Object> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DeleteSuppressionBlocks creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (deleteSuppressionBlocksRequest != null) {
            request.addBody(JsonUtil.toJson(deleteSuppressionBlocksRequest));
        }
    }
}
