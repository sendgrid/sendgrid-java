...
@ToString
public class SendMailRequestMailSettingsBypassSpamManagement {
    ...
    public SendMailRequestMailSettingsBypassSpamManagement() {}

    private SendMailRequestMailSettingsBypassSpamManagement(Builder builder) {
    ...
    public static class Builder {
        ...
        public SendMailRequestMailSettingsBypassSpamManagement build() {
            return new SendMailRequestMailSettingsBypassSpamManagement(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SendMailRequestMailSettingsBypassSpamManagement.class.getSimpleName() +
            "(",
            ")"
        );
