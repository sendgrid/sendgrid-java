...
@ToString
public class GetUserEmail200Response {
    ...
    public GetUserEmail200Response() {
    }

    private GetUserEmail200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetUserEmail200Response build() {
            return new GetUserEmail200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetUserEmail200Response.class.getSimpleName() + "(", ")");
