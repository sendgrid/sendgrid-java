...
import com.sendgrid.rest.api.v3.lmccontactdb.models.GetContactdbRecipientsRecipientIdLists200Response;
...
public class GetRecipientList {
    ...
    public GetContactdbRecipientsRecipientIdLists200Response send(final TokenRestClient client) {
        String path = "/v3/contactdb/recipients/{recipient_id}/lists";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetRecipientList creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetContactdbRecipientsRecipientIdLists200Response.class);
    }
