...
import com.sendgrid.rest.api.v3.mcdesigns.models.UpdateDesignRequest;
...
public class UpdateDesign extends ApiKeyBase {

    private final UUID id;

    @Setter
    private UpdateDesignRequest updateDesignRequest;
    ...
    public ApiResponse<DesignOutput> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateDesign creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (updateDesignRequest != null) {
            request.addBody(JsonUtil.toJson(updateDesignRequest));
        }
    }
}
