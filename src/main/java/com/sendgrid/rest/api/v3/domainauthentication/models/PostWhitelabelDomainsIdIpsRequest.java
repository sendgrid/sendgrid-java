...
@ToString
public class PostWhitelabelDomainsIdIpsRequest {
    ...
    public PostWhitelabelDomainsIdIpsRequest() {
    }

    private PostWhitelabelDomainsIdIpsRequest(Builder builder) {
        this.ip = builder.ip;
    }
    ...
    public static class Builder {
        ...
        public PostWhitelabelDomainsIdIpsRequest build() {
            return new PostWhitelabelDomainsIdIpsRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelDomainsIdIpsRequest.class.getSimpleName() + "(", ")");
