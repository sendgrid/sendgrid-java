...
@ToString
public class GetIpsPoolsPoolName404ResponseErrorsInner {
    ...
    public GetIpsPoolsPoolName404ResponseErrorsInner() {
    }

    private GetIpsPoolsPoolName404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetIpsPoolsPoolName404ResponseErrorsInner build() {
            return new GetIpsPoolsPoolName404ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetIpsPoolsPoolName404ResponseErrorsInner.class.getSimpleName() + "(", ")");
