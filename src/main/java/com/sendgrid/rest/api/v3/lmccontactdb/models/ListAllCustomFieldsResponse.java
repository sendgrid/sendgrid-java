...
@ToString
public class ListAllCustomFieldsResponse {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("custom_fields")
    @Getter
    @Setter
    private List<ContactdbCustomFieldId2xx> customFields;

    public ListAllCustomFieldsResponse() {}

    private ListAllCustomFieldsResponse(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<ContactdbCustomFieldId2xx> customFields) {
            this.customFields = customFields;
        }

        public ListAllCustomFieldsResponse build() {
            return new ListAllCustomFieldsResponse(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListAllCustomFieldsResponse.class.getSimpleName() + "(",
            ")"
        );
