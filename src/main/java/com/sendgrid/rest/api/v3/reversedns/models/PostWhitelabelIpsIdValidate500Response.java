...
@ToString
public class PostWhitelabelIpsIdValidate500Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<PostWhitelabelIpsIdValidate500ResponseErrorsInner> errors;

    public PostWhitelabelIpsIdValidate500Response() {
    }

    private PostWhitelabelIpsIdValidate500Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<PostWhitelabelIpsIdValidate500ResponseErrorsInner> errors) {
            this.errors = errors;
        }

        public PostWhitelabelIpsIdValidate500Response build() {
            return new PostWhitelabelIpsIdValidate500Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelIpsIdValidate500Response.class.getSimpleName() + "(", ")");
