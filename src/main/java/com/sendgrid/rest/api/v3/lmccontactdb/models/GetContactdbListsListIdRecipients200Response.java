...
@ToString
public class GetContactdbListsListIdRecipients200Response {
    ...
    public GetContactdbListsListIdRecipients200Response() {
    }

    private GetContactdbListsListIdRecipients200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetContactdbListsListIdRecipients200Response build() {
            return new GetContactdbListsListIdRecipients200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetContactdbListsListIdRecipients200Response.class.getSimpleName() + "(", ")");
