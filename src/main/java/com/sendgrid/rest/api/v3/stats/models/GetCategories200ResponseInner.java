...
@ToString
public class GetCategories200ResponseInner {
    ...
    public GetCategories200ResponseInner() {
    }

    private GetCategories200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetCategories200ResponseInner build() {
            return new GetCategories200ResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetCategories200ResponseInner.class.getSimpleName() + "(", ")");
        if (category != null) joiner.add("category=" + category);
