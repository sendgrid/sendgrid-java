...
public class Patch20ById {
    private final String segmentId;
    private final SegmentUpdate segmentUpdate;
    ...
    public Segment2xx send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "Patch20ById creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (segmentUpdate != null) {
            builder.body(JsonUtil.toJson(segmentUpdate));
        }
    }
