...
@ToString
public class PostMailSendRequestMailSettingsSandboxMode {
    ...
    public PostMailSendRequestMailSettingsSandboxMode() {
    }

    private PostMailSendRequestMailSettingsSandboxMode(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMailSendRequestMailSettingsSandboxMode build() {
            return new PostMailSendRequestMailSettingsSandboxMode(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMailSendRequestMailSettingsSandboxMode.class.getSimpleName() + "(", ")");
