...
``` bash
javac -classpath ../repo/com/sendgrid/5.0.0-rc.23/sendgrid-5.0.0-rc.23-jar.jar:. Example.java && java -classpath ../repo/com/sendgrid/5.0.0-rc.23/sendgrid-5.0.0-rc.23-jar.jar:. Example
```
