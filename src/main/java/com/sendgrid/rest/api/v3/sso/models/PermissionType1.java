...
public enum PermissionType1 {
    ...
    private PermissionType1(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static PermissionType1 fromString(final String value) {
        return CustomDeserializer. enum (value, PermissionType1.values());
    }
