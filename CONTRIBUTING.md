...
``` bash
javac -classpath ../repo/com/sendgrid/5.0.0-rc.2/sendgrid-5.0.0-rc.2-jar.jar:. Example.java && java -classpath ../repo/com/sendgrid/5.0.0-rc.2/sendgrid-5.0.0-rc.2-jar.jar:. Example
```
