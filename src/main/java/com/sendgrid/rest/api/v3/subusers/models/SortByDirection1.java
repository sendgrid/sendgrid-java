...
public enum SortByDirection1 {
    ...
    private SortByDirection1(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static SortByDirection1 forValue(final String value) {
        return Promoter.enumFromString(value, SortByDirection1.values());
    }
}
