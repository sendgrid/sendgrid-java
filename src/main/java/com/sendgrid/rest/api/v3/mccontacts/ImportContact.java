...
public class ImportContact extends ApiKeyBase {

    @Setter
    private ImportContactRequest importContactRequest;

    public ApiResponse<ImportContact200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ImportContact creation failed: Unable to connect to server"
            );
        } else if (
            ...
            if (Matcher.matches(Integer.toString(statusCode), "400")) {
                ImportContact400Response error = JsonUtil.fromJson(
                    response.getStream(),
                    ImportContact400Response.class
                );
            ...
            if (Matcher.matches(Integer.toString(statusCode), "404")) {
                ImportContact404Response error = JsonUtil.fromJson(
                    response.getStream(),
                    ImportContact404Response.class
                );
                throw new ApiErrorResponse(
                    statusCode,
                    null,
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ImportContact200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (importContactRequest != null) {
            request.addBody(JsonUtil.toJson(importContactRequest));
        }
    }
}
