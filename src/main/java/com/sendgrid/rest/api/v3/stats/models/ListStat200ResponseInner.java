...
import com.sendgrid.rest.api.v3.stats.models.ListStat200ResponseInnerStatsInner;
...
@ToString
public class ListStat200ResponseInner {
    ...
    @Getter
    @Setter
    private List<ListStat200ResponseInnerStatsInner> stats;

    public ListStat200ResponseInner() {}

    private ListStat200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(
            String date,
            List<ListStat200ResponseInnerStatsInner> stats
        ) {
            this.date = date;
            this.stats = stats;
        }

        public ListStat200ResponseInner build() {
            return new ListStat200ResponseInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListStat200ResponseInner.class.getSimpleName() + "(",
            ")"
        );
