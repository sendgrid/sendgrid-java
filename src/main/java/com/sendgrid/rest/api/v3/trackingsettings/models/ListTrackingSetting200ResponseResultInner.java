...
@ToString
public class ListTrackingSetting200ResponseResultInner {
    ...
    public ListTrackingSetting200ResponseResultInner() {}

    private ListTrackingSetting200ResponseResultInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListTrackingSetting200ResponseResultInner build() {
            return new ListTrackingSetting200ResponseResultInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListTrackingSetting200ResponseResultInner.class.getSimpleName() +
            "(",
            ")"
        );
