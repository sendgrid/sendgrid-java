...
import com.sendgrid.rest.api.v3.domainauthentication.models.PatchWhitelabelDomainsDomainIdRequest;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PatchWhitelabelDomainById {
    private final String domainId;
    private String onBehalfOf;
    private final PatchWhitelabelDomainsDomainIdRequest patchWhitelabelDomainsDomainIdRequest;
    ...
    public List<AuthenticatedDomain> send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchWhitelabelDomainById creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (patchWhitelabelDomainsDomainIdRequest != null) {
            builder.body(JsonUtil.toJson(patchWhitelabelDomainsDomainIdRequest));
        }
    }
