...
@ToString
public class PostMailSendRequestMailSettingsBypassListManagement {
    ...
    public PostMailSendRequestMailSettingsBypassListManagement() {
    }

    private PostMailSendRequestMailSettingsBypassListManagement(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMailSendRequestMailSettingsBypassListManagement build() {
            return new PostMailSendRequestMailSettingsBypassListManagement(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMailSendRequestMailSettingsBypassListManagement.class.getSimpleName() + "(", ")");
