...
@ToString
public class EmailDnsRecordRequest {
    ...
    public EmailDnsRecordRequest() {}

    private EmailDnsRecordRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public EmailDnsRecordRequest build() {
            return new EmailDnsRecordRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            EmailDnsRecordRequest.class.getSimpleName() + "(",
            ")"
        );
