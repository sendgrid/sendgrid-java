...
@ToString
public class SinglesendsLinkStatsResponseResultsInner {
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("abVariation")
    @Getter
    @Setter
    private UUID abVariation;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("abPhase")
    @Getter
    @Setter
    private AbPhase1 abPhase;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("clicks")
    @Getter
    @Setter
    ...
    public SinglesendsLinkStatsResponseResultsInner() {
    }

    private SinglesendsLinkStatsResponseResultsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(URI url, UUID abVariation, AbPhase1 abPhase, Integer clicks) {
            this.url = url;
        ...
        public SinglesendsLinkStatsResponseResultsInner build() {
            return new SinglesendsLinkStatsResponseResultsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SinglesendsLinkStatsResponseResultsInner.class.getSimpleName() + "(", ")");
