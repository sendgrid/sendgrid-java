...
@ToString
public class PatchMarketingFieldDefinitionsCustomFieldIdRequest {
    ...
    public PatchMarketingFieldDefinitionsCustomFieldIdRequest() {
    }

    private PatchMarketingFieldDefinitionsCustomFieldIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchMarketingFieldDefinitionsCustomFieldIdRequest build() {
            return new PatchMarketingFieldDefinitionsCustomFieldIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchMarketingFieldDefinitionsCustomFieldIdRequest.class.getSimpleName() + "(", ")");
