...
@ToString
public class PutMarketingContactsRequest {
    ...
    public PutMarketingContactsRequest() {
    }

    private PutMarketingContactsRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PutMarketingContactsRequest build() {
            return new PutMarketingContactsRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutMarketingContactsRequest.class.getSimpleName() + "(", ")");
