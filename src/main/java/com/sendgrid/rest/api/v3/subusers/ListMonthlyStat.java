...
import com.sendgrid.rest.api.v3.subusers.models.SortByDirection1;
import com.sendgrid.rest.api.v3.subusers.models.SortByMetric;
...
public class ListMonthlyStat extends ApiKeyBase {
    ...
    @Setter
    private SortByMetric sortByMetric;

    @Setter
    private SortByDirection1 sortByDirection;
    ...
    public ApiResponse<SubuserStats> send(final ApiKeyRestClient client) {
        String path = "/v3/subusers/stats/monthly";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListMonthlyStat creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), SubuserStats.class),
            response.getHeaders()
        );
    }
