...
@ToString
public class GetVerifiedSenders200Response {
    ...
    public GetVerifiedSenders200Response() {
    }

    private GetVerifiedSenders200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetVerifiedSenders200Response build() {
            return new GetVerifiedSenders200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetVerifiedSenders200Response.class.getSimpleName() + "(", ")");
