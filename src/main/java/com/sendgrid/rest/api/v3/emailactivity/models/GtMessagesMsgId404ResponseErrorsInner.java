...
@ToString
public class GtMessagesMsgId404ResponseErrorsInner {
    ...
    public GtMessagesMsgId404ResponseErrorsInner() {
    }

    private GtMessagesMsgId404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GtMessagesMsgId404ResponseErrorsInner build() {
            return new GtMessagesMsgId404ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GtMessagesMsgId404ResponseErrorsInner.class.getSimpleName() + "(", ")");
