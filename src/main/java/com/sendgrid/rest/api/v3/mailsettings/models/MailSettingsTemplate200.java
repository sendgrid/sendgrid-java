...
@ToString
public class MailSettingsTemplate200 {
    ...
    public MailSettingsTemplate200() {
    }

    private MailSettingsTemplate200(Builder builder) {
    ...
    public static class Builder {
        ...
        public MailSettingsTemplate200 build() {
            return new MailSettingsTemplate200(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", MailSettingsTemplate200.class.getSimpleName() + "(", ")");
