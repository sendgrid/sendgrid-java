...
@ToString
public class GetMarketingSinglesendsCategories200Response {
    ...
    public GetMarketingSinglesendsCategories200Response() {
    }

    private GetMarketingSinglesendsCategories200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMarketingSinglesendsCategories200Response build() {
            return new GetMarketingSinglesendsCategories200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingSinglesendsCategories200Response.class.getSimpleName() + "(", ")");
