...
public class AddSuppressionToAsmGroup extends ApiKeyBase {
    ...
    public ApiResponse<AddSuppressionToAsmGroup201Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "AddSuppressionToAsmGroup creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                AddSuppressionToAsmGroup201Response.class
            ),
            response.getHeaders()
        );
    }
