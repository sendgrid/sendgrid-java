...
public enum EventName1 {
    ...
    private EventName1(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static EventName1 fromString(final String value) {
        return CustomDeserializer. enum (value, EventName1.values());
    }
