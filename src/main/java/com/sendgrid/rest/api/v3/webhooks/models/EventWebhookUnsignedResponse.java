...
@ToString
public class EventWebhookUnsignedResponse {
    ...
    private EventWebhookUnsignedResponse(Builder builder) {
    ...
    public static class Builder {
        ...
        public EventWebhookUnsignedResponse build() {
            return new EventWebhookUnsignedResponse(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", EventWebhookUnsignedResponse.class.getSimpleName() + "(", ")");
