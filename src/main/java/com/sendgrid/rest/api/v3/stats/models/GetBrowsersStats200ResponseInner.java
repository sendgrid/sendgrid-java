...
@ToString
public class GetBrowsersStats200ResponseInner {
    ...
    @Getter
    @Setter
    private List<GetBrowsersStats200ResponseInnerStatsInner> stats;

    public GetBrowsersStats200ResponseInner() {
    }

    private GetBrowsersStats200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder stats(List<GetBrowsersStats200ResponseInnerStatsInner> stats) {
            this.stats = stats;
            return this;
        }

        public GetBrowsersStats200ResponseInner build() {
            return new GetBrowsersStats200ResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetBrowsersStats200ResponseInner.class.getSimpleName() + "(", ")");
