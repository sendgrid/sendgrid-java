...
@ToString
public class PatchSendIpsIpsIp200Response {
    ...
    public PatchSendIpsIpsIp200Response() {
    }

    private PatchSendIpsIpsIp200Response(Builder builder) {
        this.ip = builder.ip;
    ...
    public static class Builder {
        ...
        public PatchSendIpsIpsIp200Response build() {
            return new PatchSendIpsIpsIp200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchSendIpsIpsIp200Response.class.getSimpleName() + "(", ")");
