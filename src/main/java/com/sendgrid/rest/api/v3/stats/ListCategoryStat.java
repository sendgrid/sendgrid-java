...
public class ListCategoryStat extends ApiKeyBase {
    ...
    public ApiResponse<List<CategoryStats>> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListCategoryStat creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addQueryParams(Request request) {
        ...
        if (categories != null) {
            request.addQueryParam("categories", categories.toString());
        }
