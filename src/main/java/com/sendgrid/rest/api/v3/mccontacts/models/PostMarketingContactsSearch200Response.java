...
@ToString
public class PostMarketingContactsSearch200Response {
    ...
    public PostMarketingContactsSearch200Response() {
    }

    private PostMarketingContactsSearch200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingContactsSearch200Response build() {
            return new PostMarketingContactsSearch200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingContactsSearch200Response.class.getSimpleName() + "(", ")");
