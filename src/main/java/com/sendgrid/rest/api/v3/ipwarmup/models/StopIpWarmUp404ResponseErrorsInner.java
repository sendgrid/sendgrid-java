...
@ToString
public class StopIpWarmUp404ResponseErrorsInner {
    ...
    public StopIpWarmUp404ResponseErrorsInner() {}

    private StopIpWarmUp404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public StopIpWarmUp404ResponseErrorsInner build() {
            return new StopIpWarmUp404ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            StopIpWarmUp404ResponseErrorsInner.class.getSimpleName() + "(",
            ")"
        );
