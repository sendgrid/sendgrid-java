...
@ToString
public class PatchMailSettingsAddressWhitelistRequest {
    ...
    public PatchMailSettingsAddressWhitelistRequest() {
    }

    private PatchMailSettingsAddressWhitelistRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchMailSettingsAddressWhitelistRequest build() {
            return new PatchMailSettingsAddressWhitelistRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchMailSettingsAddressWhitelistRequest.class.getSimpleName() + "(", ")");
