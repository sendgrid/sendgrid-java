...
@ToString
public class PostVerifiedSenders400Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<PostVerifiedSenders400ResponseErrorsInner> errors;

    public PostVerifiedSenders400Response() {
    }

    private PostVerifiedSenders400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<PostVerifiedSenders400ResponseErrorsInner> errors) {
            this.errors = errors;
        }

        public PostVerifiedSenders400Response build() {
            return new PostVerifiedSenders400Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostVerifiedSenders400Response.class.getSimpleName() + "(", ")");
