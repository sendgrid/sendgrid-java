...
public class GetExportContact extends ApiKeyBase {

    private final String id;

    public ApiResponse<ContactExport> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetExportContact creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), ContactExport.class),
            response.getHeaders()
        );
    }
