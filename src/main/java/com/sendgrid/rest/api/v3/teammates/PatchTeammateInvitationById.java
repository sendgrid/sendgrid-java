...
import com.sendgrid.rest.api.v3.teammates.models.PatchTeammatesUsername200Response;
import com.sendgrid.rest.api.v3.teammates.models.PatchTeammatesUsernameRequest;
...
public class PatchTeammateInvitationById {
    private final String username;
    private String onBehalfOf;
    private final PatchTeammatesUsernameRequest patchTeammatesUsernameRequest;


    public PatchTeammatesUsername200Response send(final TokenRestClient client) {
        String path = "/v3/teammates/{username}";
        Request.Builder builder = new Request.Builder(HttpMethod.PATCH, path)
                .addPathParam("username", username.toString());
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchTeammateInvitationById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PatchTeammatesUsername200Response.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (patchTeammatesUsernameRequest != null) {
            builder.body(JsonUtil.toJson(patchTeammatesUsernameRequest));
        }
    }
