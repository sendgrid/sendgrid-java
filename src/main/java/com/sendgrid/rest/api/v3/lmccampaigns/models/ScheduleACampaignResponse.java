...
import com.sendgrid.rest.api.v3.lmccampaigns.models.Status;
...
@ToString
public class ScheduleACampaignResponse {
    ...
    public ScheduleACampaignResponse() {}

    private ScheduleACampaignResponse(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public Builder(Integer id, Integer sendAt, Status status) {
            this.id = id;
            this.sendAt = sendAt;
            this.status = status;
        }

        public ScheduleACampaignResponse build() {
            return new ScheduleACampaignResponse(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ScheduleACampaignResponse.class.getSimpleName() + "(",
            ")"
        );
