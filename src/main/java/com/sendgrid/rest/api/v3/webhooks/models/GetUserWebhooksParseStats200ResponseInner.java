...
@ToString
public class GetUserWebhooksParseStats200ResponseInner {
    ...
    @Getter
    @Setter
    private List<GetUserWebhooksParseStats200ResponseInnerStatsInner> stats;

    public GetUserWebhooksParseStats200ResponseInner() {
    }

    private GetUserWebhooksParseStats200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(String date, List<GetUserWebhooksParseStats200ResponseInnerStatsInner> stats) {
            this.date = date;
            this.stats = stats;
        }

        public GetUserWebhooksParseStats200ResponseInner build() {
            return new GetUserWebhooksParseStats200ResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetUserWebhooksParseStats200ResponseInner.class.getSimpleName() + "(", ")");
