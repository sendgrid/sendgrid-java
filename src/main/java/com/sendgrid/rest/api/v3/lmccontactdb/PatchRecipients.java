...
import com.sendgrid.rest.api.v3.lmccontactdb.models.PatchContactdbRecipientsRequestInner;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PatchRecipients {
    private String onBehalfOf;
    private final List<PatchContactdbRecipientsRequestInner> patchContactdbRecipientsRequestInner;
    ...
    public ContactdbRecipientResponse201 send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchRecipients creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (patchContactdbRecipientsRequestInner != null) {
            builder.body(JsonUtil.toJson(patchContactdbRecipientsRequestInner));
        }
    }
