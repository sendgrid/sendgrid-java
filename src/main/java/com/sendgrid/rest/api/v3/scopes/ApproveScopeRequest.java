...
public class ApproveScopeRequest extends ApiKeyBase {

    private final String requestId;

    public ApiResponse<ApproveScopeRequest200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ApproveScopeRequest creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ApproveScopeRequest200Response.class
            ),
            response.getHeaders()
        );
    }
