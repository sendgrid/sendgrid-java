...
import com.sendgrid.rest.api.v3.subusers.models.UpdateSubuserWebsiteAccessRequest;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class UpdateSubuserWebsiteAccess extends ApiKeyBase {
    ...
    public ApiResponse<Object> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateSubuserWebsiteAccess creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (updateSubuserWebsiteAccessRequest != null) {
            request.addBody(JsonUtil.toJson(updateSubuserWebsiteAccessRequest));
        }
    }
}
