...
@ToString
public class GetTeammatesTeammateNameSubuserAccess400Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetTeammatesTeammateNameSubuserAccess400ResponseErrorsInner> errors;

    public GetTeammatesTeammateNameSubuserAccess400Response() {
    }

    private GetTeammatesTeammateNameSubuserAccess400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<GetTeammatesTeammateNameSubuserAccess400ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public GetTeammatesTeammateNameSubuserAccess400Response build() {
            return new GetTeammatesTeammateNameSubuserAccess400Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetTeammatesTeammateNameSubuserAccess400Response.class.getSimpleName() + "(", ")");
