...
public class UpdateSubscriptionTrackingSetting extends ApiKeyBase {
    ...
    public ApiResponse<SubscriptionTrackingSettings> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateSubscriptionTrackingSetting creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                SubscriptionTrackingSettings.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (subscriptionTrackingSettings != null) {
            request.addBody(JsonUtil.toJson(subscriptionTrackingSettings));
        }
    }
}
