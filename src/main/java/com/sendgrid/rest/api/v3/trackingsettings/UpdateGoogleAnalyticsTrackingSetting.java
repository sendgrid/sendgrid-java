...
public class UpdateGoogleAnalyticsTrackingSetting extends ApiKeyBase {
    ...
    public ApiResponse<GoogleAnalyticsSettings> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateGoogleAnalyticsTrackingSetting creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (googleAnalyticsSettings != null) {
            request.addBody(JsonUtil.toJson(googleAnalyticsSettings));
        }
    }
}
