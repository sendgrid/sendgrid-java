...
@ToString
public class GetImportContact400Response {
    ...
    public GetImportContact400Response() {}

    private GetImportContact400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetImportContact400Response build() {
            return new GetImportContact400Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetImportContact400Response.class.getSimpleName() + "(",
            ")"
        );
