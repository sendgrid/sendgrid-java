...
import com.sendgrid.rest.api.v3.linkbranding.models.PostWhitelabelLinksRequest;
...
public class PostLinks {
    ...
    private final PostWhitelabelLinksRequest postWhitelabelLinksRequest;
    ...
    public LinkBranding200 send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostLinks creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (postWhitelabelLinksRequest != null) {
            builder.body(JsonUtil.toJson(postWhitelabelLinksRequest));
        }
    }
