...
import com.sendgrid.rest.api.v3.suppressions.models.GetAsmSuppressionsEmail200Response;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetSuppressionsById {
    private final String email;
    private String onBehalfOf;


    public GetAsmSuppressionsEmail200Response send(final TokenRestClient client) {
        String path = "/v3/asm/suppressions/{email}";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetSuppressionsById creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), GetAsmSuppressionsEmail200Response.class);
    }
