...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.PostSendIpsPools201Response;
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.PostSendIpsPoolsRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PostIpPool {
    private final PostSendIpsPoolsRequest postSendIpsPoolsRequest;


    public PostSendIpsPools201Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostIpPool creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PostSendIpsPools201Response.class);
    }


    private void body(final Request.Builder builder) {
        if (postSendIpsPoolsRequest != null) {
            builder.body(JsonUtil.toJson(postSendIpsPoolsRequest));
        }
    }
