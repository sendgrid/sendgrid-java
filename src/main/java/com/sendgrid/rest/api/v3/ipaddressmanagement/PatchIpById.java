...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.PatchSendIpsIpsIp200Response;
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.PatchSendIpsIpsIpRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PatchIpById {
    private final String ip;
    private final PatchSendIpsIpsIpRequest patchSendIpsIpsIpRequest;


    public PatchSendIpsIpsIp200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchIpById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PatchSendIpsIpsIp200Response.class);
    }


    private void body(final Request.Builder builder) {
        if (patchSendIpsIpsIpRequest != null) {
            builder.body(JsonUtil.toJson(patchSendIpsIpsIpRequest));
        }
    }
