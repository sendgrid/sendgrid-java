...
public class DeleteVerifiedSender extends ApiKeyBase {
    ...
    public ApiResponse<Object> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DeleteVerifiedSender creation failed: Unable to connect to server"
            );
        } else if (
            ...
            if (Matcher.matches(Integer.toString(statusCode), "403")) {
                DeleteVerifiedSender403Response error = JsonUtil.fromJson(
                    response.getStream(),
                    DeleteVerifiedSender403Response.class
                );
                throw new ApiErrorResponse(
                    statusCode,
                    null,
