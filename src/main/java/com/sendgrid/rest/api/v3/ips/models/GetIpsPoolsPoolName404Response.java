...
@ToString
public class GetIpsPoolsPoolName404Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetIpsPoolsPoolName404ResponseErrorsInner> errors;

    public GetIpsPoolsPoolName404Response() {
    }

    private GetIpsPoolsPoolName404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<GetIpsPoolsPoolName404ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public GetIpsPoolsPoolName404Response build() {
            return new GetIpsPoolsPoolName404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetIpsPoolsPoolName404Response.class.getSimpleName() + "(", ")");
