...
@ToString
public class SenderRequestFrom {
    ...
    public SenderRequestFrom() {
    }

    private SenderRequestFrom(Builder builder) {
    ...
    public static class Builder {
        ...
        public SenderRequestFrom build() {
            return new SenderRequestFrom(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SenderRequestFrom.class.getSimpleName() + "(", ")");
