...
@ToString
public class PostMarketingFieldDefinitions400Response {
    ...
    public PostMarketingFieldDefinitions400Response() {
    }

    private PostMarketingFieldDefinitions400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingFieldDefinitions400Response build() {
            return new PostMarketingFieldDefinitions400Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingFieldDefinitions400Response.class.getSimpleName() + "(", ")");
