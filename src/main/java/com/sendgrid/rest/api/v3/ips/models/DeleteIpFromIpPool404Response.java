...
@ToString
public class DeleteIpFromIpPool404Response {
    ...
    public DeleteIpFromIpPool404Response() {}

    private DeleteIpFromIpPool404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteIpFromIpPool404Response build() {
            return new DeleteIpFromIpPool404Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            DeleteIpFromIpPool404Response.class.getSimpleName() + "(",
            ")"
        );
