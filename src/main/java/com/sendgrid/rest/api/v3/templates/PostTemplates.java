...
import com.sendgrid.rest.api.v3.templates.models.PostTemplatesRequest;
...
public class PostTemplates {
    ...
    private final PostTemplatesRequest postTemplatesRequest;
    ...
    public TransactionalTemplate send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostTemplates creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (postTemplatesRequest != null) {
            builder.body(JsonUtil.toJson(postTemplatesRequest));
        }
    }
