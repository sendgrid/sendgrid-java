...
import com.sendgrid.rest.api.v3.mccontacts.models.PostMarketingContactsSearch200Response;
import com.sendgrid.rest.api.v3.mccontacts.models.PostMarketingContactsSearch400Response;
import com.sendgrid.rest.api.v3.mccontacts.models.PostMarketingContactsSearch500Response;
import com.sendgrid.rest.api.v3.mccontacts.models.PostMarketingContactsSearchRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PostMarketingContactSearch {
    private final PostMarketingContactsSearchRequest postMarketingContactsSearchRequest;


    public PostMarketingContactsSearch200Response send(final TokenRestClient client) {
        String path = "/v3/marketing/contacts/search";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostMarketingContactSearch creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
            if (Matcher.matches(Integer.toString(statusCode), "400")) {
                PostMarketingContactsSearch400Response error = JsonUtil.fromJson(
                        response.getStream(),
                        PostMarketingContactsSearch400Response.class
                );
            ...
            if (Matcher.matches(Integer.toString(statusCode), "408")) {
        ...
        return JsonUtil.fromJson(response.getStream(), PostMarketingContactsSearch200Response.class);
    }


    private void body(final Request.Builder builder) {
        if (postMarketingContactsSearchRequest != null) {
            builder.body(JsonUtil.toJson(postMarketingContactsSearchRequest));
        }
    }
