...
public class ListRecipient extends ApiKeyBase {
    ...
    public ApiResponse<ListRecipientsResponse> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListRecipient creation failed: Unable to connect to server"
            );
        } else if (
