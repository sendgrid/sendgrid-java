...
@ToString
public class SearchContact400ResponseErrorsInner {
    ...
    public SearchContact400ResponseErrorsInner() {}

    private SearchContact400ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public SearchContact400ResponseErrorsInner build() {
            return new SearchContact400ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SearchContact400ResponseErrorsInner.class.getSimpleName() + "(",
            ")"
        );
