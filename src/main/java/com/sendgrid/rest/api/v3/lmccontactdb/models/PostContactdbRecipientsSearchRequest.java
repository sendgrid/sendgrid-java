...
@ToString
public class PostContactdbRecipientsSearchRequest {
    ...
    public PostContactdbRecipientsSearchRequest() {
    }

    private PostContactdbRecipientsSearchRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(Integer listId, List<ContactdbSegmentsConditions> conditions) {
            this.listId = listId;
            this.conditions = conditions;
        }

        public PostContactdbRecipientsSearchRequest build() {
            return new PostContactdbRecipientsSearchRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostContactdbRecipientsSearchRequest.class.getSimpleName() + "(", ")");
