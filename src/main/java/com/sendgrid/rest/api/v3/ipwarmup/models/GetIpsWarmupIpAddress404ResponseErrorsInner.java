...
@ToString
public class GetIpsWarmupIpAddress404ResponseErrorsInner {
    ...
    public GetIpsWarmupIpAddress404ResponseErrorsInner() {
    }

    private GetIpsWarmupIpAddress404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetIpsWarmupIpAddress404ResponseErrorsInner build() {
            return new GetIpsWarmupIpAddress404ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetIpsWarmupIpAddress404ResponseErrorsInner.class.getSimpleName() + "(", ")");
