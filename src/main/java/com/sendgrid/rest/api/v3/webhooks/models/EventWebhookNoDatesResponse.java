...
@ToString
public class EventWebhookNoDatesResponse {
    ...
    public EventWebhookNoDatesResponse() {
    }

    private EventWebhookNoDatesResponse(Builder builder) {
    ...
    public static class Builder {
        ...
        public EventWebhookNoDatesResponse build() {
            return new EventWebhookNoDatesResponse(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", EventWebhookNoDatesResponse.class.getSimpleName() + "(", ")");
