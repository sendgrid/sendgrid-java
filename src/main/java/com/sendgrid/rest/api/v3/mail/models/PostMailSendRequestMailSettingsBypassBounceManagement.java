...
@ToString
public class PostMailSendRequestMailSettingsBypassBounceManagement {
    ...
    public PostMailSendRequestMailSettingsBypassBounceManagement() {
    }

    private PostMailSendRequestMailSettingsBypassBounceManagement(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMailSendRequestMailSettingsBypassBounceManagement build() {
            return new PostMailSendRequestMailSettingsBypassBounceManagement(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMailSendRequestMailSettingsBypassBounceManagement.class.getSimpleName() + "(", ")");
