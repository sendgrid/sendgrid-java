...
@ToString
public class ListSegment500ResponseErrorsInner {
    ...
    public ListSegment500ResponseErrorsInner() {}

    private ListSegment500ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListSegment500ResponseErrorsInner build() {
            return new ListSegment500ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListSegment500ResponseErrorsInner.class.getSimpleName() + "(",
            ")"
        );
