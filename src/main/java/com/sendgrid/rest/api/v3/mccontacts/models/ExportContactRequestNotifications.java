...
@ToString
public class ExportContactRequestNotifications {
    ...
    public ExportContactRequestNotifications() {}

    private ExportContactRequestNotifications(Builder builder) {
    ...
    public static class Builder {
        ...
        public ExportContactRequestNotifications build() {
            return new ExportContactRequestNotifications(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ExportContactRequestNotifications.class.getSimpleName() + "(",
            ")"
        );
