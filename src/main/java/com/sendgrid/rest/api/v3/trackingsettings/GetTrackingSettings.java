...
import com.sendgrid.rest.api.v3.trackingsettings.models.GetTrackingSettings200Response;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetTrackingSettings {
    private String onBehalfOf;


    public GetTrackingSettings200Response send(final TokenRestClient client) {
        String path = "/v3/tracking_settings";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetTrackingSettings creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), GetTrackingSettings200Response.class);
    }
