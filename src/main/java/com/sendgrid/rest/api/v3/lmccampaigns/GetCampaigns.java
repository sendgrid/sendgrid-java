...
import com.sendgrid.rest.api.v3.lmccampaigns.models.GetCampaigns200Response;
...
public class GetCampaigns {
    ...
    public GetCampaigns200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetCampaigns creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), GetCampaigns200Response.class);
    }
