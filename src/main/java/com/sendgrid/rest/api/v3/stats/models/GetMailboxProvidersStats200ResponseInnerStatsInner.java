...
@ToString
public class GetMailboxProvidersStats200ResponseInnerStatsInner {
    ...
    public GetMailboxProvidersStats200ResponseInnerStatsInner() {
    }

    private GetMailboxProvidersStats200ResponseInnerStatsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMailboxProvidersStats200ResponseInnerStatsInner build() {
            return new GetMailboxProvidersStats200ResponseInnerStatsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMailboxProvidersStats200ResponseInnerStatsInner.class.getSimpleName() + "(", ")");
