...
import com.sendgrid.rest.api.v3.ips.models.GetIpPool404ResponseErrorsInner;
...
@ToString
public class GetIpPool404Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetIpPool404ResponseErrorsInner> errors;

    public GetIpPool404Response() {}

    private GetIpPool404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<GetIpPool404ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public GetIpPool404Response build() {
            return new GetIpPool404Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetIpPool404Response.class.getSimpleName() + "(",
            ")"
        );
