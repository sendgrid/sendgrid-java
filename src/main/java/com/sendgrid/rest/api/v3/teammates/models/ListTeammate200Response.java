...
import com.sendgrid.rest.api.v3.teammates.models.ListTeammate200ResponseResultInner;
...
@ToString
public class ListTeammate200Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private List<ListTeammate200ResponseResultInner> result;

    public ListTeammate200Response() {}

    private ListTeammate200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder result(List<ListTeammate200ResponseResultInner> result) {
            this.result = result;
            return this;
        }

        public ListTeammate200Response build() {
            return new ListTeammate200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListTeammate200Response.class.getSimpleName() + "(",
            ")"
        );
