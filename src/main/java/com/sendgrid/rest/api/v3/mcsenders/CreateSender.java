...
import com.sendgrid.rest.api.v3.mcsenders.models.CreateSenderRequest;
...
public class CreateSender extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private CreateSenderRequest createSenderRequest;
    ...
    public ApiResponse<Sender> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "CreateSender creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (createSenderRequest != null) {
            request.addBody(JsonUtil.toJson(createSenderRequest));
        }
    }
}
