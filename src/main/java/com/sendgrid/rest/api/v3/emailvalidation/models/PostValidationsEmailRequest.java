...
@ToString
public class PostValidationsEmailRequest {
    ...
    public PostValidationsEmailRequest() {
    }

    private PostValidationsEmailRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostValidationsEmailRequest build() {
            return new PostValidationsEmailRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostValidationsEmailRequest.class.getSimpleName() + "(", ")");
