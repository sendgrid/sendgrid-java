...
import com.sendgrid.rest.api.v3.webhooks.models.GetUserWebhooksEventSettingsSignedId200Response;
import com.sendgrid.rest.api.v3.webhooks.models.PatchUserWebhooksEventSettingsSignedIdRequest;
...
public class PatchSignedWebhookEventById {
    private final String id;
    private String onBehalfOf;
    private final PatchUserWebhooksEventSettingsSignedIdRequest patchUserWebhooksEventSettingsSignedIdRequest;


    public GetUserWebhooksEventSettingsSignedId200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchSignedWebhookEventById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetUserWebhooksEventSettingsSignedId200Response.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (patchUserWebhooksEventSettingsSignedIdRequest != null) {
            builder.body(JsonUtil.toJson(patchUserWebhooksEventSettingsSignedIdRequest));
        }
    }
