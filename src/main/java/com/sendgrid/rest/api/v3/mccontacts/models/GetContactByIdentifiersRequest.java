...
@ToString
public class GetContactByIdentifiersRequest {
    ...
    private GetContactByIdentifiersRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetContactByIdentifiersRequest build() {
            return new GetContactByIdentifiersRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetContactByIdentifiersRequest.class.getSimpleName() + "(",
            ")"
        );
