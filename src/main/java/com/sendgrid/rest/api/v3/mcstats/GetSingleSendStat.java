...
import com.sendgrid.rest.api.v3.mcstats.models.Items1;
...
public class GetSingleSendStat extends ApiKeyBase {
    ...
    @Setter
    private List<Items1> groupBy;

    public ApiResponse<SinglesendsResponse> send(
        final ApiKeyRestClient client
    ) {
        String path = "/v3/marketing/stats/singlesends/{id}";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetSingleSendStat creation failed: Unable to connect to server"
            );
        } else if (
