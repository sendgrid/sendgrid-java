...
@ToString
public class GetIpPool404ResponseErrorsInner {
    ...
    public GetIpPool404ResponseErrorsInner() {}

    private GetIpPool404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetIpPool404ResponseErrorsInner build() {
            return new GetIpPool404ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetIpPool404ResponseErrorsInner.class.getSimpleName() + "(",
            ")"
        );
