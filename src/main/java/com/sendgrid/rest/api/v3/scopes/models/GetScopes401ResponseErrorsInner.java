...
@ToString
public class GetScopes401ResponseErrorsInner {
    ...
    public GetScopes401ResponseErrorsInner() {
    }

    private GetScopes401ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetScopes401ResponseErrorsInner build() {
            return new GetScopes401ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetScopes401ResponseErrorsInner.class.getSimpleName() + "(", ")");
