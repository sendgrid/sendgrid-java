...
@ToString
public class UpdateIpPool404ResponseErrorsInner {
    ...
    public UpdateIpPool404ResponseErrorsInner() {}

    private UpdateIpPool404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateIpPool404ResponseErrorsInner build() {
            return new UpdateIpPool404ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateIpPool404ResponseErrorsInner.class.getSimpleName() + "(",
            ")"
        );
