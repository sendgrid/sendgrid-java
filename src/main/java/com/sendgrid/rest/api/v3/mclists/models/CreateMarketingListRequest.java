...
@ToString
public class CreateMarketingListRequest {
    ...
    public CreateMarketingListRequest() {}

    private CreateMarketingListRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public CreateMarketingListRequest build() {
            return new CreateMarketingListRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            CreateMarketingListRequest.class.getSimpleName() + "(",
            ")"
        );
