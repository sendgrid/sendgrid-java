...
@ToString
public class PostWhitelabelIpsIdValidate404ResponseErrorsInner {
    ...
    public PostWhitelabelIpsIdValidate404ResponseErrorsInner() {
    }

    private PostWhitelabelIpsIdValidate404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostWhitelabelIpsIdValidate404ResponseErrorsInner build() {
            return new PostWhitelabelIpsIdValidate404ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelIpsIdValidate404ResponseErrorsInner.class.getSimpleName() + "(", ")");
