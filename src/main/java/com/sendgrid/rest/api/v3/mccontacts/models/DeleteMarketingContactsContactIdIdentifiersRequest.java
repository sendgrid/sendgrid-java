...
@ToString
public class DeleteMarketingContactsContactIdIdentifiersRequest {
    ...
    public DeleteMarketingContactsContactIdIdentifiersRequest() {
    }

    private DeleteMarketingContactsContactIdIdentifiersRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteMarketingContactsContactIdIdentifiersRequest build() {
            return new DeleteMarketingContactsContactIdIdentifiersRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteMarketingContactsContactIdIdentifiersRequest.class.getSimpleName() + "(", ")");
        if (identifierType != null) joiner.add("identifierType=" + identifierType);
        if (identifierValue != null) joiner.add("identifierValue=" + identifierValue);
