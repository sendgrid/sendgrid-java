...
@ToString
public class PatchUserWebhooksEventSettingsSignedIdRequest {
    ...
    public PatchUserWebhooksEventSettingsSignedIdRequest() {
    }

    private PatchUserWebhooksEventSettingsSignedIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchUserWebhooksEventSettingsSignedIdRequest build() {
            return new PatchUserWebhooksEventSettingsSignedIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchUserWebhooksEventSettingsSignedIdRequest.class.getSimpleName() + "(", ")");
