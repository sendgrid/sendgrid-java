...
@ToString
public class PutIpsPoolsPoolName404Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<PutIpsPoolsPoolName404ResponseErrorsInner> errors;

    public PutIpsPoolsPoolName404Response() {
    }

    private PutIpsPoolsPoolName404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<PutIpsPoolsPoolName404ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public PutIpsPoolsPoolName404Response build() {
            return new PutIpsPoolsPoolName404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutIpsPoolsPoolName404Response.class.getSimpleName() + "(", ")");
