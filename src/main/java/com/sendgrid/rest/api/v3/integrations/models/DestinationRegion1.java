...
public enum DestinationRegion1 {
    ...
    private DestinationRegion1(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static DestinationRegion1 forValue(final String value) {
        return Promoter.enumFromString(value, DestinationRegion1.values());
    }
}
