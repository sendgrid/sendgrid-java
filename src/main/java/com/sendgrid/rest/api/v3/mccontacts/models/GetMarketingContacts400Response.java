...
@ToString
public class GetMarketingContacts400Response {
    ...
    public GetMarketingContacts400Response() {
    }

    private GetMarketingContacts400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<ContactsError> errors) {
            this.errors = errors;
            return this;
        }

        public GetMarketingContacts400Response build() {
            return new GetMarketingContacts400Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingContacts400Response.class.getSimpleName() + "(", ")");
