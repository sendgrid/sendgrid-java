...
import com.sendgrid.rest.api.v3.suppressions.models.CreateGlobalSuppression201Response;
...
public class CreateGlobalSuppression extends ApiKeyBase {
    ...
    public ApiResponse<CreateGlobalSuppression201Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "CreateGlobalSuppression creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                CreateGlobalSuppression201Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (suppressionsRequest != null) {
            request.addBody(JsonUtil.toJson(suppressionsRequest));
        }
    }
}
