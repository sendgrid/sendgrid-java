...
@ToString
public class PostWhitelabelDomainsDomainIdSubuserRequest {
    ...
    public PostWhitelabelDomainsDomainIdSubuserRequest() {
    }

    private PostWhitelabelDomainsDomainIdSubuserRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostWhitelabelDomainsDomainIdSubuserRequest build() {
            return new PostWhitelabelDomainsDomainIdSubuserRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelDomainsDomainIdSubuserRequest.class.getSimpleName() + "(", ")");
