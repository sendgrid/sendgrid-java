...
import com.sendgrid.rest.api.v3.suppressions.models.ListSuppressionBouncesClassifications200ResponseResultInnerStatsInner;
...
@ToString
public class ListSuppressionBouncesClassifications200ResponseResultInner {
    ...
    public ListSuppressionBouncesClassifications200ResponseResultInner() {}

    private ListSuppressionBouncesClassifications200ResponseResultInner(
        Builder builder
    ) {
    ...
    public static class Builder {
        ...
        public ListSuppressionBouncesClassifications200ResponseResultInner build() {
            return new ListSuppressionBouncesClassifications200ResponseResultInner(
                this
            );
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListSuppressionBouncesClassifications200ResponseResultInner.class.getSimpleName() +
            "(",
            ")"
        );
