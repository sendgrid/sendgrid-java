...
@ToString
public class PutSubusersSubuserNameIps200Response {
    ...
    public PutSubusersSubuserNameIps200Response() {
    }

    private PutSubusersSubuserNameIps200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PutSubusersSubuserNameIps200Response build() {
            return new PutSubusersSubuserNameIps200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutSubusersSubuserNameIps200Response.class.getSimpleName() + "(", ")");
