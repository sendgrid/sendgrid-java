...
@ToString
public class ListIp200ResponseResultInnerPoolsInner {
    ...
    public ListIp200ResponseResultInnerPoolsInner() {}

    private ListIp200ResponseResultInnerPoolsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListIp200ResponseResultInnerPoolsInner build() {
            return new ListIp200ResponseResultInnerPoolsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListIp200ResponseResultInnerPoolsInner.class.getSimpleName() + "(",
            ")"
        );
