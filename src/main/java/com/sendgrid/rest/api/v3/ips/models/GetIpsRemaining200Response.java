...
@ToString
public class GetIpsRemaining200Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("results")
    @Getter
    @Setter
    private List<GetIpsRemaining200ResponseResultsInner> results;

    public GetIpsRemaining200Response() {
    }

    private GetIpsRemaining200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<GetIpsRemaining200ResponseResultsInner> results) {
            this.results = results;
        }

        public GetIpsRemaining200Response build() {
            return new GetIpsRemaining200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetIpsRemaining200Response.class.getSimpleName() + "(", ")");
