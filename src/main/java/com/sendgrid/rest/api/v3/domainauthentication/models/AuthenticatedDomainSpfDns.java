...
public class AuthenticatedDomainSpfDns {
    ...
    public static class Builder {
        ...
        public Builder(AuthenticatedDomainSpfDnsMailServer mailServer, AuthenticatedDomainSpfDnsSubdomainSpf subdomainSpf, AuthenticatedDomainSpfDnsDomainSpf domainSpf, AuthenticatedDomainSpfDnsDkim dkim) {
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", AuthenticatedDomainSpfDns.class.getSimpleName() + "(", ")");
