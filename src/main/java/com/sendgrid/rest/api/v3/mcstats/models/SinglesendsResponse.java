...
public class SinglesendsResponse {
    ...
    public static class Builder {
        ...
        public Builder(List<SinglesendsResponseResultsInner> results, Metadata metadata) {
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SinglesendsResponse.class.getSimpleName() + "(", ")");
