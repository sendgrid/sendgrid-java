...
import com.sendgrid.rest.api.v3.reversedns.models.PostWhitelabelIpsRequest;
...
public class PostIps {
    ...
    private final PostWhitelabelIpsRequest postWhitelabelIpsRequest;
    ...
    private void body(final Request.Builder builder) {
        if (postWhitelabelIpsRequest != null) {
            builder.body(JsonUtil.toJson(postWhitelabelIpsRequest));
        }
    }
