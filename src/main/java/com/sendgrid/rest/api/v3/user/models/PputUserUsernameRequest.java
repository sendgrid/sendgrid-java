...
@ToString
public class PputUserUsernameRequest {
    ...
    public PputUserUsernameRequest() {
    }

    private PputUserUsernameRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PputUserUsernameRequest build() {
            return new PputUserUsernameRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PputUserUsernameRequest.class.getSimpleName() + "(", ")");
