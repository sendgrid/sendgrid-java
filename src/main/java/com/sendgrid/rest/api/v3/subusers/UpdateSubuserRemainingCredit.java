...
import com.sendgrid.rest.api.v3.subusers.models.UpdateSubuserRemainingCreditRequest;
...
public class UpdateSubuserRemainingCredit extends ApiKeyBase {

    private final String subuserName;

    @Setter
    private UpdateSubuserRemainingCreditRequest updateSubuserRemainingCreditRequest;
    ...
    public ApiResponse<SubuserCredits> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateSubuserRemainingCredit creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (updateSubuserRemainingCreditRequest != null) {
            request.addBody(
                JsonUtil.toJson(updateSubuserRemainingCreditRequest)
            );
        }
    }
}
