...
public class AuthenticatedDomain {
    ...
    @Getter
    @Setter
    private AuthenticatedDomainDns dns;
    ...
    public static class Builder {
        ...
        public Builder(BigDecimal id, BigDecimal userId, String subdomain, String domain, String username, List<String> ips, Boolean customSpf, Boolean _default, Boolean legacy, Boolean automaticSecurity, Boolean valid, AuthenticatedDomainDns dns) {
            this.id = id;
            this.userId = userId;
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", AuthenticatedDomain.class.getSimpleName() + "(", ")");
