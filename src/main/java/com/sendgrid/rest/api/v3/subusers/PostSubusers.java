...
import com.sendgrid.rest.api.v3.subusers.models.PostSubusersRequest;
...
public class PostSubusers {
    private final PostSubusersRequest postSubusersRequest;


    public SubuserPost send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostSubusers creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), SubuserPost.class);
    }


    private void body(final Request.Builder builder) {
        if (postSubusersRequest != null) {
            builder.body(JsonUtil.toJson(postSubusersRequest));
        }
    }
