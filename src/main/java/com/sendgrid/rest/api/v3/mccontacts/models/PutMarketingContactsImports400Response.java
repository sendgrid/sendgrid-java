...
@ToString
public class PutMarketingContactsImports400Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<ContactsError> errors;

    public PutMarketingContactsImports400Response() {
    }

    private PutMarketingContactsImports400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<ContactsError> errors) {
            this.errors = errors;
        }

        public PutMarketingContactsImports400Response build() {
            return new PutMarketingContactsImports400Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutMarketingContactsImports400Response.class.getSimpleName() + "(", ")");
