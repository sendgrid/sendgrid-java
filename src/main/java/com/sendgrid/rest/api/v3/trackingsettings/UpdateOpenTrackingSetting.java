...
import com.sendgrid.rest.api.v3.trackingsettings.models.ListOpenTrackingSetting200Response;
import com.sendgrid.rest.api.v3.trackingsettings.models.UpdateOpenTrackingSettingRequest;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class UpdateOpenTrackingSetting extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private UpdateOpenTrackingSettingRequest updateOpenTrackingSettingRequest;

    public ApiResponse<ListOpenTrackingSetting200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateOpenTrackingSetting creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListOpenTrackingSetting200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (updateOpenTrackingSettingRequest != null) {
            request.addBody(JsonUtil.toJson(updateOpenTrackingSettingRequest));
        }
    }
}
