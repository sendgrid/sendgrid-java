...
import com.sendgrid.rest.api.v3.lmccontactdb.models.ContactdbCustomFieldId2xx;
import com.sendgrid.rest.api.v3.lmccontactdb.models.ErrorResponse;
import com.sendgrid.rest.api.v3.lmccontactdb.models.PostContactdbCustomFieldsRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PostCustomFields {
    private String onBehalfOf;
    private final PostContactdbCustomFieldsRequest postContactdbCustomFieldsRequest;


    public ContactdbCustomFieldId2xx send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostCustomFields creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ContactdbCustomFieldId2xx.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (postContactdbCustomFieldsRequest != null) {
            builder.body(JsonUtil.toJson(postContactdbCustomFieldsRequest));
        }
    }
