...
@ToString
public class AddIpToIpPoolRequest {
    ...
    public AddIpToIpPoolRequest() {}

    private AddIpToIpPoolRequest(Builder builder) {
        this.ip = builder.ip;
    }
    ...
    public static class Builder {
        ...
        public AddIpToIpPoolRequest build() {
            return new AddIpToIpPoolRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            AddIpToIpPoolRequest.class.getSimpleName() + "(",
            ")"
        );
