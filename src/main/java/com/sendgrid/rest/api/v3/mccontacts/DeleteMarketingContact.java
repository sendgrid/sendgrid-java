...
import com.sendgrid.rest.api.v3.mccontacts.models.DeleteMarketingContacts202Response;
...
public class DeleteMarketingContact {
    ...
    public DeleteMarketingContacts202Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "DeleteMarketingContact creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), DeleteMarketingContacts202Response.class);
    }
