...
import com.sendgrid.rest.api.v3.mccontacts.models.SearchContact400ResponseErrorsInner;
...
@ToString
public class SearchContact400Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<SearchContact400ResponseErrorsInner> errors;

    public SearchContact400Response() {}

    private SearchContact400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(
            List<SearchContact400ResponseErrorsInner> errors
        ) {
            this.errors = errors;
            return this;
        }

        public SearchContact400Response build() {
            return new SearchContact400Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SearchContact400Response.class.getSimpleName() + "(",
            ")"
        );
