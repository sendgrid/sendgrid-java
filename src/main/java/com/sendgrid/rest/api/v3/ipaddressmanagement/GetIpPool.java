...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.GetSendIpsIpsIpSubusersBatchDelete200Response;
...
public class GetIpPool {
    ...
    public GetSendIpsIpsIpSubusersBatchDelete200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetIpPool creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetSendIpsIpsIpSubusersBatchDelete200Response.class);
    }
