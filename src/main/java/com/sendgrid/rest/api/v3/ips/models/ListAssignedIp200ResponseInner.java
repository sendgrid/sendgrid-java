...
@ToString
public class ListAssignedIp200ResponseInner {
    ...
    public ListAssignedIp200ResponseInner() {}

    private ListAssignedIp200ResponseInner(Builder builder) {
        this.ip = builder.ip;
    ...
    public static class Builder {
        ...
        public ListAssignedIp200ResponseInner build() {
            return new ListAssignedIp200ResponseInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListAssignedIp200ResponseInner.class.getSimpleName() + "(",
            ")"
        );
