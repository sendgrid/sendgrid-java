...
@ToString
public class PputUserUsername200Response {
    ...
    public PputUserUsername200Response() {
    }

    private PputUserUsername200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PputUserUsername200Response build() {
            return new PputUserUsername200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PputUserUsername200Response.class.getSimpleName() + "(", ")");
