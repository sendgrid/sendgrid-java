...
import com.sendgrid.rest.api.v3.mccontacts.models.ListContactByEmail200Response;
import com.sendgrid.rest.api.v3.mccontacts.models.ListContactByEmailRequest;
...
public class ListContactByEmail extends ApiKeyBase {

    @Setter
    private ListContactByEmailRequest listContactByEmailRequest;

    public ApiResponse<ListContactByEmail200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListContactByEmail creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListContactByEmail200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (listContactByEmailRequest != null) {
            request.addBody(JsonUtil.toJson(listContactByEmailRequest));
        }
    }
}
