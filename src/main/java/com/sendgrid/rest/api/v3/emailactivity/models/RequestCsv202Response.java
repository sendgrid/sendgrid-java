...
import com.sendgrid.rest.api.v3.emailactivity.models.Status2;
...
@ToString
public class RequestCsv202Response {
    ...
    public RequestCsv202Response() {}

    private RequestCsv202Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public RequestCsv202Response build() {
            return new RequestCsv202Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            RequestCsv202Response.class.getSimpleName() + "(",
            ")"
        );
