...
public class ContactExport {
    ...
    public static class Builder {
        ...
        public Builder(String id, Status status, String createdAt, String updatedAt, String expiresAt) {
            this.id = id;
            this.status = status;
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", ContactExport.class.getSimpleName() + "(", ")");
