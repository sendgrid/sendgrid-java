...
@ToString
public class GetSegment404ResponseErrorsInner {
    ...
    public GetSegment404ResponseErrorsInner() {}

    private GetSegment404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetSegment404ResponseErrorsInner build() {
            return new GetSegment404ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetSegment404ResponseErrorsInner.class.getSimpleName() + "(",
            ")"
        );
