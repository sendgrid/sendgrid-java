...
import com.sendgrid.rest.api.v3.mclists.models.GetMarketingListsId200Response;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetListsById {
    private final String id;
    private String query;


    public GetMarketingListsId200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetListsById creation failed: Unable to connect to server"
            );
            ...
            if (Matcher.matches(Integer.toString(statusCode), "404")) {
                ...
                error = JsonUtil.fromJson(
                        response.getStream(),
                        List & lt; Error & gt;.class
        );
                throw new ApiErrorResponse(statusCode, null, error, response.getHeaders());
            }

        }
        return JsonUtil.fromJson(response.getStream(), GetMarketingListsId200Response.class);
    }
