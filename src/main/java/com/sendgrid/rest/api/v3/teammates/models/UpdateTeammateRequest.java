...
public class UpdateTeammateRequest {
    ...
    public UpdateTeammateRequest() {}

    private UpdateTeammateRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateTeammateRequest build() {
            return new UpdateTeammateRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateTeammateRequest.class.getSimpleName() + "(",
            ")"
        );
