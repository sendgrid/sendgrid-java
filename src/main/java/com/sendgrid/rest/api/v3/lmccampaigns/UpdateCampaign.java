...
import com.sendgrid.rest.api.v3.lmccampaigns.models.UpdateACampaignRequest;
...
public class UpdateCampaign extends ApiKeyBase {
    ...
    @Setter
    private UpdateACampaignRequest updateACampaignRequest;
    ...
    public ApiResponse<Campaigns2xx> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateCampaign creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (updateACampaignRequest != null) {
            request.addBody(JsonUtil.toJson(updateACampaignRequest));
        }
    }
}
