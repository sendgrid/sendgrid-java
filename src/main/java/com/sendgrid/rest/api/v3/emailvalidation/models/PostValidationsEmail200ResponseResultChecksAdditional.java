...
@ToString
public class PostValidationsEmail200ResponseResultChecksAdditional {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("hasKnownBounces")
    @Getter
    @Setter
    private Boolean hasKnownBounces;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("hasSuspectedBounces")
    @Getter
    @Setter
    private Boolean hasSuspectedBounces;

    public PostValidationsEmail200ResponseResultChecksAdditional() {
    }

    private PostValidationsEmail200ResponseResultChecksAdditional(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostValidationsEmail200ResponseResultChecksAdditional build() {
            return new PostValidationsEmail200ResponseResultChecksAdditional(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostValidationsEmail200ResponseResultChecksAdditional.class.getSimpleName() + "(", ")");
        if (hasKnownBounces != null) joiner.add("hasKnownBounces=" + hasKnownBounces);
        if (hasSuspectedBounces != null) joiner.add("hasSuspectedBounces=" + hasSuspectedBounces);
