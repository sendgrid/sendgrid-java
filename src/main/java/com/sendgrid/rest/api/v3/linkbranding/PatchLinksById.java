...
import com.sendgrid.rest.api.v3.linkbranding.models.PatchWhitelabelLinksIdRequest;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PatchLinksById {
    private final Integer id;
    private String onBehalfOf;
    private final PatchWhitelabelLinksIdRequest patchWhitelabelLinksIdRequest;
    ...
    public LinkBranding200 send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchLinksById creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (patchWhitelabelLinksIdRequest != null) {
            builder.body(JsonUtil.toJson(patchWhitelabelLinksIdRequest));
        }
    }
