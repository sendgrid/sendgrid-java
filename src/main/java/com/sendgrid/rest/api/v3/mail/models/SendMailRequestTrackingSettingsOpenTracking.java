...
@ToString
public class SendMailRequestTrackingSettingsOpenTracking {
    ...
    public SendMailRequestTrackingSettingsOpenTracking() {}

    private SendMailRequestTrackingSettingsOpenTracking(Builder builder) {
    ...
    public static class Builder {
        ...
        public SendMailRequestTrackingSettingsOpenTracking build() {
            return new SendMailRequestTrackingSettingsOpenTracking(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SendMailRequestTrackingSettingsOpenTracking.class.getSimpleName() +
            "(",
            ")"
        );
