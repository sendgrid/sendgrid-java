...
import com.sendgrid.rest.api.v3.emailvalidation.models.ValidateEmail200ResponseResult;
...
@ToString
public class ValidateEmail200Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private ValidateEmail200ResponseResult result;

    public ValidateEmail200Response() {}

    private ValidateEmail200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(ValidateEmail200ResponseResult result) {
            this.result = result;
        }

        public ValidateEmail200Response build() {
            return new ValidateEmail200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ValidateEmail200Response.class.getSimpleName() + "(",
            ")"
        );
