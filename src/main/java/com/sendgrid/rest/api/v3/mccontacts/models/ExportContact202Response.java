...
@ToString
public class ExportContact202Response {
    ...
    public ExportContact202Response() {}

    private ExportContact202Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ExportContact202Response build() {
            return new ExportContact202Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ExportContact202Response.class.getSimpleName() + "(",
            ")"
        );
