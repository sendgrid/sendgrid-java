...
@ToString
public class GetVerifiedSendersStepsCompleted200ResponseResults {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("senderVerified")
    @Getter
    @Setter
    private Boolean senderVerified;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("domainVerified")
    @Getter
    @Setter
    private Boolean domainVerified;

    public GetVerifiedSendersStepsCompleted200ResponseResults() {
    }

    private GetVerifiedSendersStepsCompleted200ResponseResults(Builder builder) {
        this.senderVerified = builder.senderVerified;
        this.domainVerified = builder.domainVerified;
    }
    ...
    public static class Builder {
        ...
        public Builder senderVerified(Boolean senderVerified) {
            this.senderVerified = senderVerified;
            return this;
        }

        public Builder domainVerified(Boolean domainVerified) {
            this.domainVerified = domainVerified;
            return this;
        }

        public GetVerifiedSendersStepsCompleted200ResponseResults build() {
            return new GetVerifiedSendersStepsCompleted200ResponseResults(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetVerifiedSendersStepsCompleted200ResponseResults.class.getSimpleName() + "(", ")");
        if (senderVerified != null) joiner.add("senderVerified=" + senderVerified);
        if (domainVerified != null) joiner.add("domainVerified=" + domainVerified);
