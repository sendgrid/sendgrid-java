...
import com.sendgrid.rest.api.v3.lmccampaigns.models.SendACampaignResponse;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PostSendCampaign {
    private final Integer campaignId;
    private String onBehalfOf;


    public SendACampaignResponse send(final TokenRestClient client) {
        String path = "/v3/campaigns/{campaign_id}/schedules/now";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostSendCampaign creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), SendACampaignResponse.class);
    }
