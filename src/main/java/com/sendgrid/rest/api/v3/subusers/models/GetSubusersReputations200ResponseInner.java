...
@ToString
public class GetSubusersReputations200ResponseInner {
    ...
    public GetSubusersReputations200ResponseInner() {
    }

    private GetSubusersReputations200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetSubusersReputations200ResponseInner build() {
            return new GetSubusersReputations200ResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetSubusersReputations200ResponseInner.class.getSimpleName() + "(", ")");
