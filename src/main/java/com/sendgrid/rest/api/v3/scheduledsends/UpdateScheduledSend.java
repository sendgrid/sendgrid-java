...
import com.sendgrid.rest.api.v3.scheduledsends.models.UpdateScheduledSendRequest;
...
public class UpdateScheduledSend extends ApiKeyBase {
    ...
    public ApiResponse<Object> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateScheduledSend creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (updateScheduledSendRequest != null) {
            request.addBody(JsonUtil.toJson(updateScheduledSendRequest));
        }
    }
}
