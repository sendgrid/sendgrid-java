...
@ToString
public class PutIpsPoolsPoolNameRequest {
    ...
    public PutIpsPoolsPoolNameRequest() {
    }

    private PutIpsPoolsPoolNameRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PutIpsPoolsPoolNameRequest build() {
            return new PutIpsPoolsPoolNameRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutIpsPoolsPoolNameRequest.class.getSimpleName() + "(", ")");
