...
@ToString
public class ListContact400Response {
    ...
    public ListContact400Response() {}

    private ListContact400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListContact400Response build() {
            return new ListContact400Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListContact400Response.class.getSimpleName() + "(",
            ")"
        );
