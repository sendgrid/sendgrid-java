...
import com.sendgrid.rest.api.v3.apikeys.models.GetApiKeysApiKeyId200Response;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetApiKeysById {
    private final String apiKeyId;
    private String onBehalfOf;


    public GetApiKeysApiKeyId200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetApiKeysById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetApiKeysApiKeyId200Response.class);
    }
