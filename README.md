...
dependencies {
  ...
  implementation 'com.sendgrid:sendgrid-java:5.0.0-rc.21'
}
...
[sendgrid-java.jar](https://github.com/sendgrid/sendgrid-java/releases/download/5.0.0-rc.21/sendgrid-java.jar)
