...
import com.sendgrid.rest.api.v3.user.models.UpdatePasswordRequest;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class UpdatePassword extends ApiKeyBase {
    ...
    public ApiResponse<Object> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdatePassword creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (updatePasswordRequest != null) {
            request.addBody(JsonUtil.toJson(updatePasswordRequest));
        }
    }
}
