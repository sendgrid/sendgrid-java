...
public class WarmUpIpRequest {
    ...
    public WarmUpIpRequest() {}

    private WarmUpIpRequest(Builder builder) {
        this.ip = builder.ip;
    }
    ...
    public static class Builder {
        ...
        public WarmUpIpRequest build() {
            return new WarmUpIpRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            WarmUpIpRequest.class.getSimpleName() + "(",
            ")"
        );
