...
import com.sendgrid.rest.api.v3.stats.models.ListGeoStat200ResponseInnerStatsInner;
...
@ToString
public class ListGeoStat200ResponseInner {
    ...
    @Getter
    @Setter
    private List<ListGeoStat200ResponseInnerStatsInner> stats;

    public ListGeoStat200ResponseInner() {}

    private ListGeoStat200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder stats(
            List<ListGeoStat200ResponseInnerStatsInner> stats
        ) {
            this.stats = stats;
            return this;
        }

        public ListGeoStat200ResponseInner build() {
            return new ListGeoStat200ResponseInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListGeoStat200ResponseInner.class.getSimpleName() + "(",
            ")"
        );
