...
@ToString
public class PatchSubusersSubuserNameCreditsRemainingRequest {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("allocationUpdate")
    @Getter
    @Setter
    private Integer allocationUpdate;

    public PatchSubusersSubuserNameCreditsRemainingRequest() {
    }

    private PatchSubusersSubuserNameCreditsRemainingRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchSubusersSubuserNameCreditsRemainingRequest build() {
            return new PatchSubusersSubuserNameCreditsRemainingRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchSubusersSubuserNameCreditsRemainingRequest.class.getSimpleName() + "(", ")");
        if (allocationUpdate != null) joiner.add("allocationUpdate=" + allocationUpdate);
