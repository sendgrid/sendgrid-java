...
@ToString
public class DeleteIpsWarmupIpAddress404Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<DeleteIpsWarmupIpAddress404ResponseErrorsInner> errors;

    public DeleteIpsWarmupIpAddress404Response() {
    }

    private DeleteIpsWarmupIpAddress404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<DeleteIpsWarmupIpAddress404ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public DeleteIpsWarmupIpAddress404Response build() {
            return new DeleteIpsWarmupIpAddress404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteIpsWarmupIpAddress404Response.class.getSimpleName() + "(", ")");
