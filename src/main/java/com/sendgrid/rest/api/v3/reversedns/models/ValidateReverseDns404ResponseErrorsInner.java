...
@ToString
public class ValidateReverseDns404ResponseErrorsInner {
    ...
    public ValidateReverseDns404ResponseErrorsInner() {}

    private ValidateReverseDns404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public ValidateReverseDns404ResponseErrorsInner build() {
            return new ValidateReverseDns404ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ValidateReverseDns404ResponseErrorsInner.class.getSimpleName() +
            "(",
            ")"
        );
