...
import com.sendgrid.rest.api.v3.ips.models.GetIp200Response;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetIp extends ApiKeyBase {

    private final String ipAddress;

    public ApiResponse<GetIp200Response> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetIp creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), GetIp200Response.class),
            response.getHeaders()
        );
    }
