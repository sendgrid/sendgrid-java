...
@ToString
public class PostMarketingContactsExportsRequestNotifications {
    ...
    public PostMarketingContactsExportsRequestNotifications() {
    }

    private PostMarketingContactsExportsRequestNotifications(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingContactsExportsRequestNotifications build() {
            return new PostMarketingContactsExportsRequestNotifications(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingContactsExportsRequestNotifications.class.getSimpleName() + "(", ")");
