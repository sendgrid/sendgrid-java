...
@ToString
public class GetMarketingSinglesends500ResponseErrorsInner {
    ...
    public GetMarketingSinglesends500ResponseErrorsInner() {
    }

    private GetMarketingSinglesends500ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMarketingSinglesends500ResponseErrorsInner build() {
            return new GetMarketingSinglesends500ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingSinglesends500ResponseErrorsInner.class.getSimpleName() + "(", ")");
