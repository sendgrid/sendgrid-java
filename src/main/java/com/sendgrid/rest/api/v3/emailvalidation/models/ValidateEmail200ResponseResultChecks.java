...
import com.sendgrid.rest.api.v3.emailvalidation.models.ValidateEmail200ResponseResultChecksAdditional;
import com.sendgrid.rest.api.v3.emailvalidation.models.ValidateEmail200ResponseResultChecksDomain;
import com.sendgrid.rest.api.v3.emailvalidation.models.ValidateEmail200ResponseResultChecksLocalPart;
...
@ToString
public class ValidateEmail200ResponseResultChecks {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("domain")
    @Getter
    @Setter
    private ValidateEmail200ResponseResultChecksDomain domain;

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("local_part")
    @Getter
    @Setter
    private ValidateEmail200ResponseResultChecksLocalPart localPart;

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("additional")
    @Getter
    @Setter
    private ValidateEmail200ResponseResultChecksAdditional additional;

    public ValidateEmail200ResponseResultChecks() {}

    private ValidateEmail200ResponseResultChecks(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(
            ValidateEmail200ResponseResultChecksDomain domain,
            ValidateEmail200ResponseResultChecksLocalPart localPart,
            ValidateEmail200ResponseResultChecksAdditional additional
        ) {
            this.domain = domain;
        ...
        public ValidateEmail200ResponseResultChecks build() {
            return new ValidateEmail200ResponseResultChecks(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ValidateEmail200ResponseResultChecks.class.getSimpleName() + "(",
            ")"
        );
