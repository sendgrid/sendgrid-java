...
@ToString
public class RetrieveAGlobalSuppressionResponse {
    ...
    public RetrieveAGlobalSuppressionResponse() {
    }

    private RetrieveAGlobalSuppressionResponse(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(String recipientEmail) {
            this.recipientEmail = recipientEmail;
        }

        public RetrieveAGlobalSuppressionResponse build() {
            return new RetrieveAGlobalSuppressionResponse(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", RetrieveAGlobalSuppressionResponse.class.getSimpleName() + "(", ")");
        if (recipientEmail != null) joiner.add("recipientEmail=" + recipientEmail);
