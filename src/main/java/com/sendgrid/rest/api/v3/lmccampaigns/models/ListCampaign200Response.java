...
@ToString
public class ListCampaign200Response {
    ...
    public ListCampaign200Response() {}

    private ListCampaign200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListCampaign200Response build() {
            return new ListCampaign200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListCampaign200Response.class.getSimpleName() + "(",
            ")"
        );
