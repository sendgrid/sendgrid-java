...
public class SearchSuppressionFromAsmGroup extends ApiKeyBase {
    ...
    public ApiResponse<List<String>> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "SearchSuppressionFromAsmGroup creation failed: Unable to connect to server"
            );
        } else if (
