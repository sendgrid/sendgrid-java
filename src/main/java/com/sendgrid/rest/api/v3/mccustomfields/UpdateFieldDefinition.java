...
import com.sendgrid.rest.api.v3.mccustomfields.models.UpdateFieldDefinitionRequest;
...
public class UpdateFieldDefinition extends ApiKeyBase {

    private final String customFieldId;

    @Setter
    private UpdateFieldDefinitionRequest updateFieldDefinitionRequest;
    ...
    public ApiResponse<CreateFieldDefinition200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateFieldDefinition creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (updateFieldDefinitionRequest != null) {
            request.addBody(JsonUtil.toJson(updateFieldDefinitionRequest));
        }
    }
}
