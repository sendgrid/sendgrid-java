...
@ToString
public class UpdateAuthenticatedDomainRequest {
    ...
    public UpdateAuthenticatedDomainRequest() {}

    private UpdateAuthenticatedDomainRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateAuthenticatedDomainRequest build() {
            return new UpdateAuthenticatedDomainRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateAuthenticatedDomainRequest.class.getSimpleName() + "(",
            ")"
        );
