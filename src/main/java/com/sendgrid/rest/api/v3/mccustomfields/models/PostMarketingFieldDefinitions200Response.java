...
@ToString
public class PostMarketingFieldDefinitions200Response {
    ...
    public PostMarketingFieldDefinitions200Response() {
    }

    private PostMarketingFieldDefinitions200Response(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public Builder(Object id, Object name, FieldType2 fieldType) {
            this.id = id;
            this.name = name;
        ...
        public PostMarketingFieldDefinitions200Response build() {
            return new PostMarketingFieldDefinitions200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingFieldDefinitions200Response.class.getSimpleName() + "(", ")");
