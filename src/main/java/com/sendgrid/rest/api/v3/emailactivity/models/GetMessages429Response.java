...
@ToString
public class GetMessages429Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetMessages429ResponseErrorsInner> errors;

    public GetMessages429Response() {
    }

    private GetMessages429Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<GetMessages429ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public GetMessages429Response build() {
            return new GetMessages429Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMessages429Response.class.getSimpleName() + "(", ")");
