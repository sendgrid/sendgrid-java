...
public class PostDesignsById {
    private final UUID id;
    private final DesignDuplicateInput designDuplicateInput;
    ...
    public DesignOutput send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostDesignsById creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (designDuplicateInput != null) {
            builder.body(JsonUtil.toJson(designDuplicateInput));
        }
    }
