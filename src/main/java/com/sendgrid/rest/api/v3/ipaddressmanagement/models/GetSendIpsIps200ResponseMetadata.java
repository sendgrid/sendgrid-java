...
@ToString
public class GetSendIpsIps200ResponseMetadata {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("nextParams")
    @Getter
    @Setter
    private GetSendIpsIps200ResponseMetadataNextParams nextParams;

    public GetSendIpsIps200ResponseMetadata() {
    }

    private GetSendIpsIps200ResponseMetadata(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder nextParams(GetSendIpsIps200ResponseMetadataNextParams nextParams) {
            this.nextParams = nextParams;
            return this;
        }

        public GetSendIpsIps200ResponseMetadata build() {
            return new GetSendIpsIps200ResponseMetadata(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetSendIpsIps200ResponseMetadata.class.getSimpleName() + "(", ")");
