...
@ToString
public class PatchUserScheduledSendsBatchIdRequest {
    ...
    public PatchUserScheduledSendsBatchIdRequest() {
    }

    private PatchUserScheduledSendsBatchIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchUserScheduledSendsBatchIdRequest build() {
            return new PatchUserScheduledSendsBatchIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchUserScheduledSendsBatchIdRequest.class.getSimpleName() + "(", ")");
