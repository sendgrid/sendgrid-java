...
import com.sendgrid.rest.api.v3.stats.models.AdvancedStatsOpens;
...
@ToString
public class ListClientStat200ResponseInnerStatsInner {
    ...
    public ListClientStat200ResponseInnerStatsInner() {}

    private ListClientStat200ResponseInnerStatsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListClientStat200ResponseInnerStatsInner build() {
            return new ListClientStat200ResponseInnerStatsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListClientStat200ResponseInnerStatsInner.class.getSimpleName() +
            "(",
            ")"
        );
