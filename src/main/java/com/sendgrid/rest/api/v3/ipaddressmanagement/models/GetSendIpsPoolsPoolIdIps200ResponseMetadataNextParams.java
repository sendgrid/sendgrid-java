...
@ToString
public class GetSendIpsPoolsPoolIdIps200ResponseMetadataNextParams {
    ...
    public GetSendIpsPoolsPoolIdIps200ResponseMetadataNextParams() {
    }

    private GetSendIpsPoolsPoolIdIps200ResponseMetadataNextParams(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetSendIpsPoolsPoolIdIps200ResponseMetadataNextParams build() {
            return new GetSendIpsPoolsPoolIdIps200ResponseMetadataNextParams(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetSendIpsPoolsPoolIdIps200ResponseMetadataNextParams.class.getSimpleName() + "(", ")");
