...
@ToString
public class PatchDesignsIdRequest {
    ...
    public PatchDesignsIdRequest() {
    }

    private PatchDesignsIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchDesignsIdRequest build() {
            return new PatchDesignsIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchDesignsIdRequest.class.getSimpleName() + "(", ")");
