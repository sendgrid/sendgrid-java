...
public class AccountProvisioningOfferingList {
    ...
    public static class Builder {
        ...
        public Builder offerings(List<AccountProvisioningOfferingV1> offerings) {
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", AccountProvisioningOfferingList.class.getSimpleName() + "(", ")");
