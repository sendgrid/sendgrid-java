...
import com.sendgrid.rest.api.v3.suppressions.models.GetSuppressionsBouncesClassificationsClassification200Response;
import com.sendgrid.rest.api.v3.suppressions.models.Schema1;
import com.sendgrid.rest.api.v3.suppressions.models.Schema2;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetSuppressionBounceClassificationById {
    private final Schema2 classification;
    private String query;
    private final Schema1 accept;
    private String onBehalfOf;


    public GetSuppressionsBouncesClassificationsClassification200Response send(final TokenRestClient client) {
        ...
        Request.Builder builder = new Request.Builder(HttpMethod.GET, path)
                .addPathParam("classification", classification.toString());
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetSuppressionBounceClassificationById creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), GetSuppressionsBouncesClassificationsClassification200Response.class);
    }
