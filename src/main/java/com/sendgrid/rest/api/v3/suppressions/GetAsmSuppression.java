...
import com.sendgrid.rest.api.v3.suppressions.models.GetAsmSuppression200Response;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class GetAsmSuppression extends ApiKeyBase {
    ...
    public ApiResponse<GetAsmSuppression200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetAsmSuppression creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                GetAsmSuppression200Response.class
            ),
            response.getHeaders()
        );
    }
