...
@ToString
public class GetMarketingSinglesends200Response {
    ...
    public GetMarketingSinglesends200Response() {
    }

    private GetMarketingSinglesends200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMarketingSinglesends200Response build() {
            return new GetMarketingSinglesends200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingSinglesends200Response.class.getSimpleName() + "(", ")");
