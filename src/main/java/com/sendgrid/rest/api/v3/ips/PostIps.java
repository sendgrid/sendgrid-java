...
import com.sendgrid.rest.api.v3.ips.models.PostIps201Response;
import com.sendgrid.rest.api.v3.ips.models.PostIpsRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PostIps {
    private final PostIpsRequest postIpsRequest;


    public PostIps201Response send(final TokenRestClient client) {
        String path = "/v3/ips";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostIps creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PostIps201Response.class);
    }


    private void body(final Request.Builder builder) {
        if (postIpsRequest != null) {
            builder.body(JsonUtil.toJson(postIpsRequest));
        }
    }
