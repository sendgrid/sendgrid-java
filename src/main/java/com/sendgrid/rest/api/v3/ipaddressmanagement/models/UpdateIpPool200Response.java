...
@ToString
public class UpdateIpPool200Response {
    ...
    public UpdateIpPool200Response() {}

    private UpdateIpPool200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateIpPool200Response build() {
            return new UpdateIpPool200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateIpPool200Response.class.getSimpleName() + "(",
            ")"
        );
