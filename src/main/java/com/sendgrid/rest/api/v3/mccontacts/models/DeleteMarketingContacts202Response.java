...
@ToString
public class DeleteMarketingContacts202Response {
    ...
    public DeleteMarketingContacts202Response() {
    }

    private DeleteMarketingContacts202Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteMarketingContacts202Response build() {
            return new DeleteMarketingContacts202Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteMarketingContacts202Response.class.getSimpleName() + "(", ")");
