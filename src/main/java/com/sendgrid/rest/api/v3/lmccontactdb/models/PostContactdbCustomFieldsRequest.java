...
@ToString
public class PostContactdbCustomFieldsRequest {
    ...
    public PostContactdbCustomFieldsRequest() {
    }

    private PostContactdbCustomFieldsRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostContactdbCustomFieldsRequest build() {
            return new PostContactdbCustomFieldsRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostContactdbCustomFieldsRequest.class.getSimpleName() + "(", ")");
