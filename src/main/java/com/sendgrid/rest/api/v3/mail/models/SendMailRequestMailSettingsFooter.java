...
@ToString
public class SendMailRequestMailSettingsFooter {
    ...
    public SendMailRequestMailSettingsFooter() {}

    private SendMailRequestMailSettingsFooter(Builder builder) {
    ...
    public static class Builder {
        ...
        public SendMailRequestMailSettingsFooter build() {
            return new SendMailRequestMailSettingsFooter(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SendMailRequestMailSettingsFooter.class.getSimpleName() + "(",
            ")"
        );
