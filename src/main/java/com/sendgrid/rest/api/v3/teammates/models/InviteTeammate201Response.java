...
@ToString
public class InviteTeammate201Response {
    ...
    public InviteTeammate201Response() {}

    private InviteTeammate201Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public InviteTeammate201Response build() {
            return new InviteTeammate201Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            InviteTeammate201Response.class.getSimpleName() + "(",
            ")"
        );
