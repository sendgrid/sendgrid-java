...
import com.sendgrid.rest.api.v3.scheduledsends.models.Status2;
...
public class ScheduledSendStatus {
    ...
    public ScheduledSendStatus() {}

    private ScheduledSendStatus(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(String batchId, Status2 status) {
            this.batchId = batchId;
            this.status = status;
        }

        public ScheduledSendStatus build() {
            return new ScheduledSendStatus(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ScheduledSendStatus.class.getSimpleName() + "(",
            ")"
        );
