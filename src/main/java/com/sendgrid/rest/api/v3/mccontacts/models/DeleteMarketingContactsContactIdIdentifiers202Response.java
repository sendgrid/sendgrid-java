...
@ToString
public class DeleteMarketingContactsContactIdIdentifiers202Response {
    ...
    public DeleteMarketingContactsContactIdIdentifiers202Response() {
    }

    private DeleteMarketingContactsContactIdIdentifiers202Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteMarketingContactsContactIdIdentifiers202Response build() {
            return new DeleteMarketingContactsContactIdIdentifiers202Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteMarketingContactsContactIdIdentifiers202Response.class.getSimpleName() + "(", ")");
