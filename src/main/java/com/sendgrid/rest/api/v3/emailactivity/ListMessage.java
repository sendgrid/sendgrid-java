...
public class ListMessage extends ApiKeyBase {
    ...
    public ApiResponse<ListMessage200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListMessage creation failed: Unable to connect to server"
            );
        } else if (
            ...
            if (Matcher.matches(Integer.toString(statusCode), "400")) {
                ListMessage400Response error = JsonUtil.fromJson(
                    response.getStream(),
                    ListMessage400Response.class
                );
