...
@ToString
public class PatchContactdbSegmentsSegmentIdRequest {
    ...
    public PatchContactdbSegmentsSegmentIdRequest() {
    }

    private PatchContactdbSegmentsSegmentIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder conditions(List<ContactdbSegmentsConditions> conditions) {
            this.conditions = conditions;
            return this;
        }

        public PatchContactdbSegmentsSegmentIdRequest build() {
            return new PatchContactdbSegmentsSegmentIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchContactdbSegmentsSegmentIdRequest.class.getSimpleName() + "(", ")");
