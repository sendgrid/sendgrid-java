...
@ToString
public class SuppressionGroupRequestBaseProps {
    ...
    public SuppressionGroupRequestBaseProps() {
    }

    private SuppressionGroupRequestBaseProps(Builder builder) {
    ...
    public static class Builder {
        ...
        public SuppressionGroupRequestBaseProps build() {
            return new SuppressionGroupRequestBaseProps(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SuppressionGroupRequestBaseProps.class.getSimpleName() + "(", ")");
