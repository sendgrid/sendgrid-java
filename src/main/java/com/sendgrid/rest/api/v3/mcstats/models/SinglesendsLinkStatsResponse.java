...
public class SinglesendsLinkStatsResponse {
    ...
    public static class Builder {
        ...
        public Builder(List<SinglesendsLinkStatsResponseResultsInner> results, LinkTrackingMetadata metadata) {
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SinglesendsLinkStatsResponse.class.getSimpleName() + "(", ")");
