...
@ToString
public class ListGlobalSuppression200ResponseInner {
    ...
    public ListGlobalSuppression200ResponseInner() {}

    private ListGlobalSuppression200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListGlobalSuppression200ResponseInner build() {
            return new ListGlobalSuppression200ResponseInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListGlobalSuppression200ResponseInner.class.getSimpleName() + "(",
            ")"
        );
