...
import com.sendgrid.rest.api.v3.suppressions.models.GetSuppressionUnsubscribes200ResponseInner;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetSuppressionUnsubscribe {
    ...
    public List<GetSuppressionUnsubscribes200ResponseInner> send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetSuppressionUnsubscribe creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), List & lt; GetSuppressionUnsubscribes200ResponseInner & gt;.class)
        ;
    }
