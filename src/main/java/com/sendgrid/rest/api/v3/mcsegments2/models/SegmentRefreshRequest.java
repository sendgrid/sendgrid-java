...
@ToString
public class SegmentRefreshRequest {
    ...
    public SegmentRefreshRequest() {
    }

    private SegmentRefreshRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(String userTimeZone) {
            this.userTimeZone = userTimeZone;
        }

        public SegmentRefreshRequest build() {
            return new SegmentRefreshRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SegmentRefreshRequest.class.getSimpleName() + "(", ")");
        if (userTimeZone != null) joiner.add("userTimeZone=" + userTimeZone);
