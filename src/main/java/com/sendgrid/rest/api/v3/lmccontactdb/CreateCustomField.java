...
import com.sendgrid.rest.api.v3.lmccontactdb.models.CreateCustomFieldRequest;
...
public class CreateCustomField extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private CreateCustomFieldRequest createCustomFieldRequest;

    public ApiResponse<ContactdbCustomFieldId2xx> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "CreateCustomField creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ContactdbCustomFieldId2xx.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (createCustomFieldRequest != null) {
            request.addBody(JsonUtil.toJson(createCustomFieldRequest));
        }
    }
}
