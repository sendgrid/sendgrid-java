...
@ToString
public class PostWhitelabelLinksIdValidate200ResponseValidationResultsOwnerCname {
    ...
    public PostWhitelabelLinksIdValidate200ResponseValidationResultsOwnerCname() {
    }

    private PostWhitelabelLinksIdValidate200ResponseValidationResultsOwnerCname(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostWhitelabelLinksIdValidate200ResponseValidationResultsOwnerCname build() {
            return new PostWhitelabelLinksIdValidate200ResponseValidationResultsOwnerCname(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelLinksIdValidate200ResponseValidationResultsOwnerCname.class.getSimpleName() + "(", ")");
