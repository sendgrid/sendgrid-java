...
public enum DestinationRegion {
    ...
    private DestinationRegion(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static DestinationRegion forValue(final String value) {
        return Promoter.enumFromString(value, DestinationRegion.values());
    }
}
