...
@ToString
public class DeleteSubUsersFromIpRequest {
    ...
    public DeleteSubUsersFromIpRequest() {}

    private DeleteSubUsersFromIpRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteSubUsersFromIpRequest build() {
            return new DeleteSubUsersFromIpRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            DeleteSubUsersFromIpRequest.class.getSimpleName() + "(",
            ")"
        );
