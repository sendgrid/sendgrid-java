...
@ToString
public class SegmentRefresh202 {
    ...
    public SegmentRefresh202() {
    }

    private SegmentRefresh202(Builder builder) {
    ...
    public static class Builder {
        ...
        public SegmentRefresh202 build() {
            return new SegmentRefresh202(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SegmentRefresh202.class.getSimpleName() + "(", ")");
