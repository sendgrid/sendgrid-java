...
@ToString
public class ListContactByEmail200Response {
    ...
    public ListContactByEmail200Response() {}

    private ListContactByEmail200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListContactByEmail200Response build() {
            return new ListContactByEmail200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListContactByEmail200Response.class.getSimpleName() + "(",
            ")"
        );
