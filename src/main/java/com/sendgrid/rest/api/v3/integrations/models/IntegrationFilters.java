...
import com.sendgrid.rest.api.v3.integrations.models.Items2;
...
public class IntegrationFilters {
    ...
    @Getter
    @Setter
    private List<Items2> emailEvents;

    public IntegrationFilters() {}

    private IntegrationFilters(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder emailEvents(List<Items2> emailEvents) {
            this.emailEvents = emailEvents;
            return this;
        }

        public IntegrationFilters build() {
            return new IntegrationFilters(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            IntegrationFilters.class.getSimpleName() + "(",
            ")"
        );
