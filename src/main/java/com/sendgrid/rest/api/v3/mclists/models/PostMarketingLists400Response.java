...
@ToString
public class PostMarketingLists400Response {
    ...
    public PostMarketingLists400Response() {
    }

    private PostMarketingLists400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingLists400Response build() {
            return new PostMarketingLists400Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingLists400Response.class.getSimpleName() + "(", ")");
