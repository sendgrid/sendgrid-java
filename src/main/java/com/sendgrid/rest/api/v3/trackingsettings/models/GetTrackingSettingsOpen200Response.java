...
@ToString
public class GetTrackingSettingsOpen200Response {
    ...
    public GetTrackingSettingsOpen200Response() {
    }

    private GetTrackingSettingsOpen200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetTrackingSettingsOpen200Response build() {
            return new GetTrackingSettingsOpen200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetTrackingSettingsOpen200Response.class.getSimpleName() + "(", ")");
