...
import com.sendgrid.rest.api.v3.emailactivity.models.ListMessage429ResponseErrorsInner;
...
@ToString
public class ListMessage429Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<ListMessage429ResponseErrorsInner> errors;

    public ListMessage429Response() {}

    private ListMessage429Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<ListMessage429ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public ListMessage429Response build() {
            return new ListMessage429Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListMessage429Response.class.getSimpleName() + "(",
            ")"
        );
