...
@ToString
public class PostMailSendRequestTrackingSettingsOpenTracking {
    ...
    public PostMailSendRequestTrackingSettingsOpenTracking() {
    }

    private PostMailSendRequestTrackingSettingsOpenTracking(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMailSendRequestTrackingSettingsOpenTracking build() {
            return new PostMailSendRequestTrackingSettingsOpenTracking(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMailSendRequestTrackingSettingsOpenTracking.class.getSimpleName() + "(", ")");
