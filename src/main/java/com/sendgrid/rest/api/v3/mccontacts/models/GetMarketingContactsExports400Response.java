...
@ToString
public class GetMarketingContactsExports400Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetMarketingContactsExports400ResponseErrorsInner> errors;

    public GetMarketingContactsExports400Response() {
    }

    private GetMarketingContactsExports400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<GetMarketingContactsExports400ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public GetMarketingContactsExports400Response build() {
            return new GetMarketingContactsExports400Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingContactsExports400Response.class.getSimpleName() + "(", ")");
