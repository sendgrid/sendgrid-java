...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.ListIp200ResponseResultInnerPoolsInner;
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.Region;
...
@ToString
public class ListIp200ResponseResultInner {
    ...
    @Getter
    @Setter
    private List<ListIp200ResponseResultInnerPoolsInner> pools;
    ...
    public ListIp200ResponseResultInner() {}

    private ListIp200ResponseResultInner(Builder builder) {
        this.ip = builder.ip;
    ...
    public static class Builder {
        ...
        public Builder pools(
            List<ListIp200ResponseResultInnerPoolsInner> pools
        ) {
            this.pools = pools;
            return this;
        }
        ...
        public ListIp200ResponseResultInner build() {
            return new ListIp200ResponseResultInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListIp200ResponseResultInner.class.getSimpleName() + "(",
            ")"
        );
