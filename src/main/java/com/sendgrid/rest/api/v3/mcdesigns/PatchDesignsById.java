...
import com.sendgrid.rest.api.v3.mcdesigns.models.PatchDesignsIdRequest;
...
public class PatchDesignsById {
    private final UUID id;
    private final PatchDesignsIdRequest patchDesignsIdRequest;
    ...
    public DesignOutput send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchDesignsById creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (patchDesignsIdRequest != null) {
            builder.body(JsonUtil.toJson(patchDesignsIdRequest));
        }
    }
