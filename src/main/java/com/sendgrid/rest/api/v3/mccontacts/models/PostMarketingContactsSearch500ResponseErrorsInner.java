...
@ToString
public class PostMarketingContactsSearch500ResponseErrorsInner {
    ...
    public PostMarketingContactsSearch500ResponseErrorsInner() {
    }

    private PostMarketingContactsSearch500ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingContactsSearch500ResponseErrorsInner build() {
            return new PostMarketingContactsSearch500ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingContactsSearch500ResponseErrorsInner.class.getSimpleName() + "(", ")");
