...
@ToString
public class ListReservedField200ResponseReservedFieldsInner {
    ...
    public ListReservedField200ResponseReservedFieldsInner() {}

    private ListReservedField200ResponseReservedFieldsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListReservedField200ResponseReservedFieldsInner build() {
            return new ListReservedField200ResponseReservedFieldsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListReservedField200ResponseReservedFieldsInner.class.getSimpleName() +
            "(",
            ")"
        );
