...
@ToString
public class PatchWhitelabelLinksIdRequest {
    ...
    public PatchWhitelabelLinksIdRequest() {
    }

    private PatchWhitelabelLinksIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchWhitelabelLinksIdRequest build() {
            return new PatchWhitelabelLinksIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchWhitelabelLinksIdRequest.class.getSimpleName() + "(", ")");
