...
@ToString
public class UpdateMarketingListRequest {
    ...
    public UpdateMarketingListRequest() {}

    private UpdateMarketingListRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateMarketingListRequest build() {
            return new UpdateMarketingListRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateMarketingListRequest.class.getSimpleName() + "(",
            ")"
        );
