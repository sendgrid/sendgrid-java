...
@ToString
public class PutMarketingContactsImportsRequestFieldMappingsInner {
    public PutMarketingContactsImportsRequestFieldMappingsInner() {
    }

    private PutMarketingContactsImportsRequestFieldMappingsInner(Builder builder) {
    }
    ...
    public static class Builder {
        ...
        public PutMarketingContactsImportsRequestFieldMappingsInner build() {
            return new PutMarketingContactsImportsRequestFieldMappingsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutMarketingContactsImportsRequestFieldMappingsInner.class.getSimpleName() + "(", ")");
