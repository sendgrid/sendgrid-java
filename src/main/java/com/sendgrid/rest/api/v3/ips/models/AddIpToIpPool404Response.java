...
import com.sendgrid.rest.api.v3.ips.models.AddIpToIpPool404ResponseErrorsInner;
...
@ToString
public class AddIpToIpPool404Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<AddIpToIpPool404ResponseErrorsInner> errors;

    public AddIpToIpPool404Response() {}

    private AddIpToIpPool404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(
            List<AddIpToIpPool404ResponseErrorsInner> errors
        ) {
            this.errors = errors;
            return this;
        }

        public AddIpToIpPool404Response build() {
            return new AddIpToIpPool404Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            AddIpToIpPool404Response.class.getSimpleName() + "(",
            ")"
        );
