...
@ToString
public class GetIpsWarmupIpAddress404Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetIpsWarmupIpAddress404ResponseErrorsInner> errors;

    public GetIpsWarmupIpAddress404Response() {
    }

    private GetIpsWarmupIpAddress404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<GetIpsWarmupIpAddress404ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public GetIpsWarmupIpAddress404Response build() {
            return new GetIpsWarmupIpAddress404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetIpsWarmupIpAddress404Response.class.getSimpleName() + "(", ")");
