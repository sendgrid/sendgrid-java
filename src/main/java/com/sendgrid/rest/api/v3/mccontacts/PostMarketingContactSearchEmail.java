...
import com.sendgrid.rest.api.v3.mccontacts.models.PostMarketingContactsSearchEmails200Response;
import com.sendgrid.rest.api.v3.mccontacts.models.PostMarketingContactsSearchEmailsRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PostMarketingContactSearchEmail {
    private final PostMarketingContactsSearchEmailsRequest postMarketingContactsSearchEmailsRequest;


    public PostMarketingContactsSearchEmails200Response send(final TokenRestClient client) {
        String path = "/v3/marketing/contacts/search/emails";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostMarketingContactSearchEmail creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PostMarketingContactsSearchEmails200Response.class);
    }


    private void body(final Request.Builder builder) {
        if (postMarketingContactsSearchEmailsRequest != null) {
            builder.body(JsonUtil.toJson(postMarketingContactsSearchEmailsRequest));
        }
    }
