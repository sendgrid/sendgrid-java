...
import com.sendgrid.rest.api.v3.suppressions.models.UpdateAsmGroupRequest;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class UpdateAsmGroup extends ApiKeyBase {
    ...
    @Setter
    private UpdateAsmGroupRequest updateAsmGroupRequest;

    public ApiResponse<SuppressionGroup> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateAsmGroup creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), SuppressionGroup.class),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (updateAsmGroupRequest != null) {
            request.addBody(JsonUtil.toJson(updateAsmGroupRequest));
        }
    }
}
