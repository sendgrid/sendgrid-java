...
@ToString
public class PostIpsPoolsPoolNameIpsRequest {
    ...
    public PostIpsPoolsPoolNameIpsRequest() {
    }

    private PostIpsPoolsPoolNameIpsRequest(Builder builder) {
        this.ip = builder.ip;
    }
    ...
    public static class Builder {
        ...
        public PostIpsPoolsPoolNameIpsRequest build() {
            return new PostIpsPoolsPoolNameIpsRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostIpsPoolsPoolNameIpsRequest.class.getSimpleName() + "(", ")");
