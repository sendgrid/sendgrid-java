...
public class ContactDetails3 {
    ...
    private ContactDetails3(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public Builder(String id, List<String> listIds, List<String> segmentIds, String createdAt, String updatedAt) {
            this.id = id;
        ...
        public ContactDetails3 build() {
            return new ContactDetails3(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", ContactDetails3.class.getSimpleName() + "(", ")");
