...
@ToString
public class PostTeammates201Response {
    ...
    public PostTeammates201Response() {
    }

    private PostTeammates201Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostTeammates201Response build() {
            return new PostTeammates201Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostTeammates201Response.class.getSimpleName() + "(", ")");
