...
@ToString
public class ListAllAuthenticatedDomainWithUser200ResponseInnerDnsDkim1 {
    ...
    public ListAllAuthenticatedDomainWithUser200ResponseInnerDnsDkim1() {}

    private ListAllAuthenticatedDomainWithUser200ResponseInnerDnsDkim1(
        Builder builder
    ) {
    ...
    public static class Builder {
        ...
        public ListAllAuthenticatedDomainWithUser200ResponseInnerDnsDkim1 build() {
            return new ListAllAuthenticatedDomainWithUser200ResponseInnerDnsDkim1(
                this
            );
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListAllAuthenticatedDomainWithUser200ResponseInnerDnsDkim1.class.getSimpleName() +
            "(",
            ")"
        );
