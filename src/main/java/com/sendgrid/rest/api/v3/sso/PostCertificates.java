...
import com.sendgrid.rest.api.v3.sso.models.PostSsoCertificatesRequest;
...
public class PostCertificates {
    private final PostSsoCertificatesRequest postSsoCertificatesRequest;


    public SsoCertificateBody send(final TokenRestClient client) {
        String path = "/v3/sso/certificates";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostCertificates creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (postSsoCertificatesRequest != null) {
            builder.body(JsonUtil.toJson(postSsoCertificatesRequest));
        }
    }
