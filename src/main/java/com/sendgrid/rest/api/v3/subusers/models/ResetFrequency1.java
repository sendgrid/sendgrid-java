...
public enum ResetFrequency1 {
    ...
    private ResetFrequency1(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ResetFrequency1 fromString(final String value) {
        return CustomDeserializer. enum (value, ResetFrequency1.values());
    }
