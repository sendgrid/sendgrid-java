...
import com.sendgrid.rest.api.v3.teammates.models.PostTeammates201Response;
import com.sendgrid.rest.api.v3.teammates.models.PostTeammates400Response;
import com.sendgrid.rest.api.v3.teammates.models.PostTeammatesRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PostTeammateInvitation {
    private String onBehalfOf;
    private final PostTeammatesRequest postTeammatesRequest;


    public PostTeammates201Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostTeammateInvitation creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PostTeammates201Response.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (postTeammatesRequest != null) {
            builder.body(JsonUtil.toJson(postTeammatesRequest));
        }
    }
