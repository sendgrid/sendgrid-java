...
@ToString
public class GetMarketingFieldDefinitions200Response {
    ...
    public GetMarketingFieldDefinitions200Response() {
    }

    private GetMarketingFieldDefinitions200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<CustomFieldDefinitionsResponse> customFields, List<ReservedFieldDefinitionsResponseInner> reservedFields) {
        ...
        public GetMarketingFieldDefinitions200Response build() {
            return new GetMarketingFieldDefinitions200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingFieldDefinitions200Response.class.getSimpleName() + "(", ")");
        if (customFields != null) joiner.add("customFields=" + customFields);
        if (reservedFields != null) joiner.add("reservedFields=" + reservedFields);
