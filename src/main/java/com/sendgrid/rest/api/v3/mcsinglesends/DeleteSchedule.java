...
public class DeleteSchedule {
    ...
    public SinglesendSchedule send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "DeleteSchedule creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), SinglesendSchedule.class);
    }
