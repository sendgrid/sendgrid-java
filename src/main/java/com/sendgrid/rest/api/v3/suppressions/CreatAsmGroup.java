...
import com.sendgrid.rest.api.v3.suppressions.models.CreatAsmGroup201Response;
...
public class CreatAsmGroup extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private SuppressionGroupRequestBaseProps suppressionGroupRequestBaseProps;

    public ApiResponse<CreatAsmGroup201Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "CreatAsmGroup creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                CreatAsmGroup201Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (suppressionGroupRequestBaseProps != null) {
            request.addBody(JsonUtil.toJson(suppressionGroupRequestBaseProps));
        }
    }
}
