...
public class PatchWebhookParseSettingById {
    private final String hostname;
    private String onBehalfOf;
    private final ParseSetting parseSetting;
    ...
    public ParseSetting send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchWebhookParseSettingById creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (parseSetting != null) {
            builder.body(JsonUtil.toJson(parseSetting));
        }
    }
