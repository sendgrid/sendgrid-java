...
@ToString
public class PatchSsoCertificatesCertIdRequest {
    ...
    public PatchSsoCertificatesCertIdRequest() {
    }

    private PatchSsoCertificatesCertIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchSsoCertificatesCertIdRequest build() {
            return new PatchSsoCertificatesCertIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchSsoCertificatesCertIdRequest.class.getSimpleName() + "(", ")");
