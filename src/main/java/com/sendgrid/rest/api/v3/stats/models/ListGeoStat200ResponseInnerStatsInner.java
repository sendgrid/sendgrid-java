...
import com.sendgrid.rest.api.v3.stats.models.AdvancedStatsClicksOpens;
...
@ToString
public class ListGeoStat200ResponseInnerStatsInner {
    ...
    @Getter
    @Setter
    private AdvancedStatsClicksOpens metrics;

    public ListGeoStat200ResponseInnerStatsInner() {}

    private ListGeoStat200ResponseInnerStatsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder metrics(AdvancedStatsClicksOpens metrics) {
            this.metrics = metrics;
            return this;
        }

        public ListGeoStat200ResponseInnerStatsInner build() {
            return new ListGeoStat200ResponseInnerStatsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListGeoStat200ResponseInnerStatsInner.class.getSimpleName() + "(",
            ")"
        );
