...
import com.sendgrid.rest.api.v3.apikeys.models.PutApiKeysApiKeyIdRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PutApiKeysById {
    private final String apiKeyId;
    private String onBehalfOf;
    private final PutApiKeysApiKeyIdRequest putApiKeysApiKeyIdRequest;


    public ApiKeyResponse send(final TokenRestClient client) {
        String path = "/v3/api_keys/{api_key_id}";
        Request.Builder builder = new Request.Builder(HttpMethod.PUT, path)
                .addPathParam("api_key_id", apiKeyId.toString());
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PutApiKeysById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ApiKeyResponse.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (putApiKeysApiKeyIdRequest != null) {
            builder.body(JsonUtil.toJson(putApiKeysApiKeyIdRequest));
        }
    }
