...
public class GetSinglesendsById {
    private final String id;
    private String query;


    public SinglesendsResponse send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetSinglesendsById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), SinglesendsResponse.class);
    }
