...
@ToString
public class GetMessage404ResponseErrorsInner {
    ...
    public GetMessage404ResponseErrorsInner() {}

    private GetMessage404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMessage404ResponseErrorsInner build() {
            return new GetMessage404ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetMessage404ResponseErrorsInner.class.getSimpleName() + "(",
            ")"
        );
