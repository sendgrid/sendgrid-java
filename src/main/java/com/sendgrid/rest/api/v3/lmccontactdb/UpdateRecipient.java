...
import com.sendgrid.rest.api.v3.lmccontactdb.models.UpdateRecipientRequestInner;
...
public class UpdateRecipient extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private List<UpdateRecipientRequestInner> updateRecipientRequestInner;

    public ApiResponse<ContactdbRecipientResponse201> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateRecipient creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ContactdbRecipientResponse201.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (updateRecipientRequestInner != null) {
            request.addBody(JsonUtil.toJson(updateRecipientRequestInner));
        }
    }
}
