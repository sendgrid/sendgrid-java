...
@ToString
public class SinglesendResponseSendTo {
    ...
    public SinglesendResponseSendTo() {
    }

    private SinglesendResponseSendTo(Builder builder) {
    ...
    public static class Builder {
        ...
        public SinglesendResponseSendTo build() {
            return new SinglesendResponseSendTo(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SinglesendResponseSendTo.class.getSimpleName() + "(", ")");
