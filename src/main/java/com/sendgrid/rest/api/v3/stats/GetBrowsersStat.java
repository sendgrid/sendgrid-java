...
import com.sendgrid.rest.api.v3.stats.models.GetBrowsersStats200ResponseInner;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetBrowsersStat {
    ...
    public List<GetBrowsersStats200ResponseInner> send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetBrowsersStat creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), List & lt; GetBrowsersStats200ResponseInner & gt;.class);
    }
