...
@ToString
public class PostTeammatesRequest {
    ...
    public PostTeammatesRequest() {
    }

    private PostTeammatesRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostTeammatesRequest build() {
            return new PostTeammatesRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostTeammatesRequest.class.getSimpleName() + "(", ")");
