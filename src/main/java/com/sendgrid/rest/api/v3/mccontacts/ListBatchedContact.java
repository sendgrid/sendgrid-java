...
public class ListBatchedContact extends ApiKeyBase {

    @Setter
    private ListBatchedContactRequest listBatchedContactRequest;

    public ApiResponse<ListBatchedContact200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListBatchedContact creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListBatchedContact200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (listBatchedContactRequest != null) {
            request.addBody(JsonUtil.toJson(listBatchedContactRequest));
        }
    }
}
