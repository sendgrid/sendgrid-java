...
@ToString
public class DeleteMarketingContacts400Response {
    ...
    public DeleteMarketingContacts400Response() {
    }

    private DeleteMarketingContacts400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteMarketingContacts400Response build() {
            return new DeleteMarketingContacts400Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteMarketingContacts400Response.class.getSimpleName() + "(", ")");
