...
import com.sendgrid.rest.api.v3.webhooks.models.GetSignedEventWebhook404ResponseErrorsInner;
...
@ToString
public class GetSignedEventWebhook404Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetSignedEventWebhook404ResponseErrorsInner> errors;

    public GetSignedEventWebhook404Response() {}

    private GetSignedEventWebhook404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(
            List<GetSignedEventWebhook404ResponseErrorsInner> errors
        ) {
            this.errors = errors;
            return this;
        }

        public GetSignedEventWebhook404Response build() {
            return new GetSignedEventWebhook404Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetSignedEventWebhook404Response.class.getSimpleName() + "(",
            ")"
        );
