...
@ToString
public class PostTemplatesTemplateIdRequest {
    ...
    public PostTemplatesTemplateIdRequest() {
    }

    private PostTemplatesTemplateIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostTemplatesTemplateIdRequest build() {
            return new PostTemplatesTemplateIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostTemplatesTemplateIdRequest.class.getSimpleName() + "(", ")");
