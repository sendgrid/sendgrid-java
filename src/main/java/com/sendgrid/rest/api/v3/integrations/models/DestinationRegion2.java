...
public enum DestinationRegion2 {
    EU("EU"),
    ...
    private DestinationRegion2(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static DestinationRegion2 forValue(final String value) {
        return Promoter.enumFromString(value, DestinationRegion2.values());
    }
}
