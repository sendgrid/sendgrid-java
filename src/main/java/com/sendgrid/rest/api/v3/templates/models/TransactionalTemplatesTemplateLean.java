...
public class TransactionalTemplatesTemplateLean {
    ...
    public static class Builder {
        ...
        public Builder(UUID id, String name, Generation1 generation, String updatedAt) {
            this.id = id;
            this.name = name;
        ...
        public Builder versions(List<TransactionalTemplatesVersionOutputLean> versions) {
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", TransactionalTemplatesTemplateLean.class.getSimpleName() + "(", ")");
