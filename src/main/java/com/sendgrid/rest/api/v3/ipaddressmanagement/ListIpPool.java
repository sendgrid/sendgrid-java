...
public class ListIpPool extends ApiKeyBase {
    ...
    public ApiResponse<ListIpPool200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListIpPool creation failed: Unable to connect to server"
            );
        } else if (
