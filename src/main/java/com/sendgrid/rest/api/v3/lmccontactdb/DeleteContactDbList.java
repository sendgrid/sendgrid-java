...
import com.sendgrid.rest.api.v3.lmccontactdb.models.DeleteContacts;
...
public class DeleteContactDbList extends ApiKeyBase {
    ...
    public ApiResponse<Object> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DeleteContactDbList creation failed: Unable to connect to server"
            );
        } else if (
