...
public class ContactdbRecipient200RecipientsInner {
    ...
    public static class Builder {
        ...
        public Builder customFields(List<ContactdbCustomFieldIdValue> customFields) {
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", ContactdbRecipient200RecipientsInner.class.getSimpleName() + "(", ")");
