...
import com.sendgrid.rest.api.v3.stats.models.GetStats200ResponseInner;
...
public class GetStats {
    ...
    public List<GetStats200ResponseInner> send(final TokenRestClient client) {
        String path = "/v3/stats";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetStats creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), List & lt; GetStats200ResponseInner & gt;.class);
    }
