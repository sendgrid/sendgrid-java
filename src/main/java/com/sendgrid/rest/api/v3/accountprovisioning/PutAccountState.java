...
public class PutAccountState {
    private final String accountID;
    private final AccountProvisioningStateWrite accountProvisioningStateWrite;
    ...
    public void send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PutAccountState creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (accountProvisioningStateWrite != null) {
            builder.body(JsonUtil.toJson(accountProvisioningStateWrite));
        }
    }
