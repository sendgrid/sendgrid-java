...
@ToString
public class AddIpToIpPool201Response {
    ...
    public AddIpToIpPool201Response() {}

    private AddIpToIpPool201Response(Builder builder) {
        this.ip = builder.ip;
    ...
    public static class Builder {
        ...
        public AddIpToIpPool201Response build() {
            return new AddIpToIpPool201Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            AddIpToIpPool201Response.class.getSimpleName() + "(",
            ")"
        );
