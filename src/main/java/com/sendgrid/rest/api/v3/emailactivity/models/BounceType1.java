...
public enum BounceType1 {
    ...
    private BounceType1(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static BounceType1 fromString(final String value) {
        return CustomDeserializer. enum (value, BounceType1.values());
    }
