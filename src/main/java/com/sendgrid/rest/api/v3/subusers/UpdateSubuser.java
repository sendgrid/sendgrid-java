...
import com.sendgrid.rest.api.v3.subusers.models.UpdateSubuserRequest;
...
public class UpdateSubuser extends ApiKeyBase {
    ...
    public ApiResponse<Object> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateSubuser creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (updateSubuserRequest != null) {
            request.addBody(JsonUtil.toJson(updateSubuserRequest));
        }
    }
}
