...
@ToString
public class GetTeammatesTeammateNameSubuserAccess400ResponseErrorsInner {
    ...
    public GetTeammatesTeammateNameSubuserAccess400ResponseErrorsInner() {
    }

    private GetTeammatesTeammateNameSubuserAccess400ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetTeammatesTeammateNameSubuserAccess400ResponseErrorsInner build() {
            return new GetTeammatesTeammateNameSubuserAccess400ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetTeammatesTeammateNameSubuserAccess400ResponseErrorsInner.class.getSimpleName() + "(", ")");
