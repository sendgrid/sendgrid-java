...
@ToString
public class PostCampaignsCampaignIdSchedulesTestRequest {
    ...
    public PostCampaignsCampaignIdSchedulesTestRequest() {
    }

    private PostCampaignsCampaignIdSchedulesTestRequest(Builder builder) {
        this.to = builder.to;
    }
    ...
    public static class Builder {
        ...
        public PostCampaignsCampaignIdSchedulesTestRequest build() {
            return new PostCampaignsCampaignIdSchedulesTestRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostCampaignsCampaignIdSchedulesTestRequest.class.getSimpleName() + "(", ")");
