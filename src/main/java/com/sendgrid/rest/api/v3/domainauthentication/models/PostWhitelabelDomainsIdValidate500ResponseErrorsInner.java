...
@ToString
public class PostWhitelabelDomainsIdValidate500ResponseErrorsInner {
    ...
    public PostWhitelabelDomainsIdValidate500ResponseErrorsInner() {
    }

    private PostWhitelabelDomainsIdValidate500ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostWhitelabelDomainsIdValidate500ResponseErrorsInner build() {
            return new PostWhitelabelDomainsIdValidate500ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelDomainsIdValidate500ResponseErrorsInner.class.getSimpleName() + "(", ")");
