...
public class UpdateSingleSend extends ApiKeyBase {
    ...
    public ApiResponse<SinglesendResponse> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateSingleSend creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (singlesendRequest != null) {
            request.addBody(JsonUtil.toJson(singlesendRequest));
        }
    }
}
