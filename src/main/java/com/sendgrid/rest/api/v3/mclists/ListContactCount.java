...
import com.sendgrid.rest.api.v3.mclists.models.ListContactCount200Response;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class ListContactCount extends ApiKeyBase {

    private final String id;

    public ApiResponse<ListContactCount200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListContactCount creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListContactCount200Response.class
            ),
            response.getHeaders()
        );
    }
