...
import com.sendgrid.rest.api.v3.user.models.GetUserEmail200Response;
...
public class GetEmail {
    ...
    public GetUserEmail200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetEmail creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), GetUserEmail200Response.class);
    }
