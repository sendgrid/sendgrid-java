...
import com.sendgrid.rest.api.v3.suppressions.models.ListGlobalSuppression200ResponseInner;
...
public class ListGlobalSuppression extends ApiKeyBase {
    ...
    public ApiResponse<List<ListGlobalSuppression200ResponseInner>> send(
        final ApiKeyRestClient client
    ) {
        String path = "/v3/suppression/unsubscribes";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListGlobalSuppression creation failed: Unable to connect to server"
            );
        } else if (
