...
import com.sendgrid.rest.api.v3.mailsettings.models.MailSettingsFooter;
...
public class UpdateFooter extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private MailSettingsFooter mailSettingsFooter;

    public ApiResponse<MailSettingsFooter> send(final ApiKeyRestClient client) {
        String path = "/v3/mail_settings/footer";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateFooter creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), MailSettingsFooter.class),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (mailSettingsFooter != null) {
            request.addBody(JsonUtil.toJson(mailSettingsFooter));
        }
    }
}
