...
public class DeleteCustomField extends ApiKeyBase {
    ...
    public ApiResponse<ErrorResponse> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DeleteCustomField creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), ErrorResponse.class),
            response.getHeaders()
        );
    }
