...
public class ListContactDbList extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    public ApiResponse<ListAllListsResponse> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListContactDbList creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), ListAllListsResponse.class),
            response.getHeaders()
        );
    }
