...
import com.sendgrid.rest.api.v3.suppressions.models.DeleteSuppressionSpamReportsRequest;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class DeleteSuppressionSpamReport {
    private String onBehalfOf;
    private final DeleteSuppressionSpamReportsRequest deleteSuppressionSpamReportsRequest;


    public Object send(final TokenRestClient client) {
        String path = "/v3/suppression/spam_reports";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "DeleteSuppressionSpamReport creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (deleteSuppressionSpamReportsRequest != null) {
            builder.body(JsonUtil.toJson(deleteSuppressionSpamReportsRequest));
        }
    }
