...
@ToString
public class PatchMailSettingsTemplate200Response {
    ...
    public PatchMailSettingsTemplate200Response() {
    }

    private PatchMailSettingsTemplate200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchMailSettingsTemplate200Response build() {
            return new PatchMailSettingsTemplate200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchMailSettingsTemplate200Response.class.getSimpleName() + "(", ")");
