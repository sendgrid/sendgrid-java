...
import com.sendgrid.rest.api.v3.mcsegments.models.GetSegment404ResponseErrorsInner;
...
@ToString
public class GetSegment404Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetSegment404ResponseErrorsInner> errors;

    public GetSegment404Response() {}

    private GetSegment404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<GetSegment404ResponseErrorsInner> errors) {
            this.errors = errors;
        }

        public GetSegment404Response build() {
            return new GetSegment404Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetSegment404Response.class.getSimpleName() + "(",
            ")"
        );
