...
@ToString
public class PostAsmGroups201Response {
    ...
    public PostAsmGroups201Response() {
    }

    private PostAsmGroups201Response(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public Builder(Integer id, String name, String description, Boolean isDefault) {
            this.id = id;
            this.name = name;
        ...
        public PostAsmGroups201Response build() {
            return new PostAsmGroups201Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostAsmGroups201Response.class.getSimpleName() + "(", ")");
