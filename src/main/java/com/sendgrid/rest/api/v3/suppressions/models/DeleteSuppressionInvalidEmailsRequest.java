...
@ToString
public class DeleteSuppressionInvalidEmailsRequest {
    ...
    public DeleteSuppressionInvalidEmailsRequest() {
    }

    private DeleteSuppressionInvalidEmailsRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteSuppressionInvalidEmailsRequest build() {
            return new DeleteSuppressionInvalidEmailsRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteSuppressionInvalidEmailsRequest.class.getSimpleName() + "(", ")");
