...
public class CreateAListRequest {
    ...
    private CreateAListRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public CreateAListRequest build() {
            return new CreateAListRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", CreateAListRequest.class.getSimpleName() + "(", ")");
