...
import com.sendgrid.rest.api.v3.stats.models.GetClientsStats200ResponseInner;
import com.sendgrid.rest.api.v3.stats.models.Schema3;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetClientStat {
    private final Schema3 clientType;
    private String query;
    private String onBehalfOf;


    public List<GetClientsStats200ResponseInner> send(final TokenRestClient client) {
        String path = "/v3/clients/{client_type}/stats";
        Request.Builder builder = new Request.Builder(HttpMethod.GET, path)
                .addPathParam("client_type", clientType.toString());
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetClientStat creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), List & lt; GetClientsStats200ResponseInner & gt;.class);
    }
