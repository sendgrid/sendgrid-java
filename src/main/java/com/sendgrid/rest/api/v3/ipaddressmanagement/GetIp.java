...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.GetSendIpsIps200Response;
...
public class GetIp {
    ...
    public GetSendIpsIps200Response send(final TokenRestClient client) {
        ...
        return JsonUtil.fromJson(response.getStream(), GetSendIpsIps200Response.class);
    }
