...
public class UpdateSubuserRequest {
    ...
    private UpdateSubuserRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateSubuserRequest build() {
            return new UpdateSubuserRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateSubuserRequest.class.getSimpleName() + "(",
            ")"
        );
