...
@ToString
public class PostAsmGroupsGroupIdSuppressions201Response {
    ...
    public PostAsmGroupsGroupIdSuppressions201Response() {
    }

    private PostAsmGroupsGroupIdSuppressions201Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostAsmGroupsGroupIdSuppressions201Response build() {
            return new PostAsmGroupsGroupIdSuppressions201Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostAsmGroupsGroupIdSuppressions201Response.class.getSimpleName() + "(", ")");
