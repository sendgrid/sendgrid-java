...
import com.sendgrid.rest.api.v3.templates.models.GetTemplates200Response;
import com.sendgrid.rest.api.v3.templates.models.GetTemplates400Response;
...
public class GetTemplates {
    ...
    public GetTemplates200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetTemplates creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
            if (Matcher.matches(Integer.toString(statusCode), "400")) {
                GetTemplates400Response error = JsonUtil.fromJson(
                        response.getStream(),
                        GetTemplates400Response.class
                );
                throw new ApiErrorResponse(statusCode, null, error, response.getHeaders());
            }

        }
        return JsonUtil.fromJson(response.getStream(), GetTemplates200Response.class);
    }
