...
@ToString
public class PostContactdbRecipientsRequestInner {
    ...
    public PostContactdbRecipientsRequestInner() {
    }

    private PostContactdbRecipientsRequestInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostContactdbRecipientsRequestInner build() {
            return new PostContactdbRecipientsRequestInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostContactdbRecipientsRequestInner.class.getSimpleName() + "(", ")");
