...
import com.sendgrid.rest.api.v3.linkbranding.models.CreateBrandedLinkRequest;
...
public class CreateBrandedLink extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private CreateBrandedLinkRequest createBrandedLinkRequest;
    ...
    public ApiResponse<LinkBranding200> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "CreateBrandedLink creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (createBrandedLinkRequest != null) {
            request.addBody(JsonUtil.toJson(createBrandedLinkRequest));
        }
    }
}
