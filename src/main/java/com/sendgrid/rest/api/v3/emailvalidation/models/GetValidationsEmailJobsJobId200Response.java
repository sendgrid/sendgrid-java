...
public class GetValidationsEmailJobsJobId200Response {
    ...
    public static class Builder {
        ...
        public Builder result(GetValidationsEmailJobsJobId200ResponseResult result) {
            this.result = result;
            return this;
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetValidationsEmailJobsJobId200Response.class.getSimpleName() + "(", ")");
