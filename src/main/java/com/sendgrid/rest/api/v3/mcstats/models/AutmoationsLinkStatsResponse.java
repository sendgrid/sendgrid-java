...
import com.sendgrid.rest.api.v3.mcstats.models.AutmoationsLinkStatsResponseResultsInner;
...
public class AutmoationsLinkStatsResponse {
    ...
    public static class Builder {
        ...
        public Builder(
            List<AutmoationsLinkStatsResponseResultsInner> results,
            Integer totalClicks,
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            AutmoationsLinkStatsResponse.class.getSimpleName() + "(",
            ")"
        );
