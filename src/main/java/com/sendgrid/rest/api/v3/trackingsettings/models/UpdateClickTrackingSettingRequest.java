...
@ToString
public class UpdateClickTrackingSettingRequest {
    ...
    public UpdateClickTrackingSettingRequest() {}

    private UpdateClickTrackingSettingRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateClickTrackingSettingRequest build() {
            return new UpdateClickTrackingSettingRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateClickTrackingSettingRequest.class.getSimpleName() + "(",
            ")"
        );
