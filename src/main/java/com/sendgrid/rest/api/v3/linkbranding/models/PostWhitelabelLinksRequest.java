...
@ToString
public class PostWhitelabelLinksRequest {
    ...
    public PostWhitelabelLinksRequest() {
    }

    private PostWhitelabelLinksRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostWhitelabelLinksRequest build() {
            return new PostWhitelabelLinksRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelLinksRequest.class.getSimpleName() + "(", ")");
