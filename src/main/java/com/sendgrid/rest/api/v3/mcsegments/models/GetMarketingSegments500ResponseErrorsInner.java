...
@ToString
public class GetMarketingSegments500ResponseErrorsInner {
    ...
    public GetMarketingSegments500ResponseErrorsInner() {
    }

    private GetMarketingSegments500ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMarketingSegments500ResponseErrorsInner build() {
            return new GetMarketingSegments500ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingSegments500ResponseErrorsInner.class.getSimpleName() + "(", ")");
