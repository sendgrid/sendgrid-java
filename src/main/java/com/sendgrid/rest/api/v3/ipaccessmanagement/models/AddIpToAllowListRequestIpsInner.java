...
@ToString
public class AddIpToAllowListRequestIpsInner {
    ...
    public AddIpToAllowListRequestIpsInner() {}

    private AddIpToAllowListRequestIpsInner(Builder builder) {
        this.ip = builder.ip;
    }
    ...
    public static class Builder {
        ...
        public AddIpToAllowListRequestIpsInner build() {
            return new AddIpToAllowListRequestIpsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            AddIpToAllowListRequestIpsInner.class.getSimpleName() + "(",
            ")"
        );
