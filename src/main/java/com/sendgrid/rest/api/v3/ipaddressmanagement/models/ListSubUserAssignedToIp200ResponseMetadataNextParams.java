...
@ToString
public class ListSubUserAssignedToIp200ResponseMetadataNextParams {
    ...
    public ListSubUserAssignedToIp200ResponseMetadataNextParams() {}

    private ListSubUserAssignedToIp200ResponseMetadataNextParams(
        Builder builder
    ) {
    ...
    public static class Builder {
        ...
        public ListSubUserAssignedToIp200ResponseMetadataNextParams build() {
            return new ListSubUserAssignedToIp200ResponseMetadataNextParams(
                this
            );
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListSubUserAssignedToIp200ResponseMetadataNextParams.class.getSimpleName() +
            "(",
            ")"
        );
