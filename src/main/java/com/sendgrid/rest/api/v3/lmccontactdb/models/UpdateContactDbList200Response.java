...
@ToString
public class UpdateContactDbList200Response {
    ...
    public UpdateContactDbList200Response() {}

    private UpdateContactDbList200Response(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public UpdateContactDbList200Response build() {
            return new UpdateContactDbList200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateContactDbList200Response.class.getSimpleName() + "(",
            ")"
        );
