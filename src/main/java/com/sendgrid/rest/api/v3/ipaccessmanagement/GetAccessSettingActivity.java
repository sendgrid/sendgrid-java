...
import com.sendgrid.rest.api.v3.ipaccessmanagement.models.GetAccessSettingsActivity200Response;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetAccessSettingActivity {
    private Integer limit;
    private String onBehalfOf;


    public GetAccessSettingsActivity200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetAccessSettingActivity creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetAccessSettingsActivity200Response.class);
    }
