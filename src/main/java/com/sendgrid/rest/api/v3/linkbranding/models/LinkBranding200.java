...
public class LinkBranding200 {
    ...
    public static class Builder {
        ...
        public Builder(Integer id, String domain, String username, Integer userId, Default2 _default, Valid3 valid, Legacy legacy, LinkBranding200Dns dns) {
            this.id = id;
            this.domain = domain;
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", LinkBranding200.class.getSimpleName() + "(", ")");
