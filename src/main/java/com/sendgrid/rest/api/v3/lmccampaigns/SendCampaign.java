...
public class SendCampaign extends ApiKeyBase {
    ...
    public ApiResponse<SendACampaignResponse> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "SendCampaign creation failed: Unable to connect to server"
            );
        } else if (
