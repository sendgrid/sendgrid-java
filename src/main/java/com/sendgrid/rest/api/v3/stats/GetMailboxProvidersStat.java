...
import com.sendgrid.rest.api.v3.stats.models.GetMailboxProvidersStats200ResponseInner;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetMailboxProvidersStat {
    ...
    public List<GetMailboxProvidersStats200ResponseInner> send(final TokenRestClient client) {
        String path = "/v3/mailbox_providers/stats";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetMailboxProvidersStat creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), List & lt; GetMailboxProvidersStats200ResponseInner & gt;.class);
    }
