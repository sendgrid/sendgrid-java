...
public class TransactionalTemplate {
    ...
    public static class Builder {
        ...
        public Builder(Object id, Object name, Generation1 generation, Object updatedAt) {
            this.id = id;
            this.name = name;
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", TransactionalTemplate.class.getSimpleName() + "(", ")");
