...
import com.sendgrid.rest.api.v3.stats.models.ListClientStat200ResponseInnerStatsInner;
...
@ToString
public class ListClientStat200ResponseInner {
    ...
    @Getter
    @Setter
    private List<ListClientStat200ResponseInnerStatsInner> stats;

    public ListClientStat200ResponseInner() {}

    private ListClientStat200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder stats(
            List<ListClientStat200ResponseInnerStatsInner> stats
        ) {
            this.stats = stats;
            return this;
        }

        public ListClientStat200ResponseInner build() {
            return new ListClientStat200ResponseInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListClientStat200ResponseInner.class.getSimpleName() + "(",
            ")"
        );
