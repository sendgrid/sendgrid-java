...
@ToString
public class ListExportContact200ResponseMetadata {
    ...
    public ListExportContact200ResponseMetadata() {}

    private ListExportContact200ResponseMetadata(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListExportContact200ResponseMetadata build() {
            return new ListExportContact200ResponseMetadata(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListExportContact200ResponseMetadata.class.getSimpleName() + "(",
            ")"
        );
