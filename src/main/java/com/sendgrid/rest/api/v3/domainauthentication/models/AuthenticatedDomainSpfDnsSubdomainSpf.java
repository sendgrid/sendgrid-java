...
@ToString
public class AuthenticatedDomainSpfDnsSubdomainSpf {
    ...
    public AuthenticatedDomainSpfDnsSubdomainSpf() {
    }

    private AuthenticatedDomainSpfDnsSubdomainSpf(Builder builder) {
    ...
    public static class Builder {
        ...
        public AuthenticatedDomainSpfDnsSubdomainSpf build() {
            return new AuthenticatedDomainSpfDnsSubdomainSpf(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", AuthenticatedDomainSpfDnsSubdomainSpf.class.getSimpleName() + "(", ")");
