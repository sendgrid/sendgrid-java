...
@ToString
public class PatchAlertsAlertIdRequest {
    ...
    public PatchAlertsAlertIdRequest() {
    }

    private PatchAlertsAlertIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchAlertsAlertIdRequest build() {
            return new PatchAlertsAlertIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchAlertsAlertIdRequest.class.getSimpleName() + "(", ")");
