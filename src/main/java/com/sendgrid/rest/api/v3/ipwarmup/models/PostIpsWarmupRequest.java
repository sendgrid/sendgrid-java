...
@ToString
public class PostIpsWarmupRequest {
    ...
    public PostIpsWarmupRequest() {
    }

    private PostIpsWarmupRequest(Builder builder) {
        this.ip = builder.ip;
    }
    ...
    public static class Builder {
        ...
        public PostIpsWarmupRequest build() {
            return new PostIpsWarmupRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostIpsWarmupRequest.class.getSimpleName() + "(", ")");
