...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.Region5;
...
@ToString
public class GetIpPool200ResponseIpCountByRegionInner {
    ...
    public GetIpPool200ResponseIpCountByRegionInner() {}

    private GetIpPool200ResponseIpCountByRegionInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetIpPool200ResponseIpCountByRegionInner build() {
            return new GetIpPool200ResponseIpCountByRegionInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetIpPool200ResponseIpCountByRegionInner.class.getSimpleName() +
            "(",
            ")"
        );
