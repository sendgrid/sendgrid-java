...
@ToString
public class SegmentStatusResponse {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("queryValidation")
    @Getter
    @Setter
    ...
    private SegmentStatusResponse(Builder builder) {
        this.queryValidation = builder.queryValidation;
    ...
    public static class Builder {
        ...
        public Builder(String queryValidation) {
        ...
        public SegmentStatusResponse build() {
            return new SegmentStatusResponse(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SegmentStatusResponse.class.getSimpleName() + "(", ")");
        if (queryValidation != null) joiner.add("queryValidation=" + queryValidation);
        if (errorMessage != null) joiner.add("errorMessage=" + errorMessage);
