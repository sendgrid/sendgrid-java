...
@ToString
public class ListExportContact200ResponseResultInnerSegmentsInner {
    ...
    public ListExportContact200ResponseResultInnerSegmentsInner() {}

    private ListExportContact200ResponseResultInnerSegmentsInner(
        Builder builder
    ) {
        this.ID = builder.ID;
    ...
    public static class Builder {
        ...
        public ListExportContact200ResponseResultInnerSegmentsInner build() {
            return new ListExportContact200ResponseResultInnerSegmentsInner(
                this
            );
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListExportContact200ResponseResultInnerSegmentsInner.class.getSimpleName() +
            "(",
            ")"
        );
