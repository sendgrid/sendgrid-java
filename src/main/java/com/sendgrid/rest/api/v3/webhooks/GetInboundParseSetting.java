...
import com.sendgrid.rest.api.v3.webhooks.models.GetUserWebhooksParseSettings200Response;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetInboundParseSetting {
    private String onBehalfOf;


    public GetUserWebhooksParseSettings200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetInboundParseSetting creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetUserWebhooksParseSettings200Response.class);
    }
