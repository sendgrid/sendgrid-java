...
import com.sendgrid.rest.api.v3.scheduledsends.models.PatchUserScheduledSendsBatchIdRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PatchUserScheduledSendById {
    private final String batchId;
    private String onBehalfOf;
    private final PatchUserScheduledSendsBatchIdRequest patchUserScheduledSendsBatchIdRequest;
    ...
    public Object send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchUserScheduledSendById creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (patchUserScheduledSendsBatchIdRequest != null) {
            builder.body(JsonUtil.toJson(patchUserScheduledSendsBatchIdRequest));
        }
    }
