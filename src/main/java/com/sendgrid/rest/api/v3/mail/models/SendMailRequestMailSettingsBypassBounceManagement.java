...
@ToString
public class SendMailRequestMailSettingsBypassBounceManagement {
    ...
    public SendMailRequestMailSettingsBypassBounceManagement() {}

    private SendMailRequestMailSettingsBypassBounceManagement(Builder builder) {
    ...
    public static class Builder {
        ...
        public SendMailRequestMailSettingsBypassBounceManagement build() {
            return new SendMailRequestMailSettingsBypassBounceManagement(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SendMailRequestMailSettingsBypassBounceManagement.class.getSimpleName() +
            "(",
            ")"
        );
