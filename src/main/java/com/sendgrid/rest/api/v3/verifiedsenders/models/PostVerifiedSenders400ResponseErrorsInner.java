...
@ToString
public class PostVerifiedSenders400ResponseErrorsInner {
    ...
    public PostVerifiedSenders400ResponseErrorsInner() {
    }

    private PostVerifiedSenders400ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostVerifiedSenders400ResponseErrorsInner build() {
            return new PostVerifiedSenders400ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostVerifiedSenders400ResponseErrorsInner.class.getSimpleName() + "(", ")");
