...
import com.sendgrid.rest.api.v3.mail.models.ContentEncoding;
import com.sendgrid.rest.api.v3.mail.models.ErrorResponse;
import com.sendgrid.rest.api.v3.mail.models.SendMailRequest;
...
public class SendMail extends ApiKeyBase {
    ...
    public ApiResponse<Void> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "SendMail creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (sendMailRequest != null) {
            request.addBody(JsonUtil.toJson(sendMailRequest));
        }
    }
}
