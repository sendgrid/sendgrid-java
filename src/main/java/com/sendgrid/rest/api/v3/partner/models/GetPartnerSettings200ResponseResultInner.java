...
@ToString
public class GetPartnerSettings200ResponseResultInner {
    ...
    public GetPartnerSettings200ResponseResultInner() {
    }

    private GetPartnerSettings200ResponseResultInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(String title, Boolean enabled, String name, String description) {
            this.title = title;
        ...
        public GetPartnerSettings200ResponseResultInner build() {
            return new GetPartnerSettings200ResponseResultInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetPartnerSettings200ResponseResultInner.class.getSimpleName() + "(", ")");
