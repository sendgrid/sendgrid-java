...
import com.sendgrid.rest.api.v3.mccontacts.models.GetMarketingContacts200Response;
...
public class GetMarketingContact {


    public GetMarketingContacts200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetMarketingContact creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetMarketingContacts200Response.class);
    }
