...
import com.sendgrid.rest.api.v3.teammates.models.GetTeammates200Response;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetTeammateInvitation {
    private Integer limit;
    private Integer offset;
    private String onBehalfOf;


    public GetTeammates200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetTeammateInvitation creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), GetTeammates200Response.class);
    }
