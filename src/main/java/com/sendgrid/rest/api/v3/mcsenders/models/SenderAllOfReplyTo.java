...
@ToString
public class SenderAllOfReplyTo {
    ...
    public SenderAllOfReplyTo() {
    }

    private SenderAllOfReplyTo(Builder builder) {
    ...
    public static class Builder {
        ...
        public SenderAllOfReplyTo build() {
            return new SenderAllOfReplyTo(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SenderAllOfReplyTo.class.getSimpleName() + "(", ")");
