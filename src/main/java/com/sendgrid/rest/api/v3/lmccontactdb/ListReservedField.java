...
import com.sendgrid.rest.api.v3.lmccontactdb.models.ListReservedField200Response;
...
public class ListReservedField extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    public ApiResponse<ListReservedField200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListReservedField creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListReservedField200Response.class
            ),
            response.getHeaders()
        );
    }
