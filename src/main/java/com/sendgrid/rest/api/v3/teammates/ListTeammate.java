...
import com.sendgrid.rest.api.v3.teammates.models.ListTeammate200Response;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class ListTeammate extends ApiKeyBase {
    ...
    public ApiResponse<ListTeammate200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListTeammate creation failed: Unable to connect to server"
            );
        } else if (
