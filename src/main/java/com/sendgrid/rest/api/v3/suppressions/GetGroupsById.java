...
import com.sendgrid.rest.api.v3.suppressions.models.GetAsmGroupsGroupId200Response;
...
public class GetGroupsById {
    ...
    public GetAsmGroupsGroupId200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetGroupsById creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), GetAsmGroupsGroupId200Response.class);
    }
