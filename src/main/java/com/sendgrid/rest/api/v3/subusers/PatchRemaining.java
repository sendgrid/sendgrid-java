...
import com.sendgrid.rest.api.v3.subusers.models.PatchSubusersSubuserNameCreditsRemainingRequest;
...
public class PatchRemaining {
    private final String subuserName;
    private final PatchSubusersSubuserNameCreditsRemainingRequest patchSubusersSubuserNameCreditsRemainingRequest;


    public SubuserCredits send(final TokenRestClient client) {
        String path = "/v3/subusers/{subuser_name}/credits/remaining";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchRemaining creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), SubuserCredits.class);
    }


    private void body(final Request.Builder builder) {
        if (patchSubusersSubuserNameCreditsRemainingRequest != null) {
            builder.body(JsonUtil.toJson(patchSubusersSubuserNameCreditsRemainingRequest));
        }
    }
