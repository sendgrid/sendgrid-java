...
@ToString
public class WarmUpIp404ResponseErrorsInner {
    ...
    public WarmUpIp404ResponseErrorsInner() {}

    private WarmUpIp404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public WarmUpIp404ResponseErrorsInner build() {
            return new WarmUpIp404ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            WarmUpIp404ResponseErrorsInner.class.getSimpleName() + "(",
            ")"
        );
