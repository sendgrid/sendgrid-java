...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.ListIp200ResponseMetadataNextParams;
...
@ToString
public class ListIp200ResponseMetadata {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("next_params")
    @Getter
    @Setter
    private ListIp200ResponseMetadataNextParams nextParams;

    public ListIp200ResponseMetadata() {}

    private ListIp200ResponseMetadata(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder nextParams(
            ListIp200ResponseMetadataNextParams nextParams
        ) {
            this.nextParams = nextParams;
            return this;
        }

        public ListIp200ResponseMetadata build() {
            return new ListIp200ResponseMetadata(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListIp200ResponseMetadata.class.getSimpleName() + "(",
            ")"
        );
