...
import com.sendgrid.rest.api.v3.integrations.models.IntegrationInput;
...
public class AddIntegration extends ApiKeyBase {

    @Setter
    private IntegrationInput integrationInput;
    ...
    public ApiResponse<Integration> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "AddIntegration creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (integrationInput != null) {
            request.addBody(JsonUtil.toJson(integrationInput));
        }
    }
}
