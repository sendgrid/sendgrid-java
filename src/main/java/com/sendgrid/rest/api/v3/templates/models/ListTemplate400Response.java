...
import com.sendgrid.rest.api.v3.templates.models.ListTemplate400ResponseErrorsInner;
...
@ToString
public class ListTemplate400Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<ListTemplate400ResponseErrorsInner> errors;

    public ListTemplate400Response() {}

    private ListTemplate400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<ListTemplate400ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public ListTemplate400Response build() {
            return new ListTemplate400Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListTemplate400Response.class.getSimpleName() + "(",
            ")"
        );
