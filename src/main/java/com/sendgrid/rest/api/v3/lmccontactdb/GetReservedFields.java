...
import com.sendgrid.rest.api.v3.lmccontactdb.models.GetContactdbReservedFields200Response;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetReservedFields {
    private String onBehalfOf;


    public GetContactdbReservedFields200Response send(final TokenRestClient client) {
        String path = "/v3/contactdb/reserved_fields";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetReservedFields creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetContactdbReservedFields200Response.class);
    }
