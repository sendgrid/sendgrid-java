...
import com.sendgrid.rest.api.v3.emailvalidation.models.GetValidationsEmailJobsJobId200ResponseResult;
...
@ToString
public class GetValidationsEmailJobsJobId200Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private GetValidationsEmailJobsJobId200ResponseResult result;

    public GetValidationsEmailJobsJobId200Response() {}

    private GetValidationsEmailJobsJobId200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder result(
            GetValidationsEmailJobsJobId200ResponseResult result
        ) {
            this.result = result;
            return this;
        }

        public GetValidationsEmailJobsJobId200Response build() {
            return new GetValidationsEmailJobsJobId200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetValidationsEmailJobsJobId200Response.class.getSimpleName() + "(",
            ")"
        );
