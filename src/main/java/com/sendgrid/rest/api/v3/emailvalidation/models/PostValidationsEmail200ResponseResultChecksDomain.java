...
@ToString
public class PostValidationsEmail200ResponseResultChecksDomain {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("hasValidAddressSyntax")
    @Getter
    @Setter
    private Boolean hasValidAddressSyntax;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("hasMxOrARecord")
    @Getter
    @Setter
    private Boolean hasMxOrARecord;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("isSuspectedDisposableAddress")
    @Getter
    @Setter
    private Boolean isSuspectedDisposableAddress;

    public PostValidationsEmail200ResponseResultChecksDomain() {
    }

    private PostValidationsEmail200ResponseResultChecksDomain(Builder builder) {
        this.hasValidAddressSyntax = builder.hasValidAddressSyntax;
        this.hasMxOrARecord = builder.hasMxOrARecord;
        this.isSuspectedDisposableAddress = builder.isSuspectedDisposableAddress;
    }
    ...
    public static class Builder {
        ...
        public PostValidationsEmail200ResponseResultChecksDomain build() {
            return new PostValidationsEmail200ResponseResultChecksDomain(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostValidationsEmail200ResponseResultChecksDomain.class.getSimpleName() + "(", ")");
        if (hasValidAddressSyntax != null) joiner.add("hasValidAddressSyntax=" + hasValidAddressSyntax);
        if (hasMxOrARecord != null) joiner.add("hasMxOrARecord=" + hasMxOrARecord);
        if (isSuspectedDisposableAddress != null)
            joiner.add("isSuspectedDisposableAddress=" + isSuspectedDisposableAddress);
