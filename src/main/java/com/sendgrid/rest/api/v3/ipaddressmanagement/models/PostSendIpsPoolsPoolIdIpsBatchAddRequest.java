...
@ToString
public class PostSendIpsPoolsPoolIdIpsBatchAddRequest {
    ...
    public PostSendIpsPoolsPoolIdIpsBatchAddRequest() {
    }

    private PostSendIpsPoolsPoolIdIpsBatchAddRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostSendIpsPoolsPoolIdIpsBatchAddRequest build() {
            return new PostSendIpsPoolsPoolIdIpsBatchAddRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostSendIpsPoolsPoolIdIpsBatchAddRequest.class.getSimpleName() + "(", ")");
