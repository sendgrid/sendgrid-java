...
import com.sendgrid.rest.api.v3.user.models.GetUserUsername200Response;
...
public class GetUsername {
    ...
    public GetUserUsername200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetUsername creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), GetUserUsername200Response.class);
    }
