...
public class PatchCampaignsById {
    private final Integer campaignId;
    private String onBehalfOf;
    private final UpdateACampaignRequest updateACampaignRequest;
    ...
    public Campaigns2xx send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchCampaignsById creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (updateACampaignRequest != null) {
            builder.body(JsonUtil.toJson(updateACampaignRequest));
        }
    }
