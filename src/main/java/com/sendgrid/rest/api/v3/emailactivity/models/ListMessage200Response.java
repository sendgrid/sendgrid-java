...
import com.sendgrid.rest.api.v3.emailactivity.models.AbbvMessage;
...
@ToString
public class ListMessage200Response {
    ...
    public ListMessage200Response() {}

    private ListMessage200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListMessage200Response build() {
            return new ListMessage200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListMessage200Response.class.getSimpleName() + "(",
            ")"
        );
