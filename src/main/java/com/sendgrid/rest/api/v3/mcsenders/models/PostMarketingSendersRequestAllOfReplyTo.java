...
@ToString
public class PostMarketingSendersRequestAllOfReplyTo {
    ...
    public PostMarketingSendersRequestAllOfReplyTo() {
    }

    private PostMarketingSendersRequestAllOfReplyTo(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingSendersRequestAllOfReplyTo build() {
            return new PostMarketingSendersRequestAllOfReplyTo(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingSendersRequestAllOfReplyTo.class.getSimpleName() + "(", ")");
