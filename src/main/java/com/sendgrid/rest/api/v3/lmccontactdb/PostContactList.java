...
public class PostContactList {
    ...
    private final CreateAListRequest createAListRequest;


    public ContactdbList2xx send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostContactList creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ContactdbList2xx.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (createAListRequest != null) {
            builder.body(JsonUtil.toJson(createAListRequest));
        }
    }
