...
import com.sendgrid.rest.api.v3.mccontacts.models.ImportContact200ResponseUploadHeadersInner;
...
@ToString
public class ImportContact200Response {
    ...
    @Getter
    @Setter
    private List<ImportContact200ResponseUploadHeadersInner> uploadHeaders;

    public ImportContact200Response() {}

    private ImportContact200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder uploadHeaders(
            List<ImportContact200ResponseUploadHeadersInner> uploadHeaders
        ) {
            this.uploadHeaders = uploadHeaders;
            return this;
        }

        public ImportContact200Response build() {
            return new ImportContact200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ImportContact200Response.class.getSimpleName() + "(",
            ")"
        );
