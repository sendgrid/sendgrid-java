...
public class PostIntegrations {
    private final PostPatchIntegrationRequest postPatchIntegrationRequest;


    public SsoIntegration send(final TokenRestClient client) {
        String path = "/v3/sso/integrations";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostIntegrations creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), SsoIntegration.class);
    }


    private void body(final Request.Builder builder) {
        if (postPatchIntegrationRequest != null) {
            builder.body(JsonUtil.toJson(postPatchIntegrationRequest));
        }
    }
