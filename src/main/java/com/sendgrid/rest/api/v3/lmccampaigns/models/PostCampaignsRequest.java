...
@ToString
public class PostCampaignsRequest {
    ...
    private PostCampaignsRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostCampaignsRequest build() {
            return new PostCampaignsRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostCampaignsRequest.class.getSimpleName() + "(", ")");
