...
@ToString
public class GetAsmSuppressions200ResponseInner {
    ...
    public GetAsmSuppressions200ResponseInner() {
    }

    private GetAsmSuppressions200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(String email, Integer groupId, String groupName, Integer createdAt) {
            this.email = email;
        ...
        public GetAsmSuppressions200ResponseInner build() {
            return new GetAsmSuppressions200ResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetAsmSuppressions200ResponseInner.class.getSimpleName() + "(", ")");
