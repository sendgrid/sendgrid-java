...
public class PostPatchIntegrationRequest {
    ...
    public static class Builder {
        ...
        public Builder(String name, Boolean enabled, String signinUrl, String signoutUrl, String entityId) {
            this.name = name;
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostPatchIntegrationRequest.class.getSimpleName() + "(", ")");
