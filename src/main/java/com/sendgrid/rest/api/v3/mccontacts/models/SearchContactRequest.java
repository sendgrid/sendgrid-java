...
public class SearchContactRequest {
    ...
    private SearchContactRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public SearchContactRequest build() {
            return new SearchContactRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SearchContactRequest.class.getSimpleName() + "(",
            ")"
        );
