...
@ToString
public class ImportContact400Response {
    ...
    public ImportContact400Response() {}

    private ImportContact400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ImportContact400Response build() {
            return new ImportContact400Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ImportContact400Response.class.getSimpleName() + "(",
            ")"
        );
