...
public class CatalogEntryEntitlements {
    ...
    @JsonProperty("emailSendsMaxMonthly")
    @Getter
    @Setter
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("teammatesMaxTotal")
    @Getter
    @Setter
    private Long teammatesMaxTotal;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("usersMaxTotal")
    @Getter
    @Setter
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", CatalogEntryEntitlements.class.getSimpleName() + "(", ")");
        if (emailSendsMaxMonthly != null) joiner.add("emailSendsMaxMonthly=" + emailSendsMaxMonthly);
        if (ipCount != null) joiner.add("ipCount=" + ipCount);
        if (teammatesMaxTotal != null) joiner.add("teammatesMaxTotal=" + teammatesMaxTotal);
