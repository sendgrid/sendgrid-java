...
public class PutCredits {
    private final String subuserName;
    private final SubuserCreditsRequest subuserCreditsRequest;
    ...
    public SubuserCredits send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PutCredits creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (subuserCreditsRequest != null) {
            builder.body(JsonUtil.toJson(subuserCreditsRequest));
        }
    }
