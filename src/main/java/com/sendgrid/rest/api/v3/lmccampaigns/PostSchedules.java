...
public class PostSchedules {
    private final Integer campaignId;
    private String onBehalfOf;
    private final ScheduleACampaignRequest scheduleACampaignRequest;


    public ScheduleACampaignResponse send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostSchedules creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ScheduleACampaignResponse.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (scheduleACampaignRequest != null) {
            builder.body(JsonUtil.toJson(scheduleACampaignRequest));
        }
    }
