...
import com.sendgrid.rest.api.v3.lmccampaigns.models.UpdateAScheduledCampaignRequest;
import com.sendgrid.rest.api.v3.lmccampaigns.models.UpdateAScheduledCampaignResponse;
...
public class PatchSchedules {
    ...
    private final UpdateAScheduledCampaignRequest updateAScheduledCampaignRequest;


    public UpdateAScheduledCampaignResponse send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchSchedules creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), UpdateAScheduledCampaignResponse.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (updateAScheduledCampaignRequest != null) {
            builder.body(JsonUtil.toJson(updateAScheduledCampaignRequest));
        }
    }
