...
import com.sendgrid.rest.api.v3.user.models.GETUserAccountResponse;
...
public class GetAccount {
    ...
    public GETUserAccountResponse send(final TokenRestClient client) {
        String path = "/v3/user/account";
        ...
        return JsonUtil.fromJson(response.getStream(), GETUserAccountResponse.class);
    }
