...
@ToString
public class GetContactByIdentifiers200Response {
    ...
    public GetContactByIdentifiers200Response() {}

    private GetContactByIdentifiers200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetContactByIdentifiers200Response build() {
            return new GetContactByIdentifiers200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetContactByIdentifiers200Response.class.getSimpleName() + "(",
            ")"
        );
