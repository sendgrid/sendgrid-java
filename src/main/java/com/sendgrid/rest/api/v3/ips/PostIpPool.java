...
import com.sendgrid.rest.api.v3.ips.models.PostIpsPoolsRequest;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PostIpPool {
    private final PostIpsPoolsRequest postIpsPoolsRequest;
    ...
    private void body(final Request.Builder builder) {
        if (postIpsPoolsRequest != null) {
            builder.body(JsonUtil.toJson(postIpsPoolsRequest));
        }
    }
