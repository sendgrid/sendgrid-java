...
@ToString
public class PostValidationsEmail200ResponseResult {
    ...
    @Getter
    @Setter
    private PostValidationsEmail200ResponseResultChecks checks;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("source")
    @Getter
    @Setter
    ...
    public PostValidationsEmail200ResponseResult() {
    }

    private PostValidationsEmail200ResponseResult(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(String email, Verdict verdict, BigDecimal score, String local, String host, PostValidationsEmail200ResponseResultChecks checks, String ipAddress) {
            this.email = email;
        ...
        public PostValidationsEmail200ResponseResult build() {
            return new PostValidationsEmail200ResponseResult(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostValidationsEmail200ResponseResult.class.getSimpleName() + "(", ")");
