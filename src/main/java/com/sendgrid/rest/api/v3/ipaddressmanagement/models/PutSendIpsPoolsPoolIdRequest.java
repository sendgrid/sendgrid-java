...
@ToString
public class PutSendIpsPoolsPoolIdRequest {
    ...
    public PutSendIpsPoolsPoolIdRequest() {
    }

    private PutSendIpsPoolsPoolIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PutSendIpsPoolsPoolIdRequest build() {
            return new PutSendIpsPoolsPoolIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutSendIpsPoolsPoolIdRequest.class.getSimpleName() + "(", ")");
