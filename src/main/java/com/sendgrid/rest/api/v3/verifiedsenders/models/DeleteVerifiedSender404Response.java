...
@ToString
public class DeleteVerifiedSender404Response {
    ...
    public DeleteVerifiedSender404Response() {}

    private DeleteVerifiedSender404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteVerifiedSender404Response build() {
            return new DeleteVerifiedSender404Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            DeleteVerifiedSender404Response.class.getSimpleName() + "(",
            ")"
        );
