...
public enum WinnerCriteria {
    ...
    private WinnerCriteria(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static WinnerCriteria fromString(final String value) {
        return CustomDeserializer. enum (value, WinnerCriteria.values());
    }
