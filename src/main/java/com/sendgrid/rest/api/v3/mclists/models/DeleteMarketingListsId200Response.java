...
@ToString
public class DeleteMarketingListsId200Response {
    ...
    public DeleteMarketingListsId200Response() {
    }

    private DeleteMarketingListsId200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteMarketingListsId200Response build() {
            return new DeleteMarketingListsId200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteMarketingListsId200Response.class.getSimpleName() + "(", ")");
