...
public class SenderAllOfFrom {
    ...
    public SenderAllOfFrom() {
    }

    private SenderAllOfFrom(Builder builder) {
    ...
    public static class Builder {
        ...
        public SenderAllOfFrom build() {
            return new SenderAllOfFrom(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SenderAllOfFrom.class.getSimpleName() + "(", ")");
