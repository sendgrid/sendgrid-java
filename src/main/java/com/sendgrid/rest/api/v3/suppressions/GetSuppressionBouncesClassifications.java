...
public class GetSuppressionBouncesClassifications extends ApiKeyBase {
    ...
    public ApiResponse<GetSuppressionBouncesClassifications200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetSuppressionBouncesClassifications creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                GetSuppressionBouncesClassifications200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addPathParams(Request request) {
        if (classification != null) {
            request.addPathParam("classification", classification.toString());
        }
    }

    private void addHeaderParams(Request request) {
        if (accept != null) {
            request.addHeaderParam("Accept", accept.toString());
        }
        if (onBehalfOf != null) {
