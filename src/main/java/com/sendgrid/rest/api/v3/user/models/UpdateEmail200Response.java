...
@ToString
public class UpdateEmail200Response {
    ...
    public UpdateEmail200Response() {}

    private UpdateEmail200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateEmail200Response build() {
            return new UpdateEmail200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateEmail200Response.class.getSimpleName() + "(",
            ")"
        );
