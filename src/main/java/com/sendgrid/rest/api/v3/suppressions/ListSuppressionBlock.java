...
import com.sendgrid.rest.api.v3.suppressions.models.BlocksResponseInner;
...
public class ListSuppressionBlock extends ApiKeyBase {
    ...
    public ApiResponse<List<BlocksResponseInner>> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListSuppressionBlock creation failed: Unable to connect to server"
            );
        } else if (
