...
import com.sendgrid.rest.api.v3.mccontacts.models.PutMarketingContacts202Response;
import com.sendgrid.rest.api.v3.mccontacts.models.PutMarketingContactsRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PutMarketingContact {
    private final PutMarketingContactsRequest putMarketingContactsRequest;


    public PutMarketingContacts202Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PutMarketingContact creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PutMarketingContacts202Response.class);
    }


    private void body(final Request.Builder builder) {
        if (putMarketingContactsRequest != null) {
            builder.body(JsonUtil.toJson(putMarketingContactsRequest));
        }
    }
