...
@ToString
public class GetMarketingSegments500Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetMarketingSegments500ResponseErrorsInner> errors;

    public GetMarketingSegments500Response() {
    }

    private GetMarketingSegments500Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<GetMarketingSegments500ResponseErrorsInner> errors) {
            this.errors = errors;
        }

        public GetMarketingSegments500Response build() {
            return new GetMarketingSegments500Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingSegments500Response.class.getSimpleName() + "(", ")");
