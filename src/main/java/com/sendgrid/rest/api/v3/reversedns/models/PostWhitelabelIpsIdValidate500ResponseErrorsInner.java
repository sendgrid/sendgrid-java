...
@ToString
public class PostWhitelabelIpsIdValidate500ResponseErrorsInner {
    ...
    public PostWhitelabelIpsIdValidate500ResponseErrorsInner() {
    }

    private PostWhitelabelIpsIdValidate500ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostWhitelabelIpsIdValidate500ResponseErrorsInner build() {
            return new PostWhitelabelIpsIdValidate500ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelIpsIdValidate500ResponseErrorsInner.class.getSimpleName() + "(", ")");
