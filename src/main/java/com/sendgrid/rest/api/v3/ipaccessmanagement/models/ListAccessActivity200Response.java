...
import com.sendgrid.rest.api.v3.ipaccessmanagement.models.ListAccessActivity200ResponseResultInner;
...
@ToString
public class ListAccessActivity200Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private List<ListAccessActivity200ResponseResultInner> result;

    public ListAccessActivity200Response() {}

    private ListAccessActivity200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<ListAccessActivity200ResponseResultInner> result) {
            this.result = result;
        }

        public ListAccessActivity200Response build() {
            return new ListAccessActivity200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListAccessActivity200Response.class.getSimpleName() + "(",
            ")"
        );
