...
import com.sendgrid.rest.api.v3.trackingsettings.models.ListTrackingSetting200Response;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class ListTrackingSetting extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    public ApiResponse<ListTrackingSetting200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListTrackingSetting creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListTrackingSetting200Response.class
            ),
            response.getHeaders()
        );
    }
