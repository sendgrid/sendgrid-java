...
public class RecipientsDataErasureEraseRecipientsRequest {
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", RecipientsDataErasureEraseRecipientsRequest.class.getSimpleName() + "(", ")");
        if (emailAddresses != null) joiner.add("emailAddresses=" + emailAddresses);
