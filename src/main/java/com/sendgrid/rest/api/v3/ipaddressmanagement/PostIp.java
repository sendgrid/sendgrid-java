...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.PostSendIpsIps201Response;
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.PostSendIpsIpsRequest;
...
public class PostIp {
    private final PostSendIpsIpsRequest postSendIpsIpsRequest;


    public PostSendIpsIps201Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostIp creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PostSendIpsIps201Response.class);
    }


    private void body(final Request.Builder builder) {
        if (postSendIpsIpsRequest != null) {
            builder.body(JsonUtil.toJson(postSendIpsIpsRequest));
        }
    }
