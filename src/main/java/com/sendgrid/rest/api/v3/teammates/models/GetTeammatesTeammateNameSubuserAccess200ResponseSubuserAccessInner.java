...
@ToString
public class GetTeammatesTeammateNameSubuserAccess200ResponseSubuserAccessInner {
    ...
    public GetTeammatesTeammateNameSubuserAccess200ResponseSubuserAccessInner() {
    }

    private GetTeammatesTeammateNameSubuserAccess200ResponseSubuserAccessInner(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public GetTeammatesTeammateNameSubuserAccess200ResponseSubuserAccessInner build() {
            return new GetTeammatesTeammateNameSubuserAccess200ResponseSubuserAccessInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetTeammatesTeammateNameSubuserAccess200ResponseSubuserAccessInner.class.getSimpleName() + "(", ")");
