...
public class ListSsoIntegration extends ApiKeyBase {

    @Setter
    private Boolean si;

    public ApiResponse<List<SsoIntegration>> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListSsoIntegration creation failed: Unable to connect to server"
            );
        } else if (
