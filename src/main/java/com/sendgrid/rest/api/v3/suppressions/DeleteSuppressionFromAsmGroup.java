...
public class DeleteSuppressionFromAsmGroup extends ApiKeyBase {
    ...
    public ApiResponse<Object> send(final ApiKeyRestClient client) {
        String path = "/v3/asm/groups/{group_id}/suppressions/{email}";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DeleteSuppressionFromAsmGroup creation failed: Unable to connect to server"
            );
        } else if (
