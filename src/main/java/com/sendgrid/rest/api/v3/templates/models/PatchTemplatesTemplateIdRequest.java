...
@ToString
public class PatchTemplatesTemplateIdRequest {
    ...
    public PatchTemplatesTemplateIdRequest() {
    }

    private PatchTemplatesTemplateIdRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchTemplatesTemplateIdRequest build() {
            return new PatchTemplatesTemplateIdRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchTemplatesTemplateIdRequest.class.getSimpleName() + "(", ")");
