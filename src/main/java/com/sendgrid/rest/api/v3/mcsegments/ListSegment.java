...
import com.sendgrid.rest.api.v3.mcsegments.models.ListSegment200Response;
...
public class ListSegment extends ApiKeyBase {
    ...
    public ApiResponse<ListSegment200Response> send(
        final ApiKeyRestClient client
    ) {
        String path = "/v3/marketing/segments";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListSegment creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addQueryParams(Request request) {
        ...
        if (parentListIds != null) {
            request.addQueryParam("parent_list_ids", parentListIds.toString());
        }
        if (noParentListId != null) {
            request.addQueryParam(
                "no_parent_list_id",
                noParentListId.toString()
            );
        }
    }
}
