...
import com.sendgrid.rest.api.v3.ipwarmup.models.GetWarmUpIp404ResponseErrorsInner;
...
@ToString
public class GetWarmUpIp404Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetWarmUpIp404ResponseErrorsInner> errors;

    public GetWarmUpIp404Response() {}

    private GetWarmUpIp404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<GetWarmUpIp404ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public GetWarmUpIp404Response build() {
            return new GetWarmUpIp404Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetWarmUpIp404Response.class.getSimpleName() + "(",
            ")"
        );
