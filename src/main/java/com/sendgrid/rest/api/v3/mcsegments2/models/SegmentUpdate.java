...
public class SegmentUpdate {
    ...
    private SegmentUpdate(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder queryDsl(String queryDsl) {
            this.queryDsl = queryDsl;
            return this;
        }

        public SegmentUpdate build() {
            return new SegmentUpdate(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SegmentUpdate.class.getSimpleName() + "(", ")");
