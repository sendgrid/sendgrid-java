...
@ToString
public class UpdateOpenTrackingSettingRequest {
    ...
    public UpdateOpenTrackingSettingRequest() {}

    private UpdateOpenTrackingSettingRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateOpenTrackingSettingRequest build() {
            return new UpdateOpenTrackingSettingRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateOpenTrackingSettingRequest.class.getSimpleName() + "(",
            ")"
        );
