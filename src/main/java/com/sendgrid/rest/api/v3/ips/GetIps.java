...
import com.sendgrid.rest.api.v3.ips.models.GetIps200ResponseInner;
...
public class GetIps {
    ...
    public List<GetIps200ResponseInner> send(final TokenRestClient client) {
        String path = "/v3/ips";
        ...
        return JsonUtil.fromJson(response.getStream(), List & lt; GetIps200ResponseInner & gt;.class);
    }
