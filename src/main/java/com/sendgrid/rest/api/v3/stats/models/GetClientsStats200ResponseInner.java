...
@ToString
public class GetClientsStats200ResponseInner {
    ...
    @Getter
    @Setter
    private List<GetClientsStats200ResponseInnerStatsInner> stats;

    public GetClientsStats200ResponseInner() {
    }

    private GetClientsStats200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder stats(List<GetClientsStats200ResponseInnerStatsInner> stats) {
            this.stats = stats;
            return this;
        }

        public GetClientsStats200ResponseInner build() {
            return new GetClientsStats200ResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetClientsStats200ResponseInner.class.getSimpleName() + "(", ")");
