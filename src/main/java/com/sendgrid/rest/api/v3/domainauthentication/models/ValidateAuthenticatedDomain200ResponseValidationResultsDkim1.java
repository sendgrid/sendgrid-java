...
@ToString
public class ValidateAuthenticatedDomain200ResponseValidationResultsDkim1 {
    ...
    public ValidateAuthenticatedDomain200ResponseValidationResultsDkim1() {}
    ...
    public static class Builder {
        ...
        public ValidateAuthenticatedDomain200ResponseValidationResultsDkim1 build() {
            return new ValidateAuthenticatedDomain200ResponseValidationResultsDkim1(
                this
            );
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ValidateAuthenticatedDomain200ResponseValidationResultsDkim1.class.getSimpleName() +
            "(",
            ")"
        );
