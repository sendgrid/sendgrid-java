...
import com.sendgrid.rest.api.v3.mcsinglesends.models.PutMarketingSinglesendsIdSchedule201Response;
import com.sendgrid.rest.api.v3.mcsinglesends.models.PutMarketingSinglesendsIdScheduleRequest;
...
public class PutSchedule {
    ...
    private final PutMarketingSinglesendsIdScheduleRequest putMarketingSinglesendsIdScheduleRequest;


    public PutMarketingSinglesendsIdSchedule201Response send(final TokenRestClient client) {
        String path = "/v3/marketing/singlesends/{id}/schedule";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PutSchedule creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PutMarketingSinglesendsIdSchedule201Response.class);
    }


    private void body(final Request.Builder builder) {
        if (putMarketingSinglesendsIdScheduleRequest != null) {
            builder.body(JsonUtil.toJson(putMarketingSinglesendsIdScheduleRequest));
        }
    }
