...
public enum AggregatedBy1 {
    ...
    private AggregatedBy1(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static AggregatedBy1 forValue(final String value) {
        return Promoter.enumFromString(value, AggregatedBy1.values());
    }
}
