...
@ToString
public class GetTeammatesPending200ResponseResultInner {
    ...
    public GetTeammatesPending200ResponseResultInner() {
    }

    private GetTeammatesPending200ResponseResultInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetTeammatesPending200ResponseResultInner build() {
            return new GetTeammatesPending200ResponseResultInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetTeammatesPending200ResponseResultInner.class.getSimpleName() + "(", ")");
