...
@ToString
public class GetVerifiedSendersDomains200Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("results")
    @Getter
    @Setter
    private GetVerifiedSendersDomains200ResponseResults results;

    public GetVerifiedSendersDomains200Response() {
    }

    private GetVerifiedSendersDomains200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(GetVerifiedSendersDomains200ResponseResults results) {
            this.results = results;
        }

        public GetVerifiedSendersDomains200Response build() {
            return new GetVerifiedSendersDomains200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetVerifiedSendersDomains200Response.class.getSimpleName() + "(", ")");
