...
public class GetValidationsEmailJobs200Response {
    ...
    public static class Builder {
        ...
        public Builder result(List<GetValidationsEmailJobs200ResponseResultInner> result) {
            this.result = result;
            return this;
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetValidationsEmailJobs200Response.class.getSimpleName() + "(", ")");
