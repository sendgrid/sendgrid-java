...
public class CreateIpPoolRequest {
    ...
    public CreateIpPoolRequest() {}

    private CreateIpPoolRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public CreateIpPoolRequest build() {
            return new CreateIpPoolRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            CreateIpPoolRequest.class.getSimpleName() + "(",
            ")"
        );
