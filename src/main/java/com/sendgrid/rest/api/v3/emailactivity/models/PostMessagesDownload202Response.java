...
@ToString
public class PostMessagesDownload202Response {
    ...
    public PostMessagesDownload202Response() {
    }

    private PostMessagesDownload202Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMessagesDownload202Response build() {
            return new PostMessagesDownload202Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMessagesDownload202Response.class.getSimpleName() + "(", ")");
