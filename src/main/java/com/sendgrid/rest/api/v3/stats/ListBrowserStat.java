...
public class ListBrowserStat extends ApiKeyBase {
    ...
    public ApiResponse<List<ListBrowserStat200ResponseInner>> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListBrowserStat creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addQueryParams(Request request) {
        if (browsers != null) {
            request.addQueryParam("browsers", browsers.toString());
        }
        if (limit != null) {
