...
public class ListSsoIntegrationCertificate extends ApiKeyBase {

    private final String integrationId;

    public ApiResponse<List<SsoCertificateBody>> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListSsoIntegrationCertificate creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addPathParams(Request request) {
        if (integrationId != null) {
            request.addPathParam("integration_id", integrationId.toString());
        }
    }
}
