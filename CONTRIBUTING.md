...
``` bash
javac -classpath ../repo/com/sendgrid/5.0.0-rc.5/sendgrid-5.0.0-rc.5-jar.jar:. Example.java && java -classpath ../repo/com/sendgrid/5.0.0-rc.5/sendgrid-5.0.0-rc.5-jar.jar:. Example
```
