...
@ToString
public class SendMailRequestMailSettingsBypassUnsubscribeManagement {
    ...
    public SendMailRequestMailSettingsBypassUnsubscribeManagement() {}

    private SendMailRequestMailSettingsBypassUnsubscribeManagement(
        Builder builder
    ) {
    ...
    public static class Builder {
        ...
        public SendMailRequestMailSettingsBypassUnsubscribeManagement build() {
            return new SendMailRequestMailSettingsBypassUnsubscribeManagement(
                this
            );
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SendMailRequestMailSettingsBypassUnsubscribeManagement.class.getSimpleName() +
            "(",
            ")"
        );
