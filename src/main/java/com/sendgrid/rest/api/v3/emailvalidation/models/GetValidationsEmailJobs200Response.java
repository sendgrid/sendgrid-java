...
import com.sendgrid.rest.api.v3.emailvalidation.models.GetValidationsEmailJobs200ResponseResultInner;
...
@ToString
public class GetValidationsEmailJobs200Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private List<GetValidationsEmailJobs200ResponseResultInner> result;

    public GetValidationsEmailJobs200Response() {}

    private GetValidationsEmailJobs200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder result(
            List<GetValidationsEmailJobs200ResponseResultInner> result
        ) {
            this.result = result;
            return this;
        }

        public GetValidationsEmailJobs200Response build() {
            return new GetValidationsEmailJobs200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetValidationsEmailJobs200Response.class.getSimpleName() + "(",
            ")"
        );
