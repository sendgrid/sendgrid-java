...
public class GetIntegrations {
    ...
    public List<SsoIntegration> send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetIntegrations creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), List & lt; SsoIntegration & gt;.class);
    }
