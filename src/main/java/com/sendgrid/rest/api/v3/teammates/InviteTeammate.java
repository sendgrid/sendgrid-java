...
import com.sendgrid.rest.api.v3.teammates.models.InviteTeammate201Response;
import com.sendgrid.rest.api.v3.teammates.models.InviteTeammate400Response;
import com.sendgrid.rest.api.v3.teammates.models.InviteTeammateRequest;
...
public class InviteTeammate extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private InviteTeammateRequest inviteTeammateRequest;

    public ApiResponse<InviteTeammate201Response> send(
        final ApiKeyRestClient client
    ) {
        String path = "/v3/teammates";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "InviteTeammate creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                InviteTeammate201Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (inviteTeammateRequest != null) {
            request.addBody(JsonUtil.toJson(inviteTeammateRequest));
        }
    }
}
