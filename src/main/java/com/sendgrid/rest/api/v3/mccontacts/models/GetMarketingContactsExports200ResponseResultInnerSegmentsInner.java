...
@ToString
public class GetMarketingContactsExports200ResponseResultInnerSegmentsInner {
    ...
    public GetMarketingContactsExports200ResponseResultInnerSegmentsInner() {
    }

    private GetMarketingContactsExports200ResponseResultInnerSegmentsInner(Builder builder) {
        this.ID = builder.ID;
    ...
    public static class Builder {
        ...
        public GetMarketingContactsExports200ResponseResultInnerSegmentsInner build() {
            return new GetMarketingContactsExports200ResponseResultInnerSegmentsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingContactsExports200ResponseResultInnerSegmentsInner.class.getSimpleName() + "(", ")");
