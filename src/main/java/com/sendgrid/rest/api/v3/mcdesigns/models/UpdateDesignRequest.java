...
public class UpdateDesignRequest {
    ...
    public UpdateDesignRequest() {}

    private UpdateDesignRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateDesignRequest build() {
            return new UpdateDesignRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateDesignRequest.class.getSimpleName() + "(",
            ")"
        );
