...
import com.sendgrid.rest.api.v3.lmccampaigns.models.SendTestCampaignRequest;
...
public class SendTestCampaign extends ApiKeyBase {
    ...
    @Setter
    private SendTestCampaignRequest sendTestCampaignRequest;

    public ApiResponse<SendATestCampaignRequest> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "SendTestCampaign creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                SendATestCampaignRequest.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (sendTestCampaignRequest != null) {
            request.addBody(JsonUtil.toJson(sendTestCampaignRequest));
        }
    }
}
