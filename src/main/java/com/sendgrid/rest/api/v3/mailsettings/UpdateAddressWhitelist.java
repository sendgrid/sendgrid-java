...
public class UpdateAddressWhitelist extends ApiKeyBase {
    ...
    public ApiResponse<MailSettingsAddressWhitelabel200> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateAddressWhitelist creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                MailSettingsAddressWhitelabel200.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (updateAddressWhitelistRequest != null) {
            request.addBody(JsonUtil.toJson(updateAddressWhitelistRequest));
        }
    }
}
