...
@ToString
public class DeleteVerifiedSendersId403Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<DeleteVerifiedSendersId403ResponseErrorsInner> errors;

    public DeleteVerifiedSendersId403Response() {
    }

    private DeleteVerifiedSendersId403Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<DeleteVerifiedSendersId403ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public DeleteVerifiedSendersId403Response build() {
            return new DeleteVerifiedSendersId403Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteVerifiedSendersId403Response.class.getSimpleName() + "(", ")");
