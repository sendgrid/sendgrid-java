...
@ToString
public class PostMarketingTestSendEmailRequest {
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("versionIdOverride")
    @Getter
    @Setter
    ...
    public PostMarketingTestSendEmailRequest() {
    }

    private PostMarketingTestSendEmailRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingTestSendEmailRequest build() {
            return new PostMarketingTestSendEmailRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingTestSendEmailRequest.class.getSimpleName() + "(", ")");
        if (templateId != null) joiner.add("templateId=" + templateId);
        if (versionIdOverride != null) joiner.add("versionIdOverride=" + versionIdOverride);
