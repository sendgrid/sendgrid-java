...
@ToString
public class PutMarketingSinglesendsIdSchedule201Response {
    ...
    public PutMarketingSinglesendsIdSchedule201Response() {
    }

    private PutMarketingSinglesendsIdSchedule201Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PutMarketingSinglesendsIdSchedule201Response build() {
            return new PutMarketingSinglesendsIdSchedule201Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutMarketingSinglesendsIdSchedule201Response.class.getSimpleName() + "(", ")");
