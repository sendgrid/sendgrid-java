...
import com.sendgrid.rest.api.v3.mcsinglesends.models.Status;
...
@ToString
public class ScheduleSingleSend201Response {
    ...
    public ScheduleSingleSend201Response() {}

    private ScheduleSingleSend201Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ScheduleSingleSend201Response build() {
            return new ScheduleSingleSend201Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ScheduleSingleSend201Response.class.getSimpleName() + "(",
            ")"
        );
