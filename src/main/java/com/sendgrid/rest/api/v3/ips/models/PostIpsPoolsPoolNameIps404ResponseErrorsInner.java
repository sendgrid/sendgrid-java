...
@ToString
public class PostIpsPoolsPoolNameIps404ResponseErrorsInner {
    ...
    public PostIpsPoolsPoolNameIps404ResponseErrorsInner() {
    }

    private PostIpsPoolsPoolNameIps404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostIpsPoolsPoolNameIps404ResponseErrorsInner build() {
            return new PostIpsPoolsPoolNameIps404ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostIpsPoolsPoolNameIps404ResponseErrorsInner.class.getSimpleName() + "(", ")");
