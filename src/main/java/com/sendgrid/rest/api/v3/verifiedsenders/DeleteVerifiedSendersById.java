...
import com.sendgrid.rest.api.v3.verifiedsenders.models.DeleteVerifiedSendersId403Response;
...
public class DeleteVerifiedSendersById {
    ...
    public Object send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "DeleteVerifiedSendersById creation failed: Unable to connect to server"
            );
            ...
            if (Matcher.matches(Integer.toString(statusCode), "403")) {
                DeleteVerifiedSendersId403Response error = JsonUtil.fromJson(
                        response.getStream(),
                        DeleteVerifiedSendersId403Response.class
                );
                throw new ApiErrorResponse(statusCode, null, error, response.getHeaders());
            }
