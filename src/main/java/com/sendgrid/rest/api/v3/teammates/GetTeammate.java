...
import com.sendgrid.rest.api.v3.teammates.models.GetTeammate200Response;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class GetTeammate extends ApiKeyBase {
    ...
    public ApiResponse<GetTeammate200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetTeammate creation failed: Unable to connect to server"
            );
        } else if (
