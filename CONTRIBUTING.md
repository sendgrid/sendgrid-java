...
``` bash
javac -classpath ../repo/com/sendgrid/5.0.0-rc.24/sendgrid-5.0.0-rc.24-jar.jar:. Example.java && java -classpath ../repo/com/sendgrid/5.0.0-rc.24/sendgrid-5.0.0-rc.24-jar.jar:. Example
```
