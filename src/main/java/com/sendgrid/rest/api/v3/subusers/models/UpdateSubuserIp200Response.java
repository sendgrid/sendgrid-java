...
@ToString
public class UpdateSubuserIp200Response {
    ...
    public UpdateSubuserIp200Response() {}

    private UpdateSubuserIp200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateSubuserIp200Response build() {
            return new UpdateSubuserIp200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateSubuserIp200Response.class.getSimpleName() + "(",
            ")"
        );
