...
import com.sendgrid.rest.api.v3.mccontacts.models.ContactExport;
...
public class GetMarketingContactExportById {
    private final String id;


    public ContactExport send(final TokenRestClient client) {
        String path = "/v3/marketing/contacts/exports/{id}";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetMarketingContactExportById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ContactExport.class);
    }
