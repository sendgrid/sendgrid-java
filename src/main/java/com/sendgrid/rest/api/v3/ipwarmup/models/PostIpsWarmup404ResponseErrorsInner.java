...
@ToString
public class PostIpsWarmup404ResponseErrorsInner {
    ...
    public PostIpsWarmup404ResponseErrorsInner() {
    }

    private PostIpsWarmup404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostIpsWarmup404ResponseErrorsInner build() {
            return new PostIpsWarmup404ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostIpsWarmup404ResponseErrorsInner.class.getSimpleName() + "(", ")");
