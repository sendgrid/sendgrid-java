...
public class UpdateForwardBounce extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private MailSettingsForwardBounce mailSettingsForwardBounce;

    public ApiResponse<MailSettingsForwardBounce> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateForwardBounce creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                MailSettingsForwardBounce.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (mailSettingsForwardBounce != null) {
            request.addBody(JsonUtil.toJson(mailSettingsForwardBounce));
        }
    }
}
