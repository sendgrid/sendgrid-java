...
public enum ResetFrequency {
    ...
    private ResetFrequency(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ResetFrequency fromString(final String value) {
        return CustomDeserializer. enum (value, ResetFrequency.values());
    }
