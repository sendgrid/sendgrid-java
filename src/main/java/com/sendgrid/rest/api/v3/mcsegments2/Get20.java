...
public class Get20 {
    ...
    public AllSegments200 send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "Get20 creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), AllSegments200.class);
    }
