...
@ToString
public class PutMarketingContactsImports404Response {
    ...
    public PutMarketingContactsImports404Response() {
    }

    private PutMarketingContactsImports404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PutMarketingContactsImports404Response build() {
            return new PutMarketingContactsImports404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutMarketingContactsImports404Response.class.getSimpleName() + "(", ")");
