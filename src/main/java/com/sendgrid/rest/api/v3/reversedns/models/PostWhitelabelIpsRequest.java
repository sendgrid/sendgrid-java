...
@ToString
public class PostWhitelabelIpsRequest {
    ...
    public PostWhitelabelIpsRequest() {
    }

    private PostWhitelabelIpsRequest(Builder builder) {
        this.ip = builder.ip;
    ...
    public static class Builder {
        ...
        public PostWhitelabelIpsRequest build() {
            return new PostWhitelabelIpsRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelIpsRequest.class.getSimpleName() + "(", ")");
