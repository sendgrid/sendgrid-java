...
@ToString
public class PatchTrackingSettingsOpenRequest {
    ...
    public PatchTrackingSettingsOpenRequest() {
    }

    private PatchTrackingSettingsOpenRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchTrackingSettingsOpenRequest build() {
            return new PatchTrackingSettingsOpenRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchTrackingSettingsOpenRequest.class.getSimpleName() + "(", ")");
