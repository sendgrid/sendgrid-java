...
@ToString
public class EventWebhookRequest {
    ...
    public EventWebhookRequest() {
    }

    private EventWebhookRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public EventWebhookRequest build() {
            return new EventWebhookRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", EventWebhookRequest.class.getSimpleName() + "(", ")");
        ...
        if (oauthClientSecret != null) joiner.add("oauthClientSecret=" + oauthClientSecret);
