...
public class GetSegmentRecipient {
    private final Integer segmentId;
    private String query;
    private String onBehalfOf;


    public ListRecipientsOnASegmentResponse send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetSegmentRecipient creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ListRecipientsOnASegmentResponse.class);
    }
