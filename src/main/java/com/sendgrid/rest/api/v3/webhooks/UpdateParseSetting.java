...
public class UpdateParseSetting extends ApiKeyBase {
    ...
    public ApiResponse<ParseSetting> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateParseSetting creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addPathParams(Request request) {
        if (hostname != null) {
            request.addPathParam("hostname", hostname.toString());
        }
    }
