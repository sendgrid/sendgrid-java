...
import com.sendgrid.rest.api.v3.mccontacts.models.GetMarketingContactsExports200Response;
import com.sendgrid.rest.api.v3.mccontacts.models.GetMarketingContactsExports400Response;
...
public class GetMarketingContactExport {


    public GetMarketingContactsExports200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetMarketingContactExport creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
            if (Matcher.matches(Integer.toString(statusCode), "400")) {
                GetMarketingContactsExports400Response error = JsonUtil.fromJson(
                        response.getStream(),
                        GetMarketingContactsExports400Response.class
                );
        ...
        return JsonUtil.fromJson(response.getStream(), GetMarketingContactsExports200Response.class);
    }
