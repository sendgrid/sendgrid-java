...
@ToString
public class EmailDnsRecord400ResponseErrors {
    ...
    public EmailDnsRecord400ResponseErrors() {}

    private EmailDnsRecord400ResponseErrors(Builder builder) {
    ...
    public static class Builder {
        ...
        public EmailDnsRecord400ResponseErrors build() {
            return new EmailDnsRecord400ResponseErrors(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            EmailDnsRecord400ResponseErrors.class.getSimpleName() + "(",
            ")"
        );
