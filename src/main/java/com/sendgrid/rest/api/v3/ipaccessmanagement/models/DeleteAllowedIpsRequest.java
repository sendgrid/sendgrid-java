...
@ToString
public class DeleteAllowedIpsRequest {
    ...
    public DeleteAllowedIpsRequest() {}

    private DeleteAllowedIpsRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteAllowedIpsRequest build() {
            return new DeleteAllowedIpsRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            DeleteAllowedIpsRequest.class.getSimpleName() + "(",
            ")"
        );
