...
@ToString
public class GetIps200ResponseInner {
    ...
    public GetIps200ResponseInner() {
    }

    private GetIps200ResponseInner(Builder builder) {
        this.ip = builder.ip;
    ...
    public static class Builder {
        ...
        public Builder(String ip, List<String> subusers, List<String> pools, Boolean warmup, BigDecimal startDate, Boolean whitelabeled, Integer assignedAt) {
            this.ip = ip;
        ...
        public GetIps200ResponseInner build() {
            return new GetIps200ResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetIps200ResponseInner.class.getSimpleName() + "(", ")");
