...
@ToString
public class MailSettingsForwardSpam {
    ...
    public MailSettingsForwardSpam() {
    }

    private MailSettingsForwardSpam(Builder builder) {
    ...
    public static class Builder {
        ...
        public MailSettingsForwardSpam build() {
            return new MailSettingsForwardSpam(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", MailSettingsForwardSpam.class.getSimpleName() + "(", ")");
