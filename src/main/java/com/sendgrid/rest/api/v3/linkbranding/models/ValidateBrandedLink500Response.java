...
import com.sendgrid.rest.api.v3.linkbranding.models.ValidateBrandedLink500ResponseErrorsInner;
...
@ToString
public class ValidateBrandedLink500Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<ValidateBrandedLink500ResponseErrorsInner> errors;

    public ValidateBrandedLink500Response() {}

    private ValidateBrandedLink500Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<ValidateBrandedLink500ResponseErrorsInner> errors) {
            this.errors = errors;
        }

        public ValidateBrandedLink500Response build() {
            return new ValidateBrandedLink500Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ValidateBrandedLink500Response.class.getSimpleName() + "(",
            ")"
        );
