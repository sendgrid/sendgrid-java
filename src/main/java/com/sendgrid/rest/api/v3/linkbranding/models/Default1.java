...
public enum Default1 {
    ...
    private Default1(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static Default1 fromString(final String value) {
        return CustomDeserializer. enum (value, Default1.values());
    }
