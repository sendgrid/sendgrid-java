...
import com.sendgrid.rest.api.v3.sso.models.PatchSsoTeammates200;
import com.sendgrid.rest.api.v3.sso.models.SsoErrorResponseInner;
import com.sendgrid.rest.api.v3.sso.models.SsoTeammatesBaseRequestProps;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PatchTeammatesById {
    private final String username;
    private final SsoTeammatesBaseRequestProps body;


    public PatchSsoTeammates200 send(final TokenRestClient client) {
        String path = "/v3/sso/teammates/{username}";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchTeammatesById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PatchSsoTeammates200.class);
    }


    private void body(final Request.Builder builder) {
        if (body != null) {
            builder.body(JsonUtil.toJson(body));
        }
    }
