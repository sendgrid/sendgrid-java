...
import com.sendgrid.rest.api.v3.mccontacts.models.DeleteMarketingContacts400Response;
import com.sendgrid.rest.api.v3.mccontacts.models.DeleteMarketingContactsContactIdIdentifiers202Response;
import com.sendgrid.rest.api.v3.mccontacts.models.DeleteMarketingContactsContactIdIdentifiersRequest;
...
public class DeleteMarketingContactIdentifier {
    private final String contactId;
    private final DeleteMarketingContactsContactIdIdentifiersRequest deleteMarketingContactsContactIdIdentifiersRequest;


    public DeleteMarketingContactsContactIdIdentifiers202Response send(final TokenRestClient client) {
        ...
        Request.Builder builder = new Request.Builder(HttpMethod.DELETE, path)
                .addPathParam("contact_id", contactId.toString());
        body(builder);
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "DeleteMarketingContactIdentifier creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
            if (Matcher.matches(Integer.toString(statusCode), "400")) {
                DeleteMarketingContacts400Response error = JsonUtil.fromJson(
                        response.getStream(),
                        DeleteMarketingContacts400Response.class
                );
        ...
        return JsonUtil.fromJson(response.getStream(), DeleteMarketingContactsContactIdIdentifiers202Response.class);
    }


    private void body(final Request.Builder builder) {
        if (deleteMarketingContactsContactIdIdentifiersRequest != null) {
            builder.body(JsonUtil.toJson(deleteMarketingContactsContactIdIdentifiersRequest));
        }
    }
