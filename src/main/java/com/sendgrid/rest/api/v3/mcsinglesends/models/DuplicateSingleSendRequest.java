...
@ToString
public class DuplicateSingleSendRequest {
    ...
    public DuplicateSingleSendRequest() {}

    private DuplicateSingleSendRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public DuplicateSingleSendRequest build() {
            return new DuplicateSingleSendRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            DuplicateSingleSendRequest.class.getSimpleName() + "(",
            ")"
        );
