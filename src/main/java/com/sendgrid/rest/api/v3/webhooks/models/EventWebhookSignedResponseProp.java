...
@ToString
public class EventWebhookSignedResponseProp {
    ...
    public EventWebhookSignedResponseProp() {
    }

    private EventWebhookSignedResponseProp(Builder builder) {
    ...
    public static class Builder {
        ...
        public EventWebhookSignedResponseProp build() {
            return new EventWebhookSignedResponseProp(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", EventWebhookSignedResponseProp.class.getSimpleName() + "(", ")");
