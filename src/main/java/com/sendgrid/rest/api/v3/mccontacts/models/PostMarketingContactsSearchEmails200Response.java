...
@ToString
public class PostMarketingContactsSearchEmails200Response {
    ...
    public PostMarketingContactsSearchEmails200Response() {
    }

    private PostMarketingContactsSearchEmails200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingContactsSearchEmails200Response build() {
            return new PostMarketingContactsSearchEmails200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingContactsSearchEmails200Response.class.getSimpleName() + "(", ")");
