...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.GetSendIpsIpsIp200Response;
...
public class GetIpById {
    private String query;


    public GetSendIpsIpsIp200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetIpById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetSendIpsIpsIp200Response.class);
    }
