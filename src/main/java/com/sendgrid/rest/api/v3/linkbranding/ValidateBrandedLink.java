...
import com.sendgrid.rest.api.v3.linkbranding.models.ValidateBrandedLink200Response;
import com.sendgrid.rest.api.v3.linkbranding.models.ValidateBrandedLink500Response;
...
public class ValidateBrandedLink extends ApiKeyBase {
    ...
    public ApiResponse<ValidateBrandedLink200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ValidateBrandedLink creation failed: Unable to connect to server"
            );
        } else if (
            ...
            if (Matcher.matches(Integer.toString(statusCode), "500")) {
                ValidateBrandedLink500Response error = JsonUtil.fromJson(
                    response.getStream(),
                    ValidateBrandedLink500Response.class
                );
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ValidateBrandedLink200Response.class
            ),
            response.getHeaders()
        );
    }
