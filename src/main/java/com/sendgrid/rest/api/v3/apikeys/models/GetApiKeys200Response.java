...
@ToString
public class GetApiKeys200Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private List<ApiKeyResponse> result;

    public GetApiKeys200Response() {
    }

    private GetApiKeys200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder result(List<ApiKeyResponse> result) {
            this.result = result;
            return this;
        }

        public GetApiKeys200Response build() {
            return new GetApiKeys200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetApiKeys200Response.class.getSimpleName() + "(", ")");
