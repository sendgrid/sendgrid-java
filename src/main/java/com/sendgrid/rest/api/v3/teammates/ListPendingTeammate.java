...
import com.sendgrid.rest.api.v3.teammates.models.ListPendingTeammate200Response;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class ListPendingTeammate extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    public ApiResponse<ListPendingTeammate200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListPendingTeammate creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListPendingTeammate200Response.class
            ),
            response.getHeaders()
        );
    }
