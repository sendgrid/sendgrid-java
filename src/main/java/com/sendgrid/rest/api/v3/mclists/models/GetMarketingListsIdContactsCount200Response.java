...
@ToString
public class GetMarketingListsIdContactsCount200Response {
    ...
    public GetMarketingListsIdContactsCount200Response() {
    }

    private GetMarketingListsIdContactsCount200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMarketingListsIdContactsCount200Response build() {
            return new GetMarketingListsIdContactsCount200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingListsIdContactsCount200Response.class.getSimpleName() + "(", ")");
