...
@ToString
public class DeleteMarketingListsIdContacts202Response {
    ...
    public DeleteMarketingListsIdContacts202Response() {
    }

    private DeleteMarketingListsIdContacts202Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteMarketingListsIdContacts202Response build() {
            return new DeleteMarketingListsIdContacts202Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteMarketingListsIdContacts202Response.class.getSimpleName() + "(", ")");
