...
@ToString
public class PostMarketingContactsSearchIdentifiersIdentifierType200Response {
    ...
    public PostMarketingContactsSearchIdentifiersIdentifierType200Response() {
    }

    private PostMarketingContactsSearchIdentifiersIdentifierType200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingContactsSearchIdentifiersIdentifierType200Response build() {
            return new PostMarketingContactsSearchIdentifiersIdentifierType200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingContactsSearchIdentifiersIdentifierType200Response.class.getSimpleName() + "(", ")");
