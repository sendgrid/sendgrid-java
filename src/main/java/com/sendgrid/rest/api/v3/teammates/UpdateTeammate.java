...
import com.sendgrid.rest.api.v3.teammates.models.UpdateTeammate200Response;
import com.sendgrid.rest.api.v3.teammates.models.UpdateTeammateRequest;
...
public class UpdateTeammate extends ApiKeyBase {
    ...
    @Setter
    private UpdateTeammateRequest updateTeammateRequest;

    public ApiResponse<UpdateTeammate200Response> send(
        final ApiKeyRestClient client
    ) {
        String path = "/v3/teammates/{username}";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateTeammate creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                UpdateTeammate200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addPathParams(Request request) {
        if (username != null) {
            request.addPathParam("username", username.toString());
        }
    }
    ...
    private void addBody(final Request request) {
        if (updateTeammateRequest != null) {
            request.addBody(JsonUtil.toJson(updateTeammateRequest));
        }
    }
}
