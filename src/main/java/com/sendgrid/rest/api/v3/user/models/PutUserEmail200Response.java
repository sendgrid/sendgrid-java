...
@ToString
public class PutUserEmail200Response {
    ...
    public PutUserEmail200Response() {
    }

    private PutUserEmail200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PutUserEmail200Response build() {
            return new PutUserEmail200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutUserEmail200Response.class.getSimpleName() + "(", ")");
