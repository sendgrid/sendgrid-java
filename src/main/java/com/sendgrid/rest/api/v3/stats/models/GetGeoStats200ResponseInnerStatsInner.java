...
@ToString
public class GetGeoStats200ResponseInnerStatsInner {
    ...
    public GetGeoStats200ResponseInnerStatsInner() {
    }

    private GetGeoStats200ResponseInnerStatsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetGeoStats200ResponseInnerStatsInner build() {
            return new GetGeoStats200ResponseInnerStatsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetGeoStats200ResponseInnerStatsInner.class.getSimpleName() + "(", ")");
