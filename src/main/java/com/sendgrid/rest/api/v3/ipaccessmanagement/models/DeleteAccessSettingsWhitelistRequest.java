...
@ToString
public class DeleteAccessSettingsWhitelistRequest {
    ...
    public DeleteAccessSettingsWhitelistRequest() {
    }

    private DeleteAccessSettingsWhitelistRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteAccessSettingsWhitelistRequest build() {
            return new DeleteAccessSettingsWhitelistRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteAccessSettingsWhitelistRequest.class.getSimpleName() + "(", ")");
