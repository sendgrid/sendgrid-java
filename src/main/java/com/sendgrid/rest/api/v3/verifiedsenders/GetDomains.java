...
import com.sendgrid.rest.api.v3.verifiedsenders.models.GetVerifiedSendersDomains200Response;
...
public class GetDomains {
    ...
    public GetVerifiedSendersDomains200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetDomains creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetVerifiedSendersDomains200Response.class);
    }
