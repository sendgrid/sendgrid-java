...
import com.sendgrid.rest.api.v3.mcsegments.models.SegmentSummary;
...
@ToString
public class ListSegment200Response {
    ...
    public ListSegment200Response() {}

    private ListSegment200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListSegment200Response build() {
            return new ListSegment200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListSegment200Response.class.getSimpleName() + "(",
            ")"
        );
