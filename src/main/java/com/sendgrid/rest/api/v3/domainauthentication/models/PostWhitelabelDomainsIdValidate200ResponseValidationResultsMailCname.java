...
@ToString
public class PostWhitelabelDomainsIdValidate200ResponseValidationResultsMailCname {
    ...
    public PostWhitelabelDomainsIdValidate200ResponseValidationResultsMailCname() {
    }

    private PostWhitelabelDomainsIdValidate200ResponseValidationResultsMailCname(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostWhitelabelDomainsIdValidate200ResponseValidationResultsMailCname build() {
            return new PostWhitelabelDomainsIdValidate200ResponseValidationResultsMailCname(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelDomainsIdValidate200ResponseValidationResultsMailCname.class.getSimpleName() + "(", ")");
