...
@ToString
public class GetMarketingContactsExports200ResponseResultInnerMetadata {
    ...
    public GetMarketingContactsExports200ResponseResultInnerMetadata() {
    }

    private GetMarketingContactsExports200ResponseResultInnerMetadata(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMarketingContactsExports200ResponseResultInnerMetadata build() {
            return new GetMarketingContactsExports200ResponseResultInnerMetadata(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingContactsExports200ResponseResultInnerMetadata.class.getSimpleName() + "(", ")");
