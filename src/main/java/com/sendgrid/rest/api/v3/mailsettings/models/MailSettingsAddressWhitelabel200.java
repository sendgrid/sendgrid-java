...
@ToString
public class MailSettingsAddressWhitelabel200 {
    ...
    public MailSettingsAddressWhitelabel200() {
    }

    private MailSettingsAddressWhitelabel200(Builder builder) {
    ...
    public static class Builder {
        ...
        public MailSettingsAddressWhitelabel200 build() {
            return new MailSettingsAddressWhitelabel200(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", MailSettingsAddressWhitelabel200.class.getSimpleName() + "(", ")");
