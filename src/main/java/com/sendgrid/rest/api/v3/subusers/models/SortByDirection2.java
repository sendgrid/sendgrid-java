...
public enum SortByDirection2 {
    ...
    private SortByDirection2(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static SortByDirection2 forValue(final String value) {
        return Promoter.enumFromString(value, SortByDirection2.values());
    }
}
