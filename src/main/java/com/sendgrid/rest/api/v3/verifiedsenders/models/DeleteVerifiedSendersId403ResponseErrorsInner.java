...
@ToString
public class DeleteVerifiedSendersId403ResponseErrorsInner {
    ...
    public DeleteVerifiedSendersId403ResponseErrorsInner() {
    }

    private DeleteVerifiedSendersId403ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteVerifiedSendersId403ResponseErrorsInner build() {
            return new DeleteVerifiedSendersId403ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteVerifiedSendersId403ResponseErrorsInner.class.getSimpleName() + "(", ")");
