...
import com.sendgrid.rest.api.v3.reversedns.models.ValidateReverseDns500ResponseErrorsInner;
...
@ToString
public class ValidateReverseDns500Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<ValidateReverseDns500ResponseErrorsInner> errors;

    public ValidateReverseDns500Response() {}

    private ValidateReverseDns500Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<ValidateReverseDns500ResponseErrorsInner> errors) {
            this.errors = errors;
        }

        public ValidateReverseDns500Response build() {
            return new ValidateReverseDns500Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ValidateReverseDns500Response.class.getSimpleName() + "(",
            ")"
        );
