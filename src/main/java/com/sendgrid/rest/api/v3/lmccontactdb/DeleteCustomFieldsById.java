...
public class DeleteCustomFieldsById {
    private final Integer customFieldId;
    private String onBehalfOf;


    public ErrorResponse send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "DeleteCustomFieldsById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ErrorResponse.class);
    }
