...
@ToString
public class GetMarketingContactsExports200ResponseResultInner {
    ...
    @Getter
    @Setter
    private List<GetMarketingContactsExports200ResponseResultInnerSegmentsInner> segments;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("lists")
    @Getter
    @Setter
    private List<GetMarketingContactsExports200ResponseResultInnerSegmentsInner> lists;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("metadata")
    @Getter
    @Setter
    private GetMarketingContactsExports200ResponseResultInnerMetadata metadata;

    public GetMarketingContactsExports200ResponseResultInner() {
    }

    private GetMarketingContactsExports200ResponseResultInner(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public Builder segments(List<GetMarketingContactsExports200ResponseResultInnerSegmentsInner> segments) {
            this.segments = segments;
            return this;
        }

        public Builder lists(List<GetMarketingContactsExports200ResponseResultInnerSegmentsInner> lists) {
            this.lists = lists;
            return this;
        }

        public Builder metadata(GetMarketingContactsExports200ResponseResultInnerMetadata metadata) {
            this.metadata = metadata;
            return this;
        }

        public GetMarketingContactsExports200ResponseResultInner build() {
            return new GetMarketingContactsExports200ResponseResultInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingContactsExports200ResponseResultInner.class.getSimpleName() + "(", ")");
