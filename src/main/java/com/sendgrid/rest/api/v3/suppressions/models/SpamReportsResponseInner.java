...
@ToString
public class SpamReportsResponseInner {
    ...
    public SpamReportsResponseInner() {
    }

    private SpamReportsResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(Integer created, String email, String ip) {
            this.created = created;
            this.email = email;
            this.ip = ip;
        }

        public SpamReportsResponseInner build() {
            return new SpamReportsResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SpamReportsResponseInner.class.getSimpleName() + "(", ")");
