...
import com.sendgrid.rest.api.v3.suppressions.models.DeleteSuppressionBouncesRequest;
...
public class DeleteSuppressionBounces extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private DeleteSuppressionBouncesRequest deleteSuppressionBouncesRequest;
    ...
    public ApiResponse<Object> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DeleteSuppressionBounces creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (deleteSuppressionBouncesRequest != null) {
            request.addBody(JsonUtil.toJson(deleteSuppressionBouncesRequest));
        }
    }
}
