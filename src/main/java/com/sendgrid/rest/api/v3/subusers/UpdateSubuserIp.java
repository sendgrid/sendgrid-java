...
public class UpdateSubuserIp extends ApiKeyBase {
    ...
    public ApiResponse<UpdateSubuserIp200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateSubuserIp creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                UpdateSubuserIp200Response.class
            ),
            response.getHeaders()
        );
    }
