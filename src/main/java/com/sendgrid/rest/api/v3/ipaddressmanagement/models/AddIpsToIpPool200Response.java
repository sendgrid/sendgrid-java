...
@ToString
public class AddIpsToIpPool200Response {
    ...
    public AddIpsToIpPool200Response() {}

    private AddIpsToIpPool200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public AddIpsToIpPool200Response build() {
            return new AddIpsToIpPool200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            AddIpsToIpPool200Response.class.getSimpleName() + "(",
            ")"
        );
