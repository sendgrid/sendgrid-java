...
public class GetJobs {
    ...
    public GetValidationsEmailJobs200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetJobs creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetValidationsEmailJobs200Response.class);
    }
