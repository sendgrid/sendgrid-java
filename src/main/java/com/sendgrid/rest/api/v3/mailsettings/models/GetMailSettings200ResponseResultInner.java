...
@ToString
public class GetMailSettings200ResponseResultInner {
    ...
    public GetMailSettings200ResponseResultInner() {
    }

    private GetMailSettings200ResponseResultInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMailSettings200ResponseResultInner build() {
            return new GetMailSettings200ResponseResultInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMailSettings200ResponseResultInner.class.getSimpleName() + "(", ")");
