...
@ToString
public class PostAlerts201Response {
    ...
    public PostAlerts201Response() {
    }

    private PostAlerts201Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(Integer createdAt, String emailTo, Integer id, String type, Integer updatedAt) {
        ...
        public PostAlerts201Response build() {
            return new PostAlerts201Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostAlerts201Response.class.getSimpleName() + "(", ")");
