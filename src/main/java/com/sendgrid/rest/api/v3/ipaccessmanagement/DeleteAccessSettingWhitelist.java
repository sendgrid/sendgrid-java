...
import com.sendgrid.rest.api.v3.ipaccessmanagement.models.DeleteAccessSettingsWhitelistRequest;
...
public class DeleteAccessSettingWhitelist {
    private String onBehalfOf;
    private final DeleteAccessSettingsWhitelistRequest deleteAccessSettingsWhitelistRequest;
    ...
    public Object send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "DeleteAccessSettingWhitelist creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (deleteAccessSettingsWhitelistRequest != null) {
            builder.body(JsonUtil.toJson(deleteAccessSettingsWhitelistRequest));
        }
    }
