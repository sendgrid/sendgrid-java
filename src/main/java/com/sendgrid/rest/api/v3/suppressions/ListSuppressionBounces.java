...
public class ListSuppressionBounces extends ApiKeyBase {
    ...
    public ApiResponse<List<BounceResponse>> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListSuppressionBounces creation failed: Unable to connect to server"
            );
        } else if (
