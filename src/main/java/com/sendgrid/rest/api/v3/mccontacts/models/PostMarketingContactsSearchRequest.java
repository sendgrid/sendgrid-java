...
@ToString
public class PostMarketingContactsSearchRequest {
    ...
    public PostMarketingContactsSearchRequest() {
    }

    private PostMarketingContactsSearchRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingContactsSearchRequest build() {
            return new PostMarketingContactsSearchRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingContactsSearchRequest.class.getSimpleName() + "(", ")");
        if (query != null) joiner.add("query=" + query);
