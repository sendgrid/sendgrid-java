...
import com.sendgrid.rest.api.v3.suppressions.models.DeleteSpamReportsRequest;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class DeleteSpamReports extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private DeleteSpamReportsRequest deleteSpamReportsRequest;
    ...
    public ApiResponse<Object> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DeleteSpamReports creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (deleteSpamReportsRequest != null) {
            request.addBody(JsonUtil.toJson(deleteSpamReportsRequest));
        }
    }
}
