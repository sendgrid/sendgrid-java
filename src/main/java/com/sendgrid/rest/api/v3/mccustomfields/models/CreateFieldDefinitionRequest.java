...
import com.sendgrid.rest.api.v3.mccustomfields.models.FieldType;
...
public class CreateFieldDefinitionRequest {
    ...
    private CreateFieldDefinitionRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public CreateFieldDefinitionRequest build() {
            return new CreateFieldDefinitionRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            CreateFieldDefinitionRequest.class.getSimpleName() + "(",
            ")"
        );
