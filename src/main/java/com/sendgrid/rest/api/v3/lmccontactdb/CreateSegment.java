...
public class CreateSegment extends ApiKeyBase {
    ...
    @Setter
    private ContactdbSegments contactdbSegments;

    public ApiResponse<ContactdbSegmentsId200> send(
    ...
    private void addBody(final Request request) {
        if (contactdbSegments != null) {
            request.addBody(JsonUtil.toJson(contactdbSegments));
        }
    }
}
