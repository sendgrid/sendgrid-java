...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.AddIpsToIpPool200Response;
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.AddIpsToIpPoolRequest;
...
public class AddIpsToIpPool extends ApiKeyBase {

    private final String poolid;

    @Setter
    private AddIpsToIpPoolRequest addIpsToIpPoolRequest;

    public ApiResponse<AddIpsToIpPool200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "AddIpsToIpPool creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                AddIpsToIpPool200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (addIpsToIpPoolRequest != null) {
            request.addBody(JsonUtil.toJson(addIpsToIpPoolRequest));
        }
    }
}
