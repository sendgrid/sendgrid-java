...
@ToString
public class PostAccessSettingsWhitelistRequest {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("ips")
    @Getter
    @Setter
    private List<PostAccessSettingsWhitelistRequestIpsInner> ips;

    public PostAccessSettingsWhitelistRequest() {
    }

    private PostAccessSettingsWhitelistRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<PostAccessSettingsWhitelistRequestIpsInner> ips) {
            this.ips = ips;
        }

        public PostAccessSettingsWhitelistRequest build() {
            return new PostAccessSettingsWhitelistRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostAccessSettingsWhitelistRequest.class.getSimpleName() + "(", ")");
