...
@ToString
public class PostMarketingContactsSearch500Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<PostMarketingContactsSearch500ResponseErrorsInner> errors;

    public PostMarketingContactsSearch500Response() {
    }

    private PostMarketingContactsSearch500Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<PostMarketingContactsSearch500ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public PostMarketingContactsSearch500Response build() {
            return new PostMarketingContactsSearch500Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingContactsSearch500Response.class.getSimpleName() + "(", ")");
