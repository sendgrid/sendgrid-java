...
public class PatchSubscriptionTrackingSetting {
    private String onBehalfOf;
    private final SubscriptionTrackingSettings subscriptionTrackingSettings;
    ...
    public SubscriptionTrackingSettings send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchSubscriptionTrackingSetting creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (subscriptionTrackingSettings != null) {
            builder.body(JsonUtil.toJson(subscriptionTrackingSettings));
        }
    }
