...
import com.sendgrid.rest.api.v3.ipaccessmanagement.models.AddIpToAllowListRequestIpsInner;
...
@ToString
public class AddIpToAllowListRequest {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("ips")
    @Getter
    @Setter
    private List<AddIpToAllowListRequestIpsInner> ips;

    public AddIpToAllowListRequest() {}

    private AddIpToAllowListRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<AddIpToAllowListRequestIpsInner> ips) {
            this.ips = ips;
        }

        public AddIpToAllowListRequest build() {
            return new AddIpToAllowListRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            AddIpToAllowListRequest.class.getSimpleName() + "(",
            ")"
        );
