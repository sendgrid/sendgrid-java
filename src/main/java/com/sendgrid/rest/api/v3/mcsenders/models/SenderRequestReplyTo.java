...
@ToString
public class SenderRequestReplyTo {
    ...
    public SenderRequestReplyTo() {
    }

    private SenderRequestReplyTo(Builder builder) {
    ...
    public static class Builder {
        ...
        public SenderRequestReplyTo build() {
            return new SenderRequestReplyTo(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SenderRequestReplyTo.class.getSimpleName() + "(", ")");
