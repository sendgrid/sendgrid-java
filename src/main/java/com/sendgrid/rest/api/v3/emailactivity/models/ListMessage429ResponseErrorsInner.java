...
@ToString
public class ListMessage429ResponseErrorsInner {
    ...
    public ListMessage429ResponseErrorsInner() {}

    private ListMessage429ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListMessage429ResponseErrorsInner build() {
            return new ListMessage429ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListMessage429ResponseErrorsInner.class.getSimpleName() + "(",
            ")"
        );
