...
public class DeleteSuppressionBlock {
    private String onBehalfOf;
    private final DeleteSuppressionBlocksRequest deleteSuppressionBlocksRequest;
    ...
    private void body(final Request.Builder builder) {
        if (deleteSuppressionBlocksRequest != null) {
            builder.body(JsonUtil.toJson(deleteSuppressionBlocksRequest));
        }
    }
