...
@ToString
public class AuthenticatedDomainDnsMailCname {
    ...
    public AuthenticatedDomainDnsMailCname() {
    }

    private AuthenticatedDomainDnsMailCname(Builder builder) {
    ...
    public static class Builder {
        ...
        public AuthenticatedDomainDnsMailCname build() {
            return new AuthenticatedDomainDnsMailCname(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", AuthenticatedDomainDnsMailCname.class.getSimpleName() + "(", ")");
