...
public class ContactImportResults {
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("erroredCount")
    @Getter
    @Setter
    private BigDecimal erroredCount;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errorsUrl")
    @Getter
    @Setter
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", ContactImportResults.class.getSimpleName() + "(", ")");
        if (requestedCount != null) joiner.add("requestedCount=" + requestedCount);
