...
@ToString
public class PostWhitelabelIpsIdValidate404Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<PostWhitelabelIpsIdValidate404ResponseErrorsInner> errors;

    public PostWhitelabelIpsIdValidate404Response() {
    }

    private PostWhitelabelIpsIdValidate404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<PostWhitelabelIpsIdValidate404ResponseErrorsInner> errors) {
            this.errors = errors;
        }

        public PostWhitelabelIpsIdValidate404Response build() {
            return new PostWhitelabelIpsIdValidate404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelIpsIdValidate404Response.class.getSimpleName() + "(", ")");
