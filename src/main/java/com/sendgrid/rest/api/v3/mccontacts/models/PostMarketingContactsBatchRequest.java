...
@ToString
public class PostMarketingContactsBatchRequest {
    ...
    public PostMarketingContactsBatchRequest() {
    }

    private PostMarketingContactsBatchRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostMarketingContactsBatchRequest build() {
            return new PostMarketingContactsBatchRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMarketingContactsBatchRequest.class.getSimpleName() + "(", ")");
