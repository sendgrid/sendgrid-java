...
import com.sendgrid.rest.api.v3.emailvalidation.models.FileType;
...
@ToString
public class ListEmailJobForVerificationRequest {
    ...
    public ListEmailJobForVerificationRequest() {}

    private ListEmailJobForVerificationRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListEmailJobForVerificationRequest build() {
            return new ListEmailJobForVerificationRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListEmailJobForVerificationRequest.class.getSimpleName() + "(",
            ")"
        );
