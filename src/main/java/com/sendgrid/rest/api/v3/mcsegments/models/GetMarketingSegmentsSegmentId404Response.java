...
@ToString
public class GetMarketingSegmentsSegmentId404Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetMarketingSegmentsSegmentId404ResponseErrorsInner> errors;

    public GetMarketingSegmentsSegmentId404Response() {
    }

    private GetMarketingSegmentsSegmentId404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<GetMarketingSegmentsSegmentId404ResponseErrorsInner> errors) {
            this.errors = errors;
        }

        public GetMarketingSegmentsSegmentId404Response build() {
            return new GetMarketingSegmentsSegmentId404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingSegmentsSegmentId404Response.class.getSimpleName() + "(", ")");
