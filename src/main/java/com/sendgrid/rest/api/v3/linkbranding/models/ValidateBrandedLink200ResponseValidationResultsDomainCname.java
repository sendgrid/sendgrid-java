...
import com.sendgrid.rest.api.v3.linkbranding.models.Valid1;
...
@ToString
public class ValidateBrandedLink200ResponseValidationResultsDomainCname {
    ...
    public ValidateBrandedLink200ResponseValidationResultsDomainCname() {}

    private ValidateBrandedLink200ResponseValidationResultsDomainCname(
        Builder builder
    ) {
    ...
    public static class Builder {
        ...
        public ValidateBrandedLink200ResponseValidationResultsDomainCname build() {
            return new ValidateBrandedLink200ResponseValidationResultsDomainCname(
                this
            );
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ValidateBrandedLink200ResponseValidationResultsDomainCname.class.getSimpleName() +
            "(",
            ")"
        );
