...
@ToString
public class GetSendIpsIpsIpSubusers200Response {
    ...
    @Getter
    @Setter
    private GetSendIpsIpsIpSubusers200ResponseMetadata metadata;

    public GetSendIpsIpsIpSubusers200Response() {
    }

    private GetSendIpsIpsIpSubusers200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder metadata(GetSendIpsIpsIpSubusers200ResponseMetadata metadata) {
            this.metadata = metadata;
            return this;
        }

        public GetSendIpsIpsIpSubusers200Response build() {
            return new GetSendIpsIpsIpSubusers200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetSendIpsIpsIpSubusers200Response.class.getSimpleName() + "(", ")");
