...
@ToString
public class GetContactByIdentifiers200ResponseResultValue {
    ...
    public GetContactByIdentifiers200ResponseResultValue() {}

    private GetContactByIdentifiers200ResponseResultValue(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetContactByIdentifiers200ResponseResultValue build() {
            return new GetContactByIdentifiers200ResponseResultValue(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetContactByIdentifiers200ResponseResultValue.class.getSimpleName() +
            "(",
            ")"
        );
