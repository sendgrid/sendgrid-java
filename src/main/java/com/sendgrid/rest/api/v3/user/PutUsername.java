...
import com.sendgrid.rest.api.v3.user.models.PputUserUsername200Response;
import com.sendgrid.rest.api.v3.user.models.PputUserUsernameRequest;
...
public class PutUsername {
    ...
    private final PputUserUsernameRequest pputUserUsernameRequest;


    public PputUserUsername200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PutUsername creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), PputUserUsername200Response.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (pputUserUsernameRequest != null) {
            builder.body(JsonUtil.toJson(pputUserUsernameRequest));
        }
    }
