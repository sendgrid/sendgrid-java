...
public class SearchSingleSend extends ApiKeyBase {
    ...
    public ApiResponse<ListSingleSend200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "SearchSingleSend creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListSingleSend200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (singlesendSearch != null) {
            request.addBody(JsonUtil.toJson(singlesendSearch));
        }
    }
}
