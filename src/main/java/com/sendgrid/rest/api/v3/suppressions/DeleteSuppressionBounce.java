...
public class DeleteSuppressionBounce {
    private String onBehalfOf;
    private final DeleteSuppressionBouncesRequest deleteSuppressionBouncesRequest;
    ...
    public Object send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "DeleteSuppressionBounce creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (deleteSuppressionBouncesRequest != null) {
            builder.body(JsonUtil.toJson(deleteSuppressionBouncesRequest));
        }
    }
