...
public class GetIpPool extends ApiKeyBase {

    private final String poolName;

    public ApiResponse<GetIpPool200Response> send(
        ...
        if (response == null) {
            ...
            if (Matcher.matches(Integer.toString(statusCode), "404")) {
                GetIpPool404Response error = JsonUtil.fromJson(
                    response.getStream(),
                    GetIpPool404Response.class
                );
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), GetIpPool200Response.class),
            response.getHeaders()
        );
    }
