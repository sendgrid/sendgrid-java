...
import com.sendgrid.rest.api.v3.mailsettings.models.GetMailSettings200Response;
...
public class GetMailSettings {
    ...
    public GetMailSettings200Response send(final TokenRestClient client) {
        String path = "/v3/mail_settings";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetMailSettings creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), GetMailSettings200Response.class);
    }
