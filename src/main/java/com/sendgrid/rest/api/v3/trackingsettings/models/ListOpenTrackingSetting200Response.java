...
@ToString
public class ListOpenTrackingSetting200Response {
    ...
    public ListOpenTrackingSetting200Response() {}

    private ListOpenTrackingSetting200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListOpenTrackingSetting200Response build() {
            return new ListOpenTrackingSetting200Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListOpenTrackingSetting200Response.class.getSimpleName() + "(",
            ")"
        );
