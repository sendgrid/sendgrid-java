...
public class ContactdbRecipient200 {
    ...
    public static class Builder {
        ...
        public Builder recipients(List<ContactdbRecipient200RecipientsInner> recipients) {
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", ContactdbRecipient200.class.getSimpleName() + "(", ")");
