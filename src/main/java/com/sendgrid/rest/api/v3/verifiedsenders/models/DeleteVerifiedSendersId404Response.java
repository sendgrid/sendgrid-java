...
@ToString
public class DeleteVerifiedSendersId404Response {
    ...
    public DeleteVerifiedSendersId404Response() {
    }

    private DeleteVerifiedSendersId404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<DeleteVerifiedSendersId403ResponseErrorsInner> errors) {
            this.errors = errors;
        }

        public DeleteVerifiedSendersId404Response build() {
            return new DeleteVerifiedSendersId404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteVerifiedSendersId404Response.class.getSimpleName() + "(", ")");
