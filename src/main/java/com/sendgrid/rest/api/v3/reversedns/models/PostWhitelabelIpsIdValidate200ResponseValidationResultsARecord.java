...
@ToString
public class PostWhitelabelIpsIdValidate200ResponseValidationResultsARecord {
    ...
    public PostWhitelabelIpsIdValidate200ResponseValidationResultsARecord() {
    }

    private PostWhitelabelIpsIdValidate200ResponseValidationResultsARecord(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostWhitelabelIpsIdValidate200ResponseValidationResultsARecord build() {
            return new PostWhitelabelIpsIdValidate200ResponseValidationResultsARecord(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelIpsIdValidate200ResponseValidationResultsARecord.class.getSimpleName() + "(", ")");
