...
public class PostCampaigns {
    private String onBehalfOf;
    private final PostCampaignsRequest postCampaignsRequest;


    public Campaigns2xx send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostCampaigns creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), Campaigns2xx.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (postCampaignsRequest != null) {
            builder.body(JsonUtil.toJson(postCampaignsRequest));
        }
    }
