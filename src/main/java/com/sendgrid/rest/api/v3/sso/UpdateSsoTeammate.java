...
public class UpdateSsoTeammate extends ApiKeyBase {

    private final String username;

    @Setter
    private SsoTeammatesBaseRequestProps body;

    public ApiResponse<PatchSsoTeammates200> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateSsoTeammate creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), PatchSsoTeammates200.class),
            response.getHeaders()
        );
    }
