...
import com.sendgrid.rest.api.v3.mcsinglesends.models.GetMarketingSinglesends200Response;
...
public class PostSearch {
    ...
    private final SinglesendSearch singlesendSearch;


    public GetMarketingSinglesends200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostSearch creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetMarketingSinglesends200Response.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (singlesendSearch != null) {
            builder.body(JsonUtil.toJson(singlesendSearch));
        }
    }
