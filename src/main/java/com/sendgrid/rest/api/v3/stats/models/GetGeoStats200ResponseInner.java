...
@ToString
public class GetGeoStats200ResponseInner {
    ...
    @Getter
    @Setter
    private List<GetGeoStats200ResponseInnerStatsInner> stats;

    public GetGeoStats200ResponseInner() {
    }

    private GetGeoStats200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder stats(List<GetGeoStats200ResponseInnerStatsInner> stats) {
            this.stats = stats;
            return this;
        }

        public GetGeoStats200ResponseInner build() {
            return new GetGeoStats200ResponseInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetGeoStats200ResponseInner.class.getSimpleName() + "(", ")");
