...
import com.sendgrid.rest.api.v3.mcsegments.models.GetMarketingSegments200Response;
...
public class GetSegments {
    ...
    public GetMarketingSegments200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetSegments creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetMarketingSegments200Response.class);
    }
