...
@ToString
public class SendMailRequestMailSettingsBypassListManagement {
    ...
    public SendMailRequestMailSettingsBypassListManagement() {}

    private SendMailRequestMailSettingsBypassListManagement(Builder builder) {
    ...
    public static class Builder {
        ...
        public SendMailRequestMailSettingsBypassListManagement build() {
            return new SendMailRequestMailSettingsBypassListManagement(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SendMailRequestMailSettingsBypassListManagement.class.getSimpleName() +
            "(",
            ")"
        );
