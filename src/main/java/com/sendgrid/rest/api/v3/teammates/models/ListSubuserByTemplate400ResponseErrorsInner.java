...
@ToString
public class ListSubuserByTemplate400ResponseErrorsInner {
    ...
    public ListSubuserByTemplate400ResponseErrorsInner() {}

    private ListSubuserByTemplate400ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public ListSubuserByTemplate400ResponseErrorsInner build() {
            return new ListSubuserByTemplate400ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListSubuserByTemplate400ResponseErrorsInner.class.getSimpleName() +
            "(",
            ")"
        );
