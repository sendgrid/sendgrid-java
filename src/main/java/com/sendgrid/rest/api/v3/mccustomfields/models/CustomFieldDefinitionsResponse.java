...
public class CustomFieldDefinitionsResponse {
    ...
    public CustomFieldDefinitionsResponse() {}

    private CustomFieldDefinitionsResponse(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public CustomFieldDefinitionsResponse build() {
            return new CustomFieldDefinitionsResponse(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            CustomFieldDefinitionsResponse.class.getSimpleName() + "(",
            ")"
        );
