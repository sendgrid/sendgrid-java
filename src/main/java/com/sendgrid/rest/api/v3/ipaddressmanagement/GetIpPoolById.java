...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.GetSendIpsPools200Response;
...
public class GetIpPoolById {
    ...
    public GetSendIpsPools200Response send(final TokenRestClient client) {
        ...
        return JsonUtil.fromJson(response.getStream(), GetSendIpsPools200Response.class);
    }
