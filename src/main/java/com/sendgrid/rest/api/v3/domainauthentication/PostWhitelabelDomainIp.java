...
import com.sendgrid.rest.api.v3.domainauthentication.models.PostWhitelabelDomainsIdIpsRequest;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PostWhitelabelDomainIp {
    private final Integer id;
    private String onBehalfOf;
    private final PostWhitelabelDomainsIdIpsRequest postWhitelabelDomainsIdIpsRequest;
    ...
    public AuthenticatedDomainSpf send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostWhitelabelDomainIp creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (postWhitelabelDomainsIdIpsRequest != null) {
            builder.body(JsonUtil.toJson(postWhitelabelDomainsIdIpsRequest));
        }
    }
