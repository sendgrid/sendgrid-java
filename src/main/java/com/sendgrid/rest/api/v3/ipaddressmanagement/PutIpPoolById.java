...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.PutSendIpsPoolsPoolId200Response;
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.PutSendIpsPoolsPoolIdRequest;
...
public class PutIpPoolById {
    ...
    private final PutSendIpsPoolsPoolIdRequest putSendIpsPoolsPoolIdRequest;


    public PutSendIpsPoolsPoolId200Response send(final TokenRestClient client) {
        ...
        return JsonUtil.fromJson(response.getStream(), PutSendIpsPoolsPoolId200Response.class);
    }


    private void body(final Request.Builder builder) {
        if (putSendIpsPoolsPoolIdRequest != null) {
            builder.body(JsonUtil.toJson(putSendIpsPoolsPoolIdRequest));
        }
    }
