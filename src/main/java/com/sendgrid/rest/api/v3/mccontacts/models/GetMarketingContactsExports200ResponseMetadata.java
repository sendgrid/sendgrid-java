...
@ToString
public class GetMarketingContactsExports200ResponseMetadata {
    ...
    public GetMarketingContactsExports200ResponseMetadata() {
    }

    private GetMarketingContactsExports200ResponseMetadata(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetMarketingContactsExports200ResponseMetadata build() {
            return new GetMarketingContactsExports200ResponseMetadata(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingContactsExports200ResponseMetadata.class.getSimpleName() + "(", ")");
