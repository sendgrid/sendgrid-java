...
@ToString
public class PostMailSendRequestTrackingSettingsClickTracking {
    ...
    public PostMailSendRequestTrackingSettingsClickTracking() {
    }

    private PostMailSendRequestTrackingSettingsClickTracking(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder enableText(Boolean enableText) {
            this.enableText = enableText;
            return this;
        }

        public PostMailSendRequestTrackingSettingsClickTracking build() {
            return new PostMailSendRequestTrackingSettingsClickTracking(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostMailSendRequestTrackingSettingsClickTracking.class.getSimpleName() + "(", ")");
