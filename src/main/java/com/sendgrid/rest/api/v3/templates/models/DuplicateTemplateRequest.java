...
public class DuplicateTemplateRequest {
    ...
    public DuplicateTemplateRequest() {}

    private DuplicateTemplateRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public DuplicateTemplateRequest build() {
            return new DuplicateTemplateRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            DuplicateTemplateRequest.class.getSimpleName() + "(",
            ")"
        );
