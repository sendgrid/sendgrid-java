...
@ToString
public class CreateVerifiedSender400ResponseErrorsInner {
    ...
    public CreateVerifiedSender400ResponseErrorsInner() {}

    private CreateVerifiedSender400ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public CreateVerifiedSender400ResponseErrorsInner build() {
            return new CreateVerifiedSender400ResponseErrorsInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            CreateVerifiedSender400ResponseErrorsInner.class.getSimpleName() +
            "(",
            ")"
        );
