...
@ToString
public class DeleteInvalidEmailsRequest {
    ...
    public DeleteInvalidEmailsRequest() {}

    private DeleteInvalidEmailsRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteInvalidEmailsRequest build() {
            return new DeleteInvalidEmailsRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            DeleteInvalidEmailsRequest.class.getSimpleName() + "(",
            ")"
        );
