...
import com.sendgrid.rest.api.v3.mailsettings.models.ListMailSetting200Response;
...
public class ListMailSetting extends ApiKeyBase {
    ...
    public ApiResponse<ListMailSetting200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListMailSetting creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListMailSetting200Response.class
            ),
            response.getHeaders()
        );
    }
