...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.AddSubUsersToIp200Response;
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.AddSubUsersToIpRequest;
...
public class AddSubUsersToIp extends ApiKeyBase {

    private final String ip;

    @Setter
    private AddSubUsersToIpRequest addSubUsersToIpRequest;

    public ApiResponse<AddSubUsersToIp200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "AddSubUsersToIp creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                AddSubUsersToIp200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (addSubUsersToIpRequest != null) {
            request.addBody(JsonUtil.toJson(addSubUsersToIpRequest));
        }
    }
}
