...
public class GetRecipientCount {
    private String onBehalfOf;


    public ContactdbRecipientCount200 send(final TokenRestClient client) {
        String path = "/v3/contactdb/recipients/count";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetRecipientCount creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ContactdbRecipientCount200.class);
    }
