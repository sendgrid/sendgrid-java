...
public class PostTemplatesRequest {
    ...
    private PostTemplatesRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostTemplatesRequest build() {
            return new PostTemplatesRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostTemplatesRequest.class.getSimpleName() + "(", ")");
