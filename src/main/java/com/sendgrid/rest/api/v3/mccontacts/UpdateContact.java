...
import com.sendgrid.rest.api.v3.mccontacts.models.UpdateContact202Response;
import com.sendgrid.rest.api.v3.mccontacts.models.UpdateContactRequest;
...
public class UpdateContact extends ApiKeyBase {

    @Setter
    private UpdateContactRequest updateContactRequest;

    public ApiResponse<UpdateContact202Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateContact creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                UpdateContact202Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (updateContactRequest != null) {
            request.addBody(JsonUtil.toJson(updateContactRequest));
        }
    }
}
