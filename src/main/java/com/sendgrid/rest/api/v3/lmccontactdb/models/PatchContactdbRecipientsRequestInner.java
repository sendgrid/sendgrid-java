...
@ToString
public class PatchContactdbRecipientsRequestInner {
    ...
    public PatchContactdbRecipientsRequestInner() {
    }

    private PatchContactdbRecipientsRequestInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public PatchContactdbRecipientsRequestInner build() {
            return new PatchContactdbRecipientsRequestInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PatchContactdbRecipientsRequestInner.class.getSimpleName() + "(", ")");
