...
@ToString
public class PostIpsPoolsPoolNameIps404Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<PostIpsPoolsPoolNameIps404ResponseErrorsInner> errors;

    public PostIpsPoolsPoolNameIps404Response() {
    }

    private PostIpsPoolsPoolNameIps404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<PostIpsPoolsPoolNameIps404ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public PostIpsPoolsPoolNameIps404Response build() {
            return new PostIpsPoolsPoolNameIps404Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostIpsPoolsPoolNameIps404Response.class.getSimpleName() + "(", ")");
