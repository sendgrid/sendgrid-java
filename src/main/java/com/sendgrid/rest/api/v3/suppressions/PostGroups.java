...
import com.sendgrid.rest.api.v3.suppressions.models.PostAsmGroups201Response;
...
public class PostGroups {
    ...
    public PostAsmGroups201Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostGroups creation failed: Unable to connect to server"
            );
        } else if (!TokenRestClient.SUCCESS.test(response.getStatusCode())) {

            int statusCode = response.getStatusCode();
        }
        return JsonUtil.fromJson(response.getStream(), PostAsmGroups201Response.class);
    }
