...
@ToString
public class UpdateSsoCertificateRequest {
    ...
    public UpdateSsoCertificateRequest() {}

    private UpdateSsoCertificateRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public UpdateSsoCertificateRequest build() {
            return new UpdateSsoCertificateRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            UpdateSsoCertificateRequest.class.getSimpleName() + "(",
            ")"
        );
