...
import com.sendgrid.rest.api.v3.lmccontactdb.models.GetContactdbListsListIdRecipients200Response;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class GetSearchRecipient {
    private String query;
    private String onBehalfOf;


    public GetContactdbListsListIdRecipients200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetSearchRecipient creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetContactdbListsListIdRecipients200Response.class);
    }
