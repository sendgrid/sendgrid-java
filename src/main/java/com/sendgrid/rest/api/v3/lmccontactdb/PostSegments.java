...
import com.sendgrid.rest.api.v3.lmccontactdb.models.ContactdbSegmentsId200;
...
public class PostSegments {
    private String onBehalfOf;
    private final ContactdbSegments contactdbSegments;


    public ContactdbSegmentsId200 send(final TokenRestClient client) {
        String path = "/v3/contactdb/segments";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostSegments creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ContactdbSegmentsId200.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (contactdbSegments != null) {
            builder.body(JsonUtil.toJson(contactdbSegments));
        }
    }
