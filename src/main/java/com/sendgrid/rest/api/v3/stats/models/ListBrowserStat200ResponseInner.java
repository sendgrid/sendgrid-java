...
import com.sendgrid.rest.api.v3.stats.models.ListBrowserStat200ResponseInnerStatsInner;
...
@ToString
public class ListBrowserStat200ResponseInner {
    ...
    @Getter
    @Setter
    private List<ListBrowserStat200ResponseInnerStatsInner> stats;

    public ListBrowserStat200ResponseInner() {}

    private ListBrowserStat200ResponseInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder stats(
            List<ListBrowserStat200ResponseInnerStatsInner> stats
        ) {
            this.stats = stats;
            return this;
        }

        public ListBrowserStat200ResponseInner build() {
            return new ListBrowserStat200ResponseInner(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ListBrowserStat200ResponseInner.class.getSimpleName() + "(",
            ")"
        );
