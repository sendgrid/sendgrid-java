...
@ToString
public class PostWhitelabelDomainsIdValidate500Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<PostWhitelabelDomainsIdValidate500ResponseErrorsInner> errors;

    public PostWhitelabelDomainsIdValidate500Response() {
    }

    private PostWhitelabelDomainsIdValidate500Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<PostWhitelabelDomainsIdValidate500ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public PostWhitelabelDomainsIdValidate500Response build() {
            return new PostWhitelabelDomainsIdValidate500Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelDomainsIdValidate500Response.class.getSimpleName() + "(", ")");
