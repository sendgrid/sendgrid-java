...
import com.sendgrid.rest.api.v3.user.models.PutUserPasswordRequest;
...
public class PutPassword {
    ...
    private final PutUserPasswordRequest putUserPasswordRequest;


    public Object send(final TokenRestClient client) {
        String path = "/v3/user/password";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PutPassword creation failed: Unable to connect to server"
            );
    ...
    private void body(final Request.Builder builder) {
        if (putUserPasswordRequest != null) {
            builder.body(JsonUtil.toJson(putUserPasswordRequest));
        }
    }
