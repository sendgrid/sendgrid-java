...
@ToString
public class GetSuppressionsBouncesClassificationsClassification200ResponseResultInner {
    ...
    @Getter
    @Setter
    private List<GetSuppressionsBouncesClassificationsClassification200ResponseResultInnerStatsInner> stats;

    public GetSuppressionsBouncesClassificationsClassification200ResponseResultInner() {
    }

    private GetSuppressionsBouncesClassificationsClassification200ResponseResultInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder stats(List<GetSuppressionsBouncesClassificationsClassification200ResponseResultInnerStatsInner> stats) {
            this.stats = stats;
            return this;
        }

        public GetSuppressionsBouncesClassificationsClassification200ResponseResultInner build() {
            return new GetSuppressionsBouncesClassificationsClassification200ResponseResultInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetSuppressionsBouncesClassificationsClassification200ResponseResultInner.class.getSimpleName() + "(", ")");
