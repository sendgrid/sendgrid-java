...
@ToString
public class DeleteSpamReportsRequest {
    ...
    public DeleteSpamReportsRequest() {}

    private DeleteSpamReportsRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteSpamReportsRequest build() {
            return new DeleteSpamReportsRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            DeleteSpamReportsRequest.class.getSimpleName() + "(",
            ")"
        );
