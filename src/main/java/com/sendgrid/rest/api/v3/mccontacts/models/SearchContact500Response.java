...
import com.sendgrid.rest.api.v3.mccontacts.models.SearchContact500ResponseErrorsInner;
...
@ToString
public class SearchContact500Response {

    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<SearchContact500ResponseErrorsInner> errors;

    public SearchContact500Response() {}

    private SearchContact500Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(
            List<SearchContact500ResponseErrorsInner> errors
        ) {
            this.errors = errors;
            return this;
        }

        public SearchContact500Response build() {
            return new SearchContact500Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            SearchContact500Response.class.getSimpleName() + "(",
            ")"
        );
