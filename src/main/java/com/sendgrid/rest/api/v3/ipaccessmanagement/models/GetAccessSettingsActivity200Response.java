...
@ToString
public class GetAccessSettingsActivity200Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private List<GetAccessSettingsActivity200ResponseResultInner> result;

    public GetAccessSettingsActivity200Response() {
    }

    private GetAccessSettingsActivity200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<GetAccessSettingsActivity200ResponseResultInner> result) {
            this.result = result;
        }

        public GetAccessSettingsActivity200Response build() {
            return new GetAccessSettingsActivity200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetAccessSettingsActivity200Response.class.getSimpleName() + "(", ")");
