...
@ToString
public class PostWhitelabelDnsEmailRequest {
    ...
    public PostWhitelabelDnsEmailRequest() {
    }

    private PostWhitelabelDnsEmailRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(Integer linkId, Integer domainId, String email) {
            this.linkId = linkId;
        ...
        public PostWhitelabelDnsEmailRequest build() {
            return new PostWhitelabelDnsEmailRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelDnsEmailRequest.class.getSimpleName() + "(", ")");
        if (linkId != null) joiner.add("linkId=" + linkId);
        if (domainId != null) joiner.add("domainId=" + domainId);
