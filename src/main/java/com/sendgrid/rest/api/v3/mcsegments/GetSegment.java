...
public class GetSegment extends ApiKeyBase {
    ...
    public ApiResponse<FullSegment> send(final ApiKeyRestClient client) {
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), FullSegment.class),
            response.getHeaders()
        );
    }
    ...
    private void addQueryParams(Request request) {
        if (queryJson != null) {
            request.addQueryParam("query_json", queryJson.toString());
        }
    }
}
