...
public class GetWarmUpIp extends ApiKeyBase {
    ...
    public ApiResponse<List<IpWarmup200Inner>> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetWarmUpIp creation failed: Unable to connect to server"
            );
        } else if (
            ...
            if (Matcher.matches(Integer.toString(statusCode), "404")) {
                GetWarmUpIp404Response error = JsonUtil.fromJson(
                    response.getStream(),
                    GetWarmUpIp404Response.class
                );
