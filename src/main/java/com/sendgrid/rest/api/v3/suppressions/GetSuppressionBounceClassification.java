...
public class GetSuppressionBounceClassification {
    private String query;
    private final Schema accept;
    private String onBehalfOf;


    public GetSuppressionBouncesClassifications200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetSuppressionBounceClassification creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), GetSuppressionBouncesClassifications200Response.class);
    }
