...
import com.sendgrid.rest.api.v3.stats.models.Country;
import com.sendgrid.rest.api.v3.stats.models.ListGeoStat200ResponseInner;
...
public class ListGeoStat extends ApiKeyBase {
    ...
    public ApiResponse<List<ListGeoStat200ResponseInner>> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListGeoStat creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addQueryParams(Request request) {
        if (country != null) {
            request.addQueryParam("country", country.toString());
        }
        if (limit != null) {
