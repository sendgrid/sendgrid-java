...
@ToString
public class GetMarketingContactsExports200Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private List<GetMarketingContactsExports200ResponseResultInner> result;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("metadata")
    @Getter
    @Setter
    private GetMarketingContactsExports200ResponseMetadata metadata;

    public GetMarketingContactsExports200Response() {
    }

    private GetMarketingContactsExports200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder result(List<GetMarketingContactsExports200ResponseResultInner> result) {
            this.result = result;
            return this;
        }

        public Builder metadata(GetMarketingContactsExports200ResponseMetadata metadata) {
            this.metadata = metadata;
            return this;
        }

        public GetMarketingContactsExports200Response build() {
            return new GetMarketingContactsExports200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingContactsExports200Response.class.getSimpleName() + "(", ")");
