...
import com.sendgrid.rest.api.v3.ips.models.GetIpsIpAddress200Response;
...
public class GetIpsById {
    ...
    public GetIpsIpAddress200Response send(final TokenRestClient client) {
        String path = "/v3/ips/{ip_address}";
        ...
        return JsonUtil.fromJson(response.getStream(), GetIpsIpAddress200Response.class);
    }
