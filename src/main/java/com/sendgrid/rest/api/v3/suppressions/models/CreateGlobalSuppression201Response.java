...
@ToString
public class CreateGlobalSuppression201Response {
    ...
    public CreateGlobalSuppression201Response() {}

    private CreateGlobalSuppression201Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public CreateGlobalSuppression201Response build() {
            return new CreateGlobalSuppression201Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            CreateGlobalSuppression201Response.class.getSimpleName() + "(",
            ")"
        );
