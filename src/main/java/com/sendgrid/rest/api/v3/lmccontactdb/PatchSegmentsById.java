...
import com.sendgrid.rest.api.v3.lmccontactdb.models.PatchContactdbSegmentsSegmentIdRequest;
import com.sendgrid.util.JsonUtil;
import com.sendgrid.util.Matcher;
import lombok.RequiredArgsConstructor;

@RequiredArgsConstructor
public class PatchSegmentsById {
    private final String segmentId;
    private String query;
    private String onBehalfOf;
    private final PatchContactdbSegmentsSegmentIdRequest patchContactdbSegmentsSegmentIdRequest;


    public ContactdbSegments send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PatchSegmentsById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ContactdbSegments.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (patchContactdbSegmentsSegmentIdRequest != null) {
            builder.body(JsonUtil.toJson(patchContactdbSegmentsSegmentIdRequest));
        }
    }
