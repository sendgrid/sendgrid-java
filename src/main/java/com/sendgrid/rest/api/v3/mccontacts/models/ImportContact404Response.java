...
@ToString
public class ImportContact404Response {
    ...
    public ImportContact404Response() {}

    private ImportContact404Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public ImportContact404Response build() {
            return new ImportContact404Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ImportContact404Response.class.getSimpleName() + "(",
            ")"
        );
