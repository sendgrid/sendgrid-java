...
public class ListEngagementQualityScore extends ApiKeyBase {
    ...
    public ApiResponse<Void> send(final ApiKeyRestClient client) {
        String path = "/v3/engagementquality/scores";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListEngagementQualityScore creation failed: Unable to connect to server"
            );
        } else if (
