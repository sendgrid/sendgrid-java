...
public enum ModelDefault {
    ...
    private ModelDefault(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static ModelDefault fromString(final String value) {
        return CustomDeserializer. enum (value, ModelDefault.values());
    }
