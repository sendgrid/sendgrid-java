...
import com.sendgrid.rest.api.v3.subusers.models.PutSubusersSubuserNameIps200Response;
...
public class PutIps {
    ...
    public PutSubusersSubuserNameIps200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PutIps creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PutSubusersSubuserNameIps200Response.class);
    }


    private void body(final Request.Builder builder) {
        if (requestBody != null) {
            builder.body(JsonUtil.toJson(requestBody));
        }
    }
