...
@ToString
public class AuthenticatedDomainSpfDnsDomainSpf {
    ...
    public AuthenticatedDomainSpfDnsDomainSpf() {
    }

    private AuthenticatedDomainSpfDnsDomainSpf(Builder builder) {
    ...
    public static class Builder {
        ...
        public AuthenticatedDomainSpfDnsDomainSpf build() {
            return new AuthenticatedDomainSpfDnsDomainSpf(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", AuthenticatedDomainSpfDnsDomainSpf.class.getSimpleName() + "(", ")");
