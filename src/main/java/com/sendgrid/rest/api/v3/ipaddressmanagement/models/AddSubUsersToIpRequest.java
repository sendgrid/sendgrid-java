...
@ToString
public class AddSubUsersToIpRequest {
    ...
    public AddSubUsersToIpRequest() {}

    private AddSubUsersToIpRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public AddSubUsersToIpRequest build() {
            return new AddSubUsersToIpRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            AddSubUsersToIpRequest.class.getSimpleName() + "(",
            ")"
        );
