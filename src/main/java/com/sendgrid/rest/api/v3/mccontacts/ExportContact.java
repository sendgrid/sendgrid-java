...
import com.sendgrid.rest.api.v3.mccontacts.models.ExportContact202Response;
import com.sendgrid.rest.api.v3.mccontacts.models.ExportContactRequest;
...
public class ExportContact extends ApiKeyBase {

    @Setter
    private ExportContactRequest exportContactRequest;

    public ApiResponse<ExportContact202Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ExportContact creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ExportContact202Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (exportContactRequest != null) {
            request.addBody(JsonUtil.toJson(exportContactRequest));
        }
    }
}
