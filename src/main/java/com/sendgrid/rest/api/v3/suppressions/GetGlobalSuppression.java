...
public class GetGlobalSuppression extends ApiKeyBase {
    ...
    public ApiResponse<RetrieveAGlobalSuppressionResponse> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetGlobalSuppression creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                RetrieveAGlobalSuppressionResponse.class
            ),
            response.getHeaders()
        );
    }
