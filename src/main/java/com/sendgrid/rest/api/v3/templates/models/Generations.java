...
public enum Generations {
    ...
    LEGACY_DYNAMIC("legacy,dynamic");

    private final String value;

    private Generations(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static Generations forValue(final String value) {
        return Promoter.enumFromString(value, Generations.values());
    }
}
