...
@ToString
public class ValidateAuthenticatedDomain200ResponseValidationResultsMailCname {
    ...
    public ValidateAuthenticatedDomain200ResponseValidationResultsMailCname() {}

    private ValidateAuthenticatedDomain200ResponseValidationResultsMailCname(
        Builder builder
    ) {
    ...
    public static class Builder {
        ...
        public ValidateAuthenticatedDomain200ResponseValidationResultsMailCname build() {
            return new ValidateAuthenticatedDomain200ResponseValidationResultsMailCname(
                this
            );
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ValidateAuthenticatedDomain200ResponseValidationResultsMailCname.class.getSimpleName() +
            "(",
            ")"
        );
