...
public class GetRecipientsById {
    private final String recipientId;
    private String onBehalfOf;


    public ContactdbRecipient200 send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetRecipientsById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ContactdbRecipient200.class);
    }
