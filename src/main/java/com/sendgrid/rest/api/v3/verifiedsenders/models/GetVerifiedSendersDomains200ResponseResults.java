...
@ToString
public class GetVerifiedSendersDomains200ResponseResults {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("softFailures")
    @Getter
    @Setter
    private List<String> softFailures;
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("hardFailures")
    @Getter
    @Setter
    private List<String> hardFailures;

    public GetVerifiedSendersDomains200ResponseResults() {
    }

    private GetVerifiedSendersDomains200ResponseResults(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetVerifiedSendersDomains200ResponseResults build() {
            return new GetVerifiedSendersDomains200ResponseResults(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetVerifiedSendersDomains200ResponseResults.class.getSimpleName() + "(", ")");
