...
@ToString
public class AssociateBrandedLinkWithSubuserRequest {
    ...
    public AssociateBrandedLinkWithSubuserRequest() {}

    private AssociateBrandedLinkWithSubuserRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public AssociateBrandedLinkWithSubuserRequest build() {
            return new AssociateBrandedLinkWithSubuserRequest(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            AssociateBrandedLinkWithSubuserRequest.class.getSimpleName() + "(",
            ")"
        );
