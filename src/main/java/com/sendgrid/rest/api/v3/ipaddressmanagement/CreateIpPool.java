...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.CreateIpPool201Response;
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.CreateIpPoolRequest;
...
public class CreateIpPool extends ApiKeyBase {

    @Setter
    private CreateIpPoolRequest createIpPoolRequest;

    public ApiResponse<CreateIpPool201Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "CreateIpPool creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (createIpPoolRequest != null) {
            request.addBody(JsonUtil.toJson(createIpPoolRequest));
        }
    }
}
