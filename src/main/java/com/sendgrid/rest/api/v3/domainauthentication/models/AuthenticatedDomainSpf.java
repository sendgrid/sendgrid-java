...
public class AuthenticatedDomainSpf {
    ...
    public static class Builder {
        ...
        public Builder(Integer id, String domain, String username, Integer userId, List<Object> ips, Boolean customSpf, Boolean _default, Boolean legacy, Boolean automaticSecurity, Boolean valid, AuthenticatedDomainSpfDns dns) {
            this.id = id;
            this.domain = domain;
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", AuthenticatedDomainSpf.class.getSimpleName() + "(", ")");
