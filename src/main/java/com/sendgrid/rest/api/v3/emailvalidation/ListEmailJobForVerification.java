...
public class ListEmailJobForVerification extends ApiKeyBase {

    @Setter
    private ListEmailJobForVerificationRequest listEmailJobForVerificationRequest;

    public ApiResponse<PutValidationsEmailJobs200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListEmailJobForVerification creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                PutValidationsEmailJobs200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (listEmailJobForVerificationRequest != null) {
            request.addBody(
                JsonUtil.toJson(listEmailJobForVerificationRequest)
            );
        }
    }
}
