...
import com.sendgrid.rest.api.v3.mccontacts.models.PostMarketingContactsSearchIdentifiersIdentifierType200Response;
import com.sendgrid.rest.api.v3.mccontacts.models.PostMarketingContactsSearchIdentifiersIdentifierTypeRequest;
...
public class PostMarketingContactSearchIdentifierById {
    private final Schema identifierType;
    private final PostMarketingContactsSearchIdentifiersIdentifierTypeRequest postMarketingContactsSearchIdentifiersIdentifierTypeRequest;


    public PostMarketingContactsSearchIdentifiersIdentifierType200Response send(final TokenRestClient client) {
        ...
        Request.Builder builder = new Request.Builder(HttpMethod.POST, path)
                .addPathParam("identifier_type", identifierType.toString());
        body(builder);
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostMarketingContactSearchIdentifierById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PostMarketingContactsSearchIdentifiersIdentifierType200Response.class);
    }


    private void body(final Request.Builder builder) {
        if (postMarketingContactsSearchIdentifiersIdentifierTypeRequest != null) {
            builder.body(JsonUtil.toJson(postMarketingContactsSearchIdentifiersIdentifierTypeRequest));
        }
    }
