...
import com.sendgrid.rest.api.v3.user.models.ListEmail200Response;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class ListEmail extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    public ApiResponse<ListEmail200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListEmail creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), ListEmail200Response.class),
            response.getHeaders()
        );
    }
