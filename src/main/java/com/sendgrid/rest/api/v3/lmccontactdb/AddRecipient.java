...
public class AddRecipient extends ApiKeyBase {
    ...
    public ApiResponse<ContactdbRecipientResponse201> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "AddRecipient creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (addRecipientRequestInner != null) {
            request.addBody(JsonUtil.toJson(addRecipientRequestInner));
        }
    }
}
