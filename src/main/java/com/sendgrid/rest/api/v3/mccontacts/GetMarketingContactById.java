...
public class GetMarketingContactById {
    private final String id;


    public ContactDetails3 send(final TokenRestClient client) {
        String path = "/v3/marketing/contacts/{id}";
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "GetMarketingContactById creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ContactDetails3.class);
    }
