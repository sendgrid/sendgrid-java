...
@ToString
public class PostValidationsEmail200Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private PostValidationsEmail200ResponseResult result;

    public PostValidationsEmail200Response() {
    }

    private PostValidationsEmail200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(PostValidationsEmail200ResponseResult result) {
            this.result = result;
        }

        public PostValidationsEmail200Response build() {
            return new PostValidationsEmail200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostValidationsEmail200Response.class.getSimpleName() + "(", ")");
