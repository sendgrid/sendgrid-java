...
import com.sendgrid.rest.api.v3.ipaddressmanagement.models.DeleteIpsFromIpPoolRequest;
...
public class DeleteIpsFromIpPool extends ApiKeyBase {

    private final String poolid;

    @Setter
    private DeleteIpsFromIpPoolRequest deleteIpsFromIpPoolRequest;
    ...
    public ApiResponse<Void> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DeleteIpsFromIpPool creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (deleteIpsFromIpPoolRequest != null) {
            request.addBody(JsonUtil.toJson(deleteIpsFromIpPoolRequest));
        }
    }
}
