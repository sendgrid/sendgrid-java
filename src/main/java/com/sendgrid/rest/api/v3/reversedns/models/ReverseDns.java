...
import com.sendgrid.rest.api.v3.reversedns.models.ReverseDnsARecord;
import com.sendgrid.rest.api.v3.reversedns.models.ReverseDnsUsersInner;
...
public class ReverseDns {
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("last_validation_attempt_at")
    @Getter
    @Setter
    ...
    public static class Builder {
        ...
        public Builder(
            ...
            String ip,
            String rdns,
            List<ReverseDnsUsersInner> users,
            String domain,
            Boolean valid,
            Boolean legacy,
            ReverseDnsARecord aRecord
        ) {
            this.id = id;
            this.ip = ip;
            this.rdns = rdns;
        ...
        public Builder lastValidationAttemptAt(
            Integer lastValidationAttemptAt
        ) {
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            ReverseDns.class.getSimpleName() + "(",
            ")"
        );
        ...
        if (lastValidationAttemptAt != null) joiner.add(
            "lastValidationAttemptAt=" + lastValidationAttemptAt
        );
