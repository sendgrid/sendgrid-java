...
public class DeleteMarketingList extends ApiKeyBase {
    ...
    public ApiResponse<String> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "DeleteMarketingList creation failed: Unable to connect to server"
            );
        } else if (
            ...
            if (Matcher.matches(Integer.toString(statusCode), "404")) {
                DeleteMarketingList404Response error = JsonUtil.fromJson(
                    response.getStream(),
                    DeleteMarketingList404Response.class
                );
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), String.class),
            response.getHeaders()
        );
    }
