...
@ToString
public class GetVerifiedSendersStepsCompleted200Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("results")
    @Getter
    @Setter
    private GetVerifiedSendersStepsCompleted200ResponseResults results;

    public GetVerifiedSendersStepsCompleted200Response() {
    }

    private GetVerifiedSendersStepsCompleted200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder results(GetVerifiedSendersStepsCompleted200ResponseResults results) {
            this.results = results;
            return this;
        }

        public GetVerifiedSendersStepsCompleted200Response build() {
            return new GetVerifiedSendersStepsCompleted200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetVerifiedSendersStepsCompleted200Response.class.getSimpleName() + "(", ")");
