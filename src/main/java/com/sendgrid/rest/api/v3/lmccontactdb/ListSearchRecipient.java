...
public class ListSearchRecipient extends ApiKeyBase {

    @Setter
    private String leftCurlyBracketFieldNameRightCurlyBracket;
    ...
    public ApiResponse<ListRecipientsFromContactDbList200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListSearchRecipient creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListRecipientsFromContactDbList200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addQueryParams(Request request) {
        if (leftCurlyBracketFieldNameRightCurlyBracket != null) {
            request.addQueryParam(
                "{field_name}",
                leftCurlyBracketFieldNameRightCurlyBracket.toString()
            );
        }
    }
}
