...
@ToString
public class DeleteContact202Response {
    ...
    public DeleteContact202Response() {}

    private DeleteContact202Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteContact202Response build() {
            return new DeleteContact202Response(this);
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            DeleteContact202Response.class.getSimpleName() + "(",
            ")"
        );
