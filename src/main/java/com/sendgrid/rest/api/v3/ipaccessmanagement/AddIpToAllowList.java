...
import com.sendgrid.rest.api.v3.ipaccessmanagement.models.AddIpToAllowListRequest;
...
public class AddIpToAllowList extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private AddIpToAllowListRequest addIpToAllowListRequest;

    public ApiResponse<IpAccessManagement2xx> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "AddIpToAllowList creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addBody(final Request request) {
        if (addIpToAllowListRequest != null) {
            request.addBody(JsonUtil.toJson(addIpToAllowListRequest));
        }
    }
}
