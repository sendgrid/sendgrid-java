...
public class GetSuppressionBouncesClassifications200ResponseResultInnerStatsInner {
    ...
    private GetSuppressionBouncesClassifications200ResponseResultInnerStatsInner(
        Builder builder
    ) {
    ...
    public static class Builder {
        ...
        public GetSuppressionBouncesClassifications200ResponseResultInnerStatsInner build() {
            return new GetSuppressionBouncesClassifications200ResponseResultInnerStatsInner(
                this
            );
        }
    }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(
            ", ",
            GetSuppressionBouncesClassifications200ResponseResultInnerStatsInner.class.getSimpleName() +
            "(",
            ")"
        );
