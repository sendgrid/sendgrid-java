...
public class SuppressionsRequest {
    ...
    public SuppressionsRequest() {
    }

    private SuppressionsRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public SuppressionsRequest build() {
            return new SuppressionsRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SuppressionsRequest.class.getSimpleName() + "(", ")");
