...
@ToString
public class GetBrowsersStats200ResponseInnerStatsInner {
    ...
    public GetBrowsersStats200ResponseInnerStatsInner() {
    }

    private GetBrowsersStats200ResponseInnerStatsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public GetBrowsersStats200ResponseInnerStatsInner build() {
            return new GetBrowsersStats200ResponseInnerStatsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetBrowsersStats200ResponseInnerStatsInner.class.getSimpleName() + "(", ")");
