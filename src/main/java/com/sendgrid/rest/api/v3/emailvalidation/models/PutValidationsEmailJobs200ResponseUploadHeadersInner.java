...
public class PutValidationsEmailJobs200ResponseUploadHeadersInner {
    ...
    private PutValidationsEmailJobs200ResponseUploadHeadersInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public PutValidationsEmailJobs200ResponseUploadHeadersInner build() {
            return new PutValidationsEmailJobs200ResponseUploadHeadersInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PutValidationsEmailJobs200ResponseUploadHeadersInner.class.getSimpleName() + "(", ")");
