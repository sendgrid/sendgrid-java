...
@ToString
public class PostValidationsEmail200ResponseResultChecksLocalPart {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("isSuspectedRoleAddress")
    @Getter
    @Setter
    private Boolean isSuspectedRoleAddress;

    public PostValidationsEmail200ResponseResultChecksLocalPart() {
    }

    private PostValidationsEmail200ResponseResultChecksLocalPart(Builder builder) {
        this.isSuspectedRoleAddress = builder.isSuspectedRoleAddress;
    }
    ...
    public static class Builder {
        ...
        public Builder(Boolean isSuspectedRoleAddress) {
            this.isSuspectedRoleAddress = isSuspectedRoleAddress;
        }

        public PostValidationsEmail200ResponseResultChecksLocalPart build() {
            return new PostValidationsEmail200ResponseResultChecksLocalPart(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostValidationsEmail200ResponseResultChecksLocalPart.class.getSimpleName() + "(", ")");
        if (isSuspectedRoleAddress != null) joiner.add("isSuspectedRoleAddress=" + isSuspectedRoleAddress);
