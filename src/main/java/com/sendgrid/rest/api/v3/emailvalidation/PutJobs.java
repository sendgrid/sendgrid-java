...
import com.sendgrid.rest.api.v3.emailvalidation.models.PutValidationsEmailJobsRequest;
...
public class PutJobs {
    private final PutValidationsEmailJobsRequest putValidationsEmailJobsRequest;


    public PutValidationsEmailJobs200Response send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PutJobs creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), PutValidationsEmailJobs200Response.class);
    }


    private void body(final Request.Builder builder) {
        if (putValidationsEmailJobsRequest != null) {
            builder.body(JsonUtil.toJson(putValidationsEmailJobsRequest));
        }
    }
