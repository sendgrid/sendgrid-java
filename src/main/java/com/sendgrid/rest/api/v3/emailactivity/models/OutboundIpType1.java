...
public enum OutboundIpType1 {
    ...
    private OutboundIpType1(final String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static OutboundIpType1 fromString(final String value) {
        return CustomDeserializer. enum (value, OutboundIpType1.values());
    }
