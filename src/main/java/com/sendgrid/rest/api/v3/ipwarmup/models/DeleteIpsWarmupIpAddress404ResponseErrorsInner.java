...
@ToString
public class DeleteIpsWarmupIpAddress404ResponseErrorsInner {
    ...
    public DeleteIpsWarmupIpAddress404ResponseErrorsInner() {
    }

    private DeleteIpsWarmupIpAddress404ResponseErrorsInner(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteIpsWarmupIpAddress404ResponseErrorsInner build() {
            return new DeleteIpsWarmupIpAddress404ResponseErrorsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteIpsWarmupIpAddress404ResponseErrorsInner.class.getSimpleName() + "(", ")");
