...
import com.sendgrid.rest.api.v3.webhooks.models.ListParseSetting200Response;
...
public class ListParseSetting extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    public ApiResponse<ListParseSetting200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListParseSetting creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ListParseSetting200Response.class
            ),
            response.getHeaders()
        );
    }
