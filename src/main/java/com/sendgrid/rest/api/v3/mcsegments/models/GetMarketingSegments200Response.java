...
@ToString
public class GetMarketingSegments200Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("results")
    @Getter
    @Setter
    private List<SegmentSummary> results;

    public GetMarketingSegments200Response() {
    }

    private GetMarketingSegments200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder(List<SegmentSummary> results) {
            this.results = results;
        }

        public GetMarketingSegments200Response build() {
            return new GetMarketingSegments200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetMarketingSegments200Response.class.getSimpleName() + "(", ")");
