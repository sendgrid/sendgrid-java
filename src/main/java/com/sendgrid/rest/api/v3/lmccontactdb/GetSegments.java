...
import com.sendgrid.rest.api.v3.lmccontactdb.models.ListAllSegmentsResponse;
...
public class GetSegments {
    ...
    public ListAllSegmentsResponse send(final TokenRestClient client) {
        ...
        return JsonUtil.fromJson(response.getStream(), ListAllSegmentsResponse.class);
    }
