...
@ToString
public class PostWhitelabelDomainsIdValidate200ResponseValidationResultsDkim1 {
    ...
    public PostWhitelabelDomainsIdValidate200ResponseValidationResultsDkim1() {
    }

    private PostWhitelabelDomainsIdValidate200ResponseValidationResultsDkim1(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostWhitelabelDomainsIdValidate200ResponseValidationResultsDkim1 build() {
            return new PostWhitelabelDomainsIdValidate200ResponseValidationResultsDkim1(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostWhitelabelDomainsIdValidate200ResponseValidationResultsDkim1.class.getSimpleName() + "(", ")");
