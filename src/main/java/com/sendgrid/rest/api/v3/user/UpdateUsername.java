...
import com.sendgrid.rest.api.v3.user.models.UpdateUsername200Response;
import com.sendgrid.rest.api.v3.user.models.UpdateUsernameRequest;
import com.sendgrid.util.JsonUtil;
import lombok.RequiredArgsConstructor;
import lombok.Setter;

@RequiredArgsConstructor
public class UpdateUsername extends ApiKeyBase {
    ...
    public ApiResponse<UpdateUsername200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateUsername creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                UpdateUsername200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (updateUsernameRequest != null) {
            request.addBody(JsonUtil.toJson(updateUsernameRequest));
        }
    }
}
