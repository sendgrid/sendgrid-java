...
public class SeqMetrics {
    ...
    @JsonProperty("engagementRecency")
    @Getter
    @Setter
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("bounceClassification")
    @Getter
    @Setter
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", SeqMetrics.class.getSimpleName() + "(", ")");
        if (engagementRecency != null) joiner.add("engagementRecency=" + engagementRecency);
        if (openRate != null) joiner.add("openRate=" + openRate);
        if (bounceClassification != null) joiner.add("bounceClassification=" + bounceClassification);
