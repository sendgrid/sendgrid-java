...
@ToString
public class GetSuppressionBouncesClassifications200Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("result")
    @Getter
    @Setter
    private List<GetSuppressionBouncesClassifications200ResponseResultInner> result;

    public GetSuppressionBouncesClassifications200Response() {
    }

    private GetSuppressionBouncesClassifications200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder result(List<GetSuppressionBouncesClassifications200ResponseResultInner> result) {
            this.result = result;
            return this;
        }

        public GetSuppressionBouncesClassifications200Response build() {
            return new GetSuppressionBouncesClassifications200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetSuppressionBouncesClassifications200Response.class.getSimpleName() + "(", ")");
