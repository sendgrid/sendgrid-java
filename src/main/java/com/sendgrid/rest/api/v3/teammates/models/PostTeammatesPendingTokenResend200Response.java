...
@ToString
public class PostTeammatesPendingTokenResend200Response {
    ...
    public PostTeammatesPendingTokenResend200Response() {
    }

    private PostTeammatesPendingTokenResend200Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public PostTeammatesPendingTokenResend200Response build() {
            return new PostTeammatesPendingTokenResend200Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", PostTeammatesPendingTokenResend200Response.class.getSimpleName() + "(", ")");
