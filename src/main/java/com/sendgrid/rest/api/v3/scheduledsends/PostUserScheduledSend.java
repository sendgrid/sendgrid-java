...
public class PostUserScheduledSend {
    private String onBehalfOf;
    private final CancelOrPauseAScheduledSendRequest cancelOrPauseAScheduledSendRequest;


    public ScheduledSendStatus send(final TokenRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                    "PostUserScheduledSend creation failed: Unable to connect to server"
            );
        ...
        return JsonUtil.fromJson(response.getStream(), ScheduledSendStatus.class);
    }
    ...
    private void body(final Request.Builder builder) {
        if (cancelOrPauseAScheduledSendRequest != null) {
            builder.body(JsonUtil.toJson(cancelOrPauseAScheduledSendRequest));
        }
    }
