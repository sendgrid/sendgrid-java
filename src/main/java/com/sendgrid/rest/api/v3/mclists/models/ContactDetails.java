...
public class ContactDetails {
    ...
    public static class Builder {
        ...
        public Builder(UUID id, List<UUID> listIds, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
            this.id = id;
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", ContactDetails.class.getSimpleName() + "(", ")");
