...
import com.sendgrid.rest.api.v3.lmccontactdb.models.UpdateContactDbList200Response;
...
public class UpdateContactDbList extends ApiKeyBase {
    ...
    @Setter
    private UpdateAListRequest updateAListRequest;
    ...
    public ApiResponse<UpdateContactDbList200Response> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "UpdateContactDbList creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                UpdateContactDbList200Response.class
            ),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (updateAListRequest != null) {
            request.addBody(JsonUtil.toJson(updateAListRequest));
        }
    }
}
