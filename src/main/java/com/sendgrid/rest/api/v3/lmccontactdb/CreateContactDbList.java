...
import com.sendgrid.rest.api.v3.lmccontactdb.models.CreateAListRequest;
...
public class CreateContactDbList extends ApiKeyBase {

    @Setter
    private String onBehalfOf;

    @Setter
    private CreateAListRequest createAListRequest;

    public ApiResponse<ContactdbList2xx> send(final ApiKeyRestClient client) {
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "CreateContactDbList creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            statusCode,
            JsonUtil.fromJson(response.getStream(), ContactdbList2xx.class),
            response.getHeaders()
        );
    }
    ...
    private void addBody(final Request request) {
        if (createAListRequest != null) {
            request.addBody(JsonUtil.toJson(createAListRequest));
        }
    }
}
