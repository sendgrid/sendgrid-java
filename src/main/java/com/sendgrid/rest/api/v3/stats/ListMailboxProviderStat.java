...
import com.sendgrid.rest.api.v3.stats.models.ListMailboxProviderStat200ResponseInner;
...
public class ListMailboxProviderStat extends ApiKeyBase {

    @Setter
    private String mailboxProviders;
    ...
    public ApiResponse<List<ListMailboxProviderStat200ResponseInner>> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "ListMailboxProviderStat creation failed: Unable to connect to server"
            );
        } else if (
    ...
    private void addQueryParams(Request request) {
        if (mailboxProviders != null) {
            request.addQueryParam(
                "mailbox_providers",
                mailboxProviders.toString()
            );
        }
        if (limit != null) {
