...
@ToString
public class GetTemplates400Response {
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonProperty("errors")
    @Getter
    @Setter
    private List<GetTemplates400ResponseErrorsInner> errors;

    public GetTemplates400Response() {
    }

    private GetTemplates400Response(Builder builder) {
    ...
    public static class Builder {
        ...
        public Builder errors(List<GetTemplates400ResponseErrorsInner> errors) {
            this.errors = errors;
            return this;
        }

        public GetTemplates400Response build() {
            return new GetTemplates400Response(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetTemplates400Response.class.getSimpleName() + "(", ")");
