...
@ToString
public class DeleteSuppressionSpamReportsRequest {
    ...
    public DeleteSuppressionSpamReportsRequest() {
    }

    private DeleteSuppressionSpamReportsRequest(Builder builder) {
    ...
    public static class Builder {
        ...
        public DeleteSuppressionSpamReportsRequest build() {
            return new DeleteSuppressionSpamReportsRequest(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", DeleteSuppressionSpamReportsRequest.class.getSimpleName() + "(", ")");
