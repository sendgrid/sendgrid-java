...
public class GetScheduledCampaign extends ApiKeyBase {
    ...
    public ApiResponse<ViewScheduledTimeOfACampaignResponse> send(
        ...
        if (response == null) {
            throw new ApiConnectionException(
                "GetScheduledCampaign creation failed: Unable to connect to server"
            );
        } else if (
        ...
        return new ApiResponse(
            ...
            JsonUtil.fromJson(
                response.getStream(),
                ViewScheduledTimeOfACampaignResponse.class
            ),
            response.getHeaders()
        );
    }
