...
@ToString
public class GetSendIpsIpsIp200ResponsePoolsInner {
    ...
    public GetSendIpsIpsIp200ResponsePoolsInner() {
    }

    private GetSendIpsIpsIp200ResponsePoolsInner(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public GetSendIpsIpsIp200ResponsePoolsInner build() {
            return new GetSendIpsIpsIp200ResponsePoolsInner(this);
        }
    ...
    public String toString() {
        StringJoiner joiner = new StringJoiner(", ", GetSendIpsIpsIp200ResponsePoolsInner.class.getSimpleName() + "(", ")");
